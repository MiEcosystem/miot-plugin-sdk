...
import { adjustSize } from "../utils/sizes"; // import { FontDefault } from '../utils/fonts';
...
export default class WallSwitch extends Component {
  ...
  getItems = items => {
    ...
    return items.map((item, index) => {
      ...
      let isOn = item.isOn;
      return <LinearGradient key={index} style={[Styles.item, isOn ? Styles.itemOn : Styles.itemOff, isFirst ? Styles.itemFirst : null, isLast ? Styles.itemLast : null]} colors={isOn ? SwitchBgColorsOn : SwitchBgColorsOff} {...getAccessibilityConfig({
