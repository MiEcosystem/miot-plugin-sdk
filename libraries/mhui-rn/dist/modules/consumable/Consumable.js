...
export default function Consumable(props) {
  ...
  return <View style={Styles.container}>
      ...
      accessibilityRole: AccessibilityRoles.text
        ...
        {icon ? <Image style={Styles.imageWrap} source={icon} /> : null}
        {title ? <Text style={[Styles.title, titleColor ? {
        color: titleColor
      } : null]}>{title}</Text> : null}
        {subtitle ? <Text style={[Styles.subtitle, subtitleColor ? {
        color: subtitleColor
      } : null]}>{subtitle}</Text> : null}
      </View>
      {buy && reset ? <View style={Styles.buttons}>
        ...
        </View> : buy ? <PrimeButton title={buy} themeColor={ColorGreen} textColor="#fff" onClick={onBuy} {...getAccessibilityConfig({
      accessible: props.accessible,
      accessibilityRole: AccessibilityRoles.button,
      accessibilityHint: props.buyAccessibilityHint
    })} /> : reset ? <PrimeButton title={reset} themeColor={ColorGreen} textColor="#fff" onClick={onReset} {...getAccessibilityConfig({
      accessible: props.accessible,
      accessibilityRole: AccessibilityRoles.button,
      accessibilityHint: props.resetAccessibilityHint
    })} /> : null}
