...
import { FontDefault } from "../utils/fonts"; // import { NOOP } from '../utils/fns';
...
export default class DeviceWithInfo extends PureComponent {
  ...
  render() {
    ...
    let PathCircleBase = new Path().moveTo(startX, startY).arcTo(halfX, halfY, r, r, false, false).arcTo(startX, startY, r, r, false, false);
    let PathCircle = new Path().moveTo(startX, startY);
    ...
    let PathDot = new Path().moveTo(endX, endY - rDot).arcTo(endX, endY + rDot, rDot, rDot, false, false).arcTo(endX, endY - rDot, rDot, rDot, false, false);
