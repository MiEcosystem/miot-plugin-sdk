...
class MHCard extends React.Component {
  ...
  static propTypes = {
    ...
    cardRadiusType: PropTypes.oneOf([CARD_RADIUS_TYPE.ALL, CARD_RADIUS_TYPE.NONE, CARD_RADIUS_TYPE.TOP, CARD_RADIUS_TYPE.BOTTOM]),
  ...
  renderInnerView() {
    ...
    return <View style={[styles.container, this.radiusStyle, opacityStyle, this.props.style]} {...getAccessibilityConfig({
      ...
      name: 'activate'
        ...
        <View style={[styles.iconContainer, this.props.iconContainerStyle]}>
          <Image style={[styles.icon, this.props.iconStyle]} source={this.props.icon} resizeMode="contain" {...getAccessibilityConfig({
          accessible: false
        })} />
        </View>
        <View style={styles.textContainer}>
          <View style={styles.titleContainer}>
          ...
          } : {}, this.props.titleStyle]} numberOfLines={titleLine} {...getAccessibilityConfig({
            accessible: false
          })}>
              {this.props.title || ''}
            </Text>
            ...
            height: undefined,
            lineHeight: undefined
          } : {}, this.props.subtitleStyle]} numberOfLines={subtitleLine} {...getAccessibilityConfig({
            accessible: false
          })}>
                  {this.props.subtitle}
                </Text> : null}
          ...
          maxWidth: '33%'
            ...
            height: undefined,
            lineHeight: undefined
          } : {}, this.props.rightTextStyle]} allowFontScaling={this.props.allowFontScaling} numberOfLines={rightTextLine} {...getAccessibilityConfig({
            accessible: false
          })}>
  ...
  renderRight() {
    if (this.props.cardType === CARD_TYPE.NORMAL) {
      ...
      return <Image style={styles.arrow} source={Images.common.right_arrow} resizeMode="contain" {...getAccessibilityConfig({
        accessible: false
      })} />;
    }

    if (this.props.cardType === CARD_TYPE.SWITCH) {
      return <Switch value={this.props.switchValue} {...this.props} {...getAccessibilityConfig({
        accessible: false
      })} />;
    }
  ...
  render() {
    const cardStyle = StyleSheet.flatten([this.cardStyle, !this.props.allowFontScaling ? {
      height: undefined
    } : {}]);
    return <Card innerView={this.renderInnerView()} cardStyle={cardStyle} {...this.props} />;
  }
