...
const modalWidth = width - margin * 2; // 选择器样式，固定
...
class MHDatePicker extends React.Component {
  ...
  renderTitle() {
    ...
    return <View style={[styles.titleContainer, heightStyle]} {...getAccessibilityConfig({
      ...
      accessibilityLabel: this.props.accessibilityLabel
        ...
        <Text numberOfLines={numberOfLines.titleNumberOfLines} allowFontScaling={this.props.datePickerStyle.allowFontScaling} style={[Styles.common.title, styles.title, {
        ...
        return <View key={index + this.unitArray[index]} style={[{
          flexDirection: 'row'
            ...
            accessibilityHint: this.props.accessibilityHint
              ...
              {index < length - 1 ? <Separator type="column" style={{
  ...
  renderButton() {
    ...
    return <View style={[styles.buttons, heightStyle]}>
      ...
      }]} onPress={() => this.dismiss()} underlayColor="rgba(0,0,0,.05)" accessible={this.props.accessible} accessibilityRole={AccessibilityRoles.button}>
          <Text style={[styles.buttonText, {
          color: theme.colorGrayNormal
        }, this.props.datePickerStyle.leftButtonStyle]} numberOfLines={numberOfLines.leftButtonNumberOfLines} allowFontScaling={this.props.datePickerStyle.allowFontScaling}>
            {Locale.of(this.context.language).cancel}
          </Text>
        </TouchableHighlight>
        <Separator type="column" style={{
        height: buttonHeight
      }} />
        <TouchableHighlight style={[styles.button, {
        borderBottomRightRadius: borderRadius
      }]} onPress={() => this.confirm()} underlayColor="rgba(0,0,0,.05)" accessible={this.props.accessible} accessibilityRole={AccessibilityRoles.button}>
         <Text style={[styles.buttonText, {
          color: theme.colorGrayNormal
        }, {
          color: this.props.confirmColor
        }, this.props.datePickerStyle.rightButtonStyle]} numberOfLines={numberOfLines.rightButtonNumberOfLines} allowFontScaling={this.props.datePickerStyle.allowFontScaling}>
            {Locale.of(this.context.language).ok}
          </Text>
        </TouchableHighlight>
      </View>;
  }
  ...
  array2Date() {
    ...
    switch (this.props.type) {
      case TYPE.DATE:
        ...
        date.setMonth(parseInt(currentArray[1], 10) - 1);
