...
import { transformHexToDigtal, transformDigtalToHex, colorGetterforRange } from "../../utils/color";
...
Object.freeze(TYPE);
Object.freeze(CONTENTTYPE); // const { width: screenWidth } = Dimensions.get('window');
...
class SlideGear extends React.Component {
  static propTypes = {
  ...
  constructor(props, context) {
    ...
    this.containerHeight = containerHeight; // console.log(`滑块高度: ${ blockHeight }\n滑块宽度: ${ blockWidth }\n滑块周围间距: ${ margin }\n容器高度: ${ containerHeight }`);
  ...
  _onPanResponderGrant(e) {
    ...
    this.offset = pageX - this.currentCoord; // console.log('⬇️⬇️⬇️⬇️⬇️⬇️⬇️滑动开始⬇️⬇️⬇️⬇️⬇️⬇️⬇️');
  ...
  _onPanResponderRelease(e, gesture) {
    ...
    this.offset = 0; // console.log(`手势结束坐标: ${ coord }\n滑块最终坐标: ${ this.currentCoord }\n离滑块最近的选项下标: ${ index }`);
  ...
  renderBackground() {
    ...
    return <Animated.View ref={background => this._background = background} style={{
      ...
      backgroundColor: this.props.contentType === CONTENTTYPE.NUM ? this.props.minimumTrackTintColor : ''
        ...
        {this.props.showEndText ? <View style={[styles.textContainer, {
        margin: this.margin,
        ...
        }, this.props.leftTextStyle]} allowFontScaling={this.props.allowFontScaling} numberOfLines={this.props.numberOfLines}>
  ...
  renderRightText() {
    ...
    return <View style={[styles.textContainer, {
      ...
      }, this.props.rightTextStyle]} allowFontScaling={this.props.allowFontScaling} numberOfLines={this.props.numberOfLines}>
  ...
  render() {
    ...
    return <View onLayout={() => this._onLayout()} ref={container => this._container = container} style={[this.props.containerStyle, containerStyle, {
      opacity
    }]}>
