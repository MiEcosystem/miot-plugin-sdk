...
class NormalGear extends React.Component {
  static propTypes = {
  ...
  renderOptions() {
    ...
    return this.props.options.map((option, index) => <Clickable key={option} allowFontScaling={this.props.allowFontScaling} numberOfLines={this.props.numberOfLines} select={this.state.selectArray[index]} selectColor={this.props.selectColor} onPress={() => this.onPress(index)} text={option} style={style} textStyle={this.props.textStyle} {...getAccessibilityConfig({
  ...
  render() {
    ...
    return <View style={[this.props.containerStyle, styles.container, {
