...
export default class ChoiceItem extends React.Component {
  ...
  renderIcon() {
    ...
    return <View style={[styles.iconContainer, paddingTop]}>
  ...
  renderText() {
    ...
    return <View style={styles.textContainer}>
        <Text style={[styles.title, color, textAlign, adaptedFontStyle, this.props.titleStyle]} numberOfLines={this.props.titleNumberOfLines} allowFontScaling={this.props.allowFontScaling}>
          {this.props.title}
        </Text>
        {this.props.subtitle ? <Text style={[styles.subtitle, {
        color: theme.colorGrayNormal
      }, textAlign, adaptedFontStyle, this.props.subtitleStyle]} numberOfLines={this.props.subtitleNumberOfLines} allowFontScaling={this.props.allowFontScaling}>
                {this.props.subtitle}
              </Text> : null}
      </View>;
  }
  ...
  render() {
    ...
    return <TouchableHighlight underlayColor="rgba(0,0,0,0.05)" onPress={() => this._onPress()} {...getAccessibilityConfig({
