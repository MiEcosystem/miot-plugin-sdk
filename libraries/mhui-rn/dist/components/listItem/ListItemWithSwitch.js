  ...
  render() {
    ...
    return <View style={{
      backgroundColor: '#fff'
        ...
        <TouchableView disabled={!this.props.onPress} underlayColor={Styles.common.underlayColor} onPress={this.props.onPress} viewStyle={[styles.container, this.props.containerStyle, extraContainerStyle, adaptedContainerStyle]} {...this.props.onPress ? getAccessibilityConfig({
        accessible: false
        ...
        name: 'activate'
          ...
          <View style={styles.left} {...!this.props.onPress ? {} : getAccessibilityConfig({
          accessible: this.props.accessible,
          ...
          name: 'activate'
            ...
            <View style={[styles.up]}>
              <Text numberOfLines={titleLine} allowFontScaling={this.props.allowFontScaling} ellipsizeMode="tail" style={[Styles.common.title, extraStyle, this.props.titleStyle, adaptedFontStyle]} {...getAccessibilityConfig({
              accessible: false
            })}>
                {this.props.title}
              </Text>
              {this.props.valueText ? <View style={[styles.up]}>
                    {
                /* <View style={[styles.separatorCol, !this.props.allowFontScaling ? {
                 alignSelf: 'stretch', width: 0.5, height: undefined, marginVertical: 8,
                    ...
                    <Text numberOfLines={valueLine} ellipsizeMode="tail" allowFontScaling={this.props.allowFontScaling} style={[Styles.common.subtitle, this.props.valueTextStyle, {
                flex: 1
              }, adaptedFontStyle]} {...getAccessibilityConfig({
                accessible: false
              })}>
            ...
            {this.props.subtitle ? <Text numberOfLines={subtitleLine} ellipsizeMode="tail" allowFontScaling={this.props.allowFontScaling} style={[Styles.common.subtitle, this.props.subtitleStyle, adaptedFontStyle]} {...getAccessibilityConfig({
            accessible: false
          })}>
                  {this.props.subtitle}
                </Text> : null}
          ...
          <View style={styles.right}>
            <Switch style={this.props.switchStyle} value={this.props.value} disabled={this.props.disabled} tintColor={this.props.tintColor} onTintColor={this.props.onTintColor} onValueChange={value => this._onValueChange(value)} {...!this.props.onPress ? {} : getAccessibilityConfig({
            accessible: this.props.accessible,
