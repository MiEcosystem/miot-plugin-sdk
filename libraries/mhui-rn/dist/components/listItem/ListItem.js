  ...
  render() {
    ...
    return <View style={{
      backgroundColor: '#fff'
        ...
        <TouchableView disabled={this.props.disabled} underlayColor={Styles.common.underlayColor} onPress={this.props.onPress} onLongPress={this.props.onLongPress} viewStyle={[styles.container, this.props.containerStyle, extraContainerStyle, adaptedFontStyle]} {...getAccessibilityConfig({
        ...
        accessibilityState: {
          ...
          <View style={[styles.left]}>
            ...
            paddingVertical: 2
              ...
              <Text numberOfLines={titleLine} allowFontScaling={this.props.allowFontScaling} style={[Styles.common.title, fontFamily, adaptedFontStyle, this.props.titleStyle]} {...getAccessibilityConfig({
              accessible: false
            })}>
                {this.props.title}
              </Text>
            ...
            {this.props.subtitle ? <Text numberOfLines={subtitleLine} allowFontScaling={this.props.allowFontScaling} style={[Styles.common.subtitle, this.props.subtitleStyle, adaptedFontStyle]} {...getAccessibilityConfig({
            accessible: false
          })}>
                  {this.props.subtitle}
                </Text> : null}
          ...
          <View style={[styles.right, extraRightStyle]}>
            {this.props.value ? <Text numberOfLines={valueLine} allowFontScaling={this.props.allowFontScaling} ellipsizeMode="tail" style={[Styles.common.subtitle, this.props.valueStyle, valueStyle, adaptedFontStyle]} {...getAccessibilityConfig({
            accessible: false
          })}>
                  {this.props.value}
                </Text> : null}
