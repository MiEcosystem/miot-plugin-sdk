...
class TitleBar extends Component {
  ...
  render() {
    ...
    const leftWidth = this.props.leftTextStyle ? this.props.leftTextStyle.width : 0;
    const rightWidth = this.props.rightTextStyle ? this.props.rightTextStyle.width : 0;
    const titleTextStyle = this.isDarkStyle ? styles.blackTitleText : styles.whiteTitleText;
    const subtitleTextStyle = this.isDarkStyle ? styles.blackSubtitleText : styles.whiteSubtitleText;
    const leftRightTextStyle = this.isDarkStyle ? styles.blackLeftRightText : styles.whiteLeftRightText;
    ...
    const message = this.isDarkStyle ? require("../../resources/title/std_tittlebar_main_device_massage_point.png") : require("../../resources/title/std_tittlebar_main_device_massage_point.png"); // 为了保持两端统一，传参的 height 只定义除 StatusBar 外的部分，即覆盖 titleHeight
    ...
    if (height !== undefined) {
      containerHeight = {
        height: (StatusBar.currentHeight || 0) + height
      };
    ...
    return <SafeAreaView style={[containerStyle, this.props.style, containerHeight]}>
        {this.props.leftText ? <RkButton onPress={this.props.onPressLeft} contentStyle={[leftRightTextStyle, this.props.leftTextStyle]} style={[leftRightTextStyle, {
        height: this.props.onPressLeft ? titleHeight : 0,
        width: leftWidth || imgHeight + marginH * 2
        ...
        accessibilityHint: this.props.leftAccessibilityHint
              ...
              {this.props.leftText}
            </RkButton> : <ImageButton onPress={this.props.onPressLeft} style={[styles.img, {
        height: this.props.onPressLeft ? imgHeight : 0
      }]} source={back_n} highlightedSource={back_p} {...getAccessibilityConfig({
        accessible: this.props.onPressLeft ? this.props.accessible : false,
        accessibilityLabel: this.props.leftAccessibilityLabel,
        accessibilityHint: this.props.leftAccessibilityHint
      })} />}
        <ImageButton onPress={this.props.onPressLeft2} style={[styles.img, {
        marginLeft: 0,
        height: this.props.onPressLeft2 ? imgHeight : 0
      }]} source={set_n} highlightedSource={set_p} {...getAccessibilityConfig({
        ...
        accessibilityRole: AccessibilityRoles.header
          ...
          <Text numberOfLines={1} style={[titleTextStyle, this.props.titleStyle]} allowFontScaling={this.props.allowFontScaling} onPress={this.props.onPressTitle}>
            {this.props.title}
          </Text>
          {this.props.subTitle ? <Text numberOfLines={1} style={[subtitleTextStyle, this.props.subtitleStyle]} allowFontScaling={this.props.allowFontScaling} onPress={this.props.onPressTitle}>
                {this.props.subTitle}
              </Text> : null}
        </View>
        <ImageButton onPress={this.props.onPressRight2} style={[styles.img, {
        marginRight: 0,
        height: this.props.onPressRight2 ? imgHeight : 0
      }]} source={share_n} highlightedSource={share_p} {...getAccessibilityConfig({
        ...
        {this.props.rightText ? <RkButton onPress={this.props.onPressRight} contentStyle={[leftRightTextStyle, this.props.rightTextStyle]} style={[leftRightTextStyle, {
        height: this.props.onPressRight ? titleHeight : 0,
        width: rightWidth || imgHeight + marginH * 2
      }]} {...getAccessibilityConfig({
        ...
        accessibilityHint: this.props.rightAccessibilityHint
            ...
            </RkButton> : <ImageButton onPress={this.props.onPressRight} style={[styles.img, {
        height: this.props.onPressRight ? imgHeight : 0
      }]} source={more_n} highlightedSource={more_p} {...getAccessibilityConfig({
        accessible: this.props.onPressRight ? this.props.accessible : false,
        accessibilityLabel: this.props.rightAccessibilityLabel,
        accessibilityHint: this.props.rightAccessibilityHint
      })} />}
        {this.props.showDot && <Image style={[styles.dot, dotTop]} resizeMode="contain" source={message} />}
      </SafeAreaView>;
  }
