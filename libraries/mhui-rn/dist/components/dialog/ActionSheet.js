...
class ActionSheet extends React.Component {
  ...
  render() {
    return <AbstractDialog animationType={this.props.animationType} visible={this.state.visible} dialogStyle={this.props.dialogStyle} showTitle={false} buttons={this.props.buttons} onDismiss={() => this._onDismiss()} canDismiss={this.props.canDismiss} {...getAccessibilityConfig({
      accessible: this.props.accessible
    })}>
        {this.props.options.map((option, index) => <View key={(option.title || '') + index}>
            <ChoiceItem title={option.title || ''} titleStyle={this.props.dialogStyle.itemTitleStyle} subtitle={option.subtitle || ''} subtitleStyle={this.props.dialogStyle.itemSubtitleStyle} allowFontScaling={this.props.dialogStyle.allowFontScaling} unlimitedHeightEnable={this.props.dialogStyle.unlimitedHeightEnable} titleNumberOfLines={this.props.dialogStyle.itemTitleNumberOfLines} subtitleNumberOfLines={this.props.dialogStyle.itemSubtitleNumberOfLines} onPress={() => this._onPress(option.onPress)} {...getAccessibilityConfig({
          accessible: this.props.accessible,
