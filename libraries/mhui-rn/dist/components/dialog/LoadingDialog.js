...
class LoadingDialog extends React.Component {
  ...
  render() {
    ...
    return <AbstractDialog animationType={this.props.animationType} visible={this.state.visible} showTitle={false} canDismiss={false} showButton={false} accessible={this.props.accessible}>
        <View style={[styles.container, heightStyle]} {...getAccessibilityConfig({
        accessible: this.props.accessible,
        accessibilityRole: AccessibilityRoles.text
      })}>
          <BallIndicator style={styles.indicator} color={this.context.theme?.colorGrayHeavier} size={20} />
          <Text style={[styles.message, this.props.dialogStyle.messageStyle]} allowFontScaling={this.props.dialogStyle.allowFontScaling} numberOfLines={this.props.dialogStyle.textNumberOfLines}>
            {this.props.message || ''}
          </Text>
        </View>
      </AbstractDialog>;
