...
class ShareDialog extends React.Component {
  ...
  renderIconsPages(options) {
    ...
    return <Swiper style={styles.swiper} autoplay={false} loop={false} paginationStyle={styles.paginationStyle} dotColor="rgba(0,0,0,0.2)" activeDotColor={theme.colorPrimary} dotStyle={styles.dot} activeDotStyle={styles.dot} {...getAccessibilityConfig({
      accessible: false
    })}>
  ...
  render() {
    ...
    return <AbstractDialog animationType={this.props.animationType} visible={this.props.visible} title={this.props.title} dialogStyle={this.props.dialogStyle} buttons={this.props.buttons} onDismiss={() => this._onDismiss()}>
