...
class AbstractDialog extends React.Component {
  ...
  */
  ...
  renderTitle() {
    ...
    return <View style={[styles.titleContainer, height]} {...getAccessibilityConfig({
  ...
  renderOneButton(buttons) {
    ...
    return <View style={[Styles.dialog.buttons, {
      height
        ...
        <TouchableHighlight style={[Styles.dialog.button, {
  ...
  render() {
    ...
    return <Modal animationType={this.props.animationType} transparent visible={this.state.visible} onRequestClose={() => this.dismiss()}>
        ...
        backgroundColor: theme.colorOverLayerBlack
          ...
          width: Dimensions.get('window').width - MODAL_MARGIN * 2
        }]}>
            {this.renderTitle()}
            {this.renderContent()}
