    ...
    const items = keys.map((key) => {
      ...
      if (item) {
        ...
        if (key === AllOptions.FIRMWARE_UPGRADE && !item.showDot) {
          ...
          Service.smarthome.reportSDKFileLog('[Device][Upgrade] FIRMWARE_UPGRADE', Device.needUpgrade, 'needShowUpgradeRedDot =', this.state.needShowUpgradeRedDot, ', firmwareUpgradeDotClicked = ', firmwareUpgradeDotClicked, Device.lastVersion);
