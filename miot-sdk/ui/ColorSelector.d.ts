 ...
 *                              参数：（index） 当前移动的滑块的index
 */
export default class ColorSelector extends React.Component<any, any, any> {
    static propTypes: {
        ...
        indicatorRadius: PropTypes.Requireable<number>;
        allowIndicatorOverlap: PropTypes.Requireable<boolean>;
        showIndicator: PropTypes.Requireable<boolean>;
        showIndicatorText: PropTypes.Requireable<boolean>;
        showBorder: PropTypes.Requireable<boolean>;
        showWhite: PropTypes.Requireable<boolean>;
        indicatorTexts: PropTypes.Requireable<any[]>;
        onColorChange: PropTypes.Requireable<(...args: any[]) => any>;
        onTrackStart: PropTypes.Requireable<(...args: any[]) => any>;
        onTrackEnd: PropTypes.Requireable<(...args: any[]) => any>;
     ...
     */
    setIndicatorNumberWithColors(number: <number>() => any, indicatorColors?: <array>() => any): void;
    /**
     * 改变指定触摸点的颜色，或可以理解为将触摸点移动到指定颜色的位置
     * note：若需要改变点的数量，推荐使用方法 setIndicatorNumberWithColors
     * @param {<string>} color : rgb color，eg：'#E6312E', '#302EE6'
     * @param {<number>} index : 指定点的index，eg：0， 1
     */
    setColorWithIndex(color: <string>() => any, index: <number_1>() => any): void;
    removeChar(value: any, charToRemove: any): any;
    originColorStrModels(): string[];
    hexToBGR(hex: any): number;
}
