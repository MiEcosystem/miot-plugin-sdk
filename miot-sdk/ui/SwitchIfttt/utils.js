...
export function getTargetDeviceList(homeDeviceList, deviceType, filterMain) {
  ...
  Service.smarthome.reportLog(Device.model, `[homeDeviceList value is : ${ JSON.stringify(homeDeviceList) }`);
  ...
  Service.smarthome.reportLog(Device.model, `[targetDeviceList value is : ${ JSON.stringify(targetDeviceList) }`);
...
export function getTargetSectionDeviceList(homeDeviceList, deviceType) {
  ...
  Service.smarthome.reportLog(Device.model, `[getTargetSectionDeviceList value is : ${ JSON.stringify(targetDeviceList) }`);
  return targetDeviceList;
}
