...
export function getSwitchTypeTitleV2(type = '') {
  ...
  switch (type) {
    ...
    case SWITCH_DEVICE_TYPE.SMART_LIGHT:
      ...
      break;
    case SWITCH_DEVICE_TYPE.SMART_SWITCH:
      switchTypeDescription = I18n.switch_double_control;
      break;
    case SWITCH_DEVICE_TYPE.MANUAL_SCENE:
      switchTypeDescription = I18n.execute_scene;
      break;
    case SWITCH_DEVICE_TYPE.OTHER_SMART_DEVICE:
      switchTypeDescription = I18n.more_smart_devices;
      break;
    default:
      break;
  }
...
export function getSwitchTypeSubTitleV2(type = '') {
  ...
  switch (type) {
    case SWITCH_DEVICE_TYPE.COMMON_DEVICE:
      ...
      break;
    case SWITCH_DEVICE_TYPE.SMART_LIGHT:
      switchTypeDescription = I18n.control_smart_lights_group;
      break;
    case SWITCH_DEVICE_TYPE.SMART_SWITCH:
      switchTypeDescription = I18n.link_other_switches_intercontrol;
      break;
    case SWITCH_DEVICE_TYPE.MANUAL_SCENE:
      switchTypeDescription = I18n.execute_manual_scenes_home;
      break;
    case SWITCH_DEVICE_TYPE.OTHER_SMART_DEVICE:
      switchTypeDescription = I18n.control_other_devices_home;
      break;
    default:
      break;
  }
