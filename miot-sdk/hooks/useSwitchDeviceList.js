...
import { Service, PackageEvent, Device } from 'miot';
...
export default function useSwitchLightDeviceList(devices = []) {
  ...
  const generateSwitchDevice = (devices, devicesSpecs, devicesInfo) => {
    ...
    Service.smarthome.reportLog(Device.model, `[useSwitchLightDeviceList value is : ${ JSON.stringify(supportToggleDevices) }`);
