...
declare const NfcInstance: INfc;
/**
 * NFC
 * @interface
 *
 */
export declare class INfc {
  /**
     * 获取NFC的状态信息
     * since 10051
  ...
  /**
     ...
     * { code: xx, message: 'xx' }
     */
  writeNFCData(params: jsonObject): Promise<any>;
  /**
  * 判断miui是否支持投屏
  ...
  */
  isMiConnectSupportNFC(param?: Object): Promise<any>;
}