...
class IPermission {
  ...
  /**
   * 仅android
   * 原生模块：FixPermissionsModule提供的请求权限接口 
   * @param {permission} permission 例如：android.permission.CAMERA
   * 
   * System.permission.requestPermissionAndroid("android.permission.CAMERA")
   *          .then(result => {
