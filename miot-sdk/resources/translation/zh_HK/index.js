export default {
  ...
  updated: '已更新',
  deviceOfflineCheckNetwork: '裝置離線，請檢查網絡',
  checkNetworkError: '網絡異常，請檢查網絡後重試',
  ...
  switch_dia_msg_repeatScene: '當前按鍵已建立了單按自動化，關聯控制裝置後，自動化可能會重複執行，是否需刪除關聯控制的裝置？',
  ...
  non_smart_device_wired: '透過電線連接的非智能裝置',
  control_smart_lights_group: '控制當前家庭下的智能燈或燈組',
  switch_double_control: '開關雙控',
  link_other_switches_intercontrol: '關聯其他智能開關，實現開關互控',
  execute_scene: '執行場景',
  execute_manual_scenes_home: '執行當前家庭已建立的手動場景，如回家模式',
  more_smart_devices: '更多智能裝置',
  control_other_devices_home: '控制當前家庭下的其他智能裝置，如冷氣機等',
  power_switch: '電源開關',
  turn_off_light_offline: '關閉後，連接了開關的智能燈會斷電離線',
  manage_switch_power: '控制開關開啟或關閉。為了確保智能燈上線，請保持開啟',
  ...
  switch_autoCtrl_confirmToSmart_desc: '切換後，按鍵不再控制開關的通斷，可用於控制當前家庭下的智能型設備',
  ...
  switch_controlType_otherSmartDevice_desc: '控制當前家庭下的其他智能裝置',
  switch_controlType_otherSmartDevice_title: '建立自動化',
  switch_controlType_quickConfig: '快速配置',
  switch_controlType_smartLight_desc: '開啟或關閉智能燈',
  switch_controlType_smartLight_title: '智能燈',
  switch_controlType_switchDualControl_desc: '開啟或關閉其他智能開關',
  ...
  switch_list_empty_light: '當前家庭下沒有支援的燈',
  switch_list_empty_manualScene: '當前家庭下沒有「手動控制」，在「米家」首頁，右上角「+」可建立「手動控制」',
  switch_list_empty_switch: '當前家庭下沒有支援的開關',
