export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'この機能をオンにすると、物理ボタンで回路を制御できなくなります。スマートシーンでは引き続き使用可能です。',
  switch_dia_msg_wirelessSwitchSetting: 'このボタンは別のアイテム (${}) に関連付けられています。ワイヤレススイッチに切り替えてご利用ください。',
  switch_listItem_title_voiceControlLoop: '音声コマンドで回路を操作',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Mi AI で回路を操作',
  switch_listItem_value_voiceControlLoopOn: 'オン',
  switch_listItem_value_voiceControlLoopOff: 'オフ',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Mi AI を使用して回路のオン・オフを切り替えます。スマートライトが回路に接続されている場合、それらの電源と接続が切れる可能性があります。',
  ...
  switch_listItem_subtile_speedModeDescription: '「押す」操作の自動化だけが必要な場合は、このオプションを選択することをお勧めします。選択すると、スイッチが押す操作に素早く反応し、自動化の応答速度が増します。',
  switch_listItem_subtile_standardModeDescription: '「2 回押す」と「長押し」のオートメーションが必要な場合は、このオプションを選択します。',
  switch_dia_msg_speedModeMessage: '現在のデバイスに設定されているオートメーションには、「2 回押す」または「長押し」が含まれます。スーパースピードモードがオンの場合、スマートシーンは応答しません。オンにしてもよろしいですか？',
  ...
  switch_button_title_seeCreatedScene: 'オートメーションを表示',
  ...
  switch_dia_msg_deleteScene: 'このオートメーションを削除しますか？',
