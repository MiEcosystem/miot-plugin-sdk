export default {
  ...
  updateWarningTip: 'アップデート中はデバイスの電源をオフにしたり、使用したりしないでください',
  basicPerformanceUpdate: '基本性能',
  productFunctionUpdate: '製品機能',
  updateFailed: 'アップデートできませんでした',
  partialUpdateFailed: 'このアップデートの一部を完了できませんでした',
  checkUpdateFailed: 'アップデートを確認できませんでした',
  updated: 'アップデートしました',
  deviceOfflineCheckNetwork: 'デバイスはオフラインです。ネットワーク設定を確認してください。',
  checkNetworkError: 'ネットワークエラーが発生しました。数分待ってからもう一度お試しください。',
  alreadyLatest: '現在のバージョンは最新です',
  checkingUpdate: 'アップデートを確認しています…',
  foundNewVersion: 'アップデートが利用可能です',
  version: 'バージョン',
  updating: '更新しています…',
  more: '追加設定',
  help: 'ヘルプ',
  ...
  cloutStorageSetting: 'クラウドストレージのその他の設定',
  open: 'オン',
  close: 'オフ',
  other: 'その他',
  ...
  switch_dia_msg_repeatScene: 'このボタンには既に 1 回押した場合の自動化が設定されてます。デバイスを接続すると、繰り返し実行される可能性があります。接続されているデバイスを取り外しますか？',
  common_loading: 'お待ちください...',
  pairMode: 'ペアリングモード',
  ...
  select_control_type: '制御の種類を選択してください',
  non_smart_device_wired: '有線接続で非スマートデバイスを制御します',
  control_smart_lights_group: 'この家のスマート照明または照明グループを制御します',
  switch_double_control: 'デュアルスイッチ制御',
  link_other_switches_intercontrol: '相互に制御できるように、他のスマートスイッチに接続します',
  execute_scene: 'インテリジェントシーンを実行',
  execute_manual_scenes_home: 'マニュアルシーン (例: 帰宅) を実行します',
  more_smart_devices: 'その他のスマートデバイス',
  control_other_devices_home: 'この家のその他のスマートデバイス (例: エアコン) を制御します',
  power_switch: '電源スイッチ',
  turn_off_light_offline: 'これをオフにすると、接続されているスマート照明の電源が切れ、オフラインとなります',
  manage_switch_power: 'スイッチをオンまたはオフにします。スマート照明をオンラインに維持するには、オンのままにしてください。',
  automation_toggle_btn: '切り替え',
  save: '保存',
  add_device_type: 'デバイスタイプを追加',
  common_brand_produced_by: '${}によるデザイン',
  automation_add_control_device: 'デバイスを追加する',
  automation_edit_btn: '編集する',
  switch_autoCtrl_confirmToSmart_desc: '切り替え後は、ボタンによるスイッチのオン・オフの切り替えは行われず、この家のスマートデバイスの制御に使用できます。',
  switch_autoCtrl_confirmToSmart_title: '無線モードに切り替えますか？',
  switch_autoCtrl_confirmToSpeedMode_desc: 'スーパースピードモードでは、「2 回押す」と「長押し」の自動化は実行されません。',
  switch_autoCtrl_confirmToSpeedMode_title: 'スーパースピードモードに切り替えますか？',
  switch_autoCtrl_confirmToTraditional_desc: '切り替え後は、ボタンによるスマートデバイスの制御は行われず、関連する自動化は実行されません。',
  switch_autoCtrl_confirmToTraditional_title: '有線モードに切り替えますか？',
  switch_autoCtrl_ctrlSection: '制御',
  switch_autoCtrl_modeSection: 'モード',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'オフにした場合、接続されたデバイスの電源が切られ、オフラインになります',
  switch_autoCtrl_powerSwitch_title: '電源の制御',
  switch_autoCtrl_selectControlDevice_title: 'デバイスの選択',
  switch_autoCtrl_smartMode_desc: 'ボタンを使用して、スマートライトやスマートスイッチなどのスマートデバイスを制御します',
  switch_autoCtrl_smartMode_title: '無線モード',
  switch_autoCtrl_traditionalMode_desc: '通常の照明や排気扇などの標準的なデバイスに接続する場合は、このモードを使用します',
  switch_autoCtrl_traditionalMode_title: '有線モード',
  switch_autoCtrl_wirelessHint_title: 'ワイヤレスモードに切り替えた後は、「1 回押す」、「2 回押す」、「長押し」の自動化が利用可能です',
  switch_controlType_advancedConfig: '高度な設定',
  switch_controlType_manualScene_desc: '既存のマニュアルシーン (例: 帰宅) を実行します',
  switch_controlType_manualScene_title: '手動制御',
  switch_controlType_otherSmartDevice_desc: 'この家のその他のスマートデバイスを制御します',
  switch_controlType_otherSmartDevice_title: '自動化の作成',
  switch_controlType_quickConfig: 'クイックセットアップ',
  switch_controlType_smartLight_desc: 'スマートライトのオンとオフを切り替えます',
  switch_controlType_smartLight_title: 'スマートライト',
  switch_controlType_switchDualControl_desc: 'その他のスマートスイッチのオンとオフを切り替えます',
  switch_controlType_switchDualControl_title: 'デュアルスイッチ制御',
  switch_layoutDetail_editIcon: 'アイコンを変更',
  switch_layoutDetail_name: '名前',
  switch_layoutDetail_room: '部屋',
  switch_list_empty_light: 'この家には対応する照明がありません',
  switch_list_empty_manualScene: 'この家には手動制御がありません。Xiaomi Home のスタートページから追加してください。',
  switch_list_empty_switch: 'この家には対応するスイッチがありません',
  switch_menu_deleteConfig: '設定の削除',
  switch_multikey_iconCategory_default: 'デフォルト',
  switch_multikey_iconCategory_light: '照明',
  switch_multikey_iconCategory_other: 'その他',
  switch_multikey_iconSelect_title: 'アイコン',
  switch_multikey_roomSelect_createFail: '部屋を作成できませんでした',
  switch_multikey_roomSelect_createNew: '部屋を作成',
  switch_multikey_roomSelect_inputPlaceholder: '部屋名を入力してください',
