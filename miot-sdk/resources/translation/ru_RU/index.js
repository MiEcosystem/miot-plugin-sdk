export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'Когда эта функция включена, физические кнопки не смогут управлять цепями. Вы по-прежнему сможете использовать их для умных сценариев.',
  ...
  switch_listItem_title_voiceControlLoop: 'Схемы управления с голосовыми командами',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Схемы управления с Mi AI',
  switch_listItem_value_voiceControlLoopOn: 'Вкл.',
  switch_listItem_value_voiceControlLoopOff: 'Откл.',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Активируйте и выключайте схемы с помощью Mi AI. Если в цепь включены умные осветительные приборы,  они могут быть выключены и отключены.',
  ...
  switch_listItem_subtile_speedModeDescription: 'Рекомендуется выбрать этот вариант, если автоматизация требуется только для действия «Нажать». После выбора выключатель будет быстро реагировать на действие нажатия, повышая скорость отклика автоматизации.',
  switch_listItem_subtile_standardModeDescription: 'Выберите этот вариант, если требуется автоматизация для действия «Двойное нажатие» и «Долгое нажатие». ',
  switch_dia_msg_speedModeMessage: 'Автоматизация, настроенная на текущем устройстве, включает действие «Двойное нажатие» или «Долгое нажатие». Если включен суперскоростной режим, умный сценарий не будет активирован. Включить?',
