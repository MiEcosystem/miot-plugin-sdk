export default {
  ...
  // 常用设备
  favoriteDevices: 'Εμφάνιση στην αρχική σελίδα της Xiaomi Home',
  favoriteCamera: 'Εναλλαγή στη μεγάλη κάρτα',
  ...
  noSuppurtedLinkageTip: '1. Βεβαιωθείτε ότι έχετε προσθέσει τις συσκευές στην εφαρμογή Xiaomi Home και ότι τις έχετε εκχωρήσει σε δωμάτια.\\n2. Κρατήστε τις συσκευές με Bluetooth κοντά στη συσκευή για να τις συνδέσετε με επιτυχία.',
  ...
  releaseNote: 'Ενημέρωση αρχείων καταγραφής',
  releaseVersionHistory: 'Ιστορικό ενημέρωσης υλικολογισμικού',
  firmwareAutoUpdate: 'Αυτόματες ενημερώσεις υλικολογισμικού',
  autoUpdateDescriptionNote: 'Όταν εντοπιστεί υλικολογισμικό, η συσκευή θα προσπαθήσει να κάνει αυτόματη ενημέρωση μεταξύ {0}. Η ενημέρωση θα εγκατασταθεί όταν δεν χρησιμοποιείτε τη συσκευή και κατά τη διάρκεια της διαδικασίας ενημέρωσης δεν θα λαμβάνετε φωνητικές ή φωτεινές ειδοποιήσεις.',
  updateNow: 'Ενημέρωση',
  ...
  stdGuideDialogSubTitle: 'Ενημερώστε την εφαρμογή για μια νέα, απλοποιημένη εμπειρία.',
