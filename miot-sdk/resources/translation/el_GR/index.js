export default {
  ...
  updateWarningTip: 'Μην απενεργοποιήσετε ή χρησιμοποιήσετε τη συσκευή κατά τη διάρκεια της ενημέρωσης',
  basicPerformanceUpdate: 'Βασική απόδοση',
  productFunctionUpdate: 'Χαρακτηριστικά προϊόντος',
  updateFailed: 'Η ενημέρωση δεν ήταν δυνατή',
  partialUpdateFailed: 'Δεν ήταν δυνατή η ολοκλήρωση μέρους αυτής της ενημέρωσης',
  checkUpdateFailed: 'Δεν ήταν δυνατός ο έλεγχος για ενημερώσεις',
  updated: 'Ενημερώθηκε',
  deviceOfflineCheckNetwork: 'Η συσκευή είναι εκτός σύνδεσης. Ελέγξτε τις ρυθμίσεις δικτύου.',
  checkNetworkError: 'Παρουσιάστηκε σφάλμα δικτύου. Περιμένετε ένα με δύο λεπτά και προσπαθήστε ξανά.',
  alreadyLatest: 'Η τρέχουσα έκδοση είναι ενημερωμένη',
  ...
  cloutStorageSetting: 'Περισσότερες ρυθμίσει αποθήκευσης στο cloud',
  open: 'Ενεργοποιημένο',
  close: 'Ανενεργό',
  other: 'Άλλα',
  ...
  switch_dia_msg_repeatScene: 'Αυτό το κουμπί έχει ήδη αυτοματισμό με μία μόνο πίεση. Η σύνδεση μιας συσκευής μπορεί να προκαλέσει επαναλαμβανόμενη ενεργοποίηση. Να αφαιρεθεί η συνδεδεμένη συσκευή;',
  common_loading: 'Μια στιγμή…',
  ...
  select_control_type: 'Επιλογή τύπου ελέγχου',
  non_smart_device_wired: 'Έλεγχος μη έξυπνων συσκευών μέσω ενσύρματης σύνδεσης',
  control_smart_lights_group: 'Έλεγχος έξυπνων φώτων ή ομάδων φωτισμού σε αυτό το σπίτι',
  switch_double_control: 'Έλεγχος με διπλό διακόπτη',
  link_other_switches_intercontrol: 'Συνδέστε άλλους έξυπνους διακόπτες ώστε να ελέγχουν ο ένας τον άλλον',
  execute_scene: 'Εκτέλεση σκηνής',
  execute_manual_scenes_home: 'Εκτέλεση υπάρχουσας χειροκίνητης σκηνής (π.χ. "Επιστροφή στο σπίτι")',
  more_smart_devices: 'Περισσότερες έξυπνες συσκευές',
  control_other_devices_home: 'Έλεγχος άλλων έξυπνων συσκευών σε αυτό το σπίτι (π.χ. κλιματιστικό)',
  power_switch: 'Διακόπτης τροφοδοσίας',
  turn_off_light_offline: 'Αν το απενεργοποιήσετε, το συνδεδεμένο έξυπνο φως δεν θα έχει τροφοδοσία και θα αποσυνδεθεί',
  manage_switch_power: 'Ανοίξτε ή κλείστε τον διακόπτη. Για να παραμείνουν τα έξυπνα φώτα συνδεδεμένα, αφήστε τον ανοιχτό.',
  automation_toggle_btn: 'Εναλλαγή',
  save: 'Αποθήκευση',
  add_device_type: 'Προσθήκη τύπου συσκευής',
  common_brand_produced_by: 'Σχεδιάστηκε από ${}',
  automation_add_control_device: 'Προσθήκη συσκευών',
  automation_edit_btn: 'Επεξεργασία',
  switch_autoCtrl_confirmToSmart_desc: 'Μετά τη μετάβαση, το κουμπί δεν θα ενεργοποιεί ή απενεργοποιεί πλέον τον διακόπτη και θα μπορεί να χρησιμοποιείται για τον έλεγχο έξυπνων συσκευών στο σπίτι.',
  switch_autoCtrl_confirmToSmart_title: 'Μετάβαση σε ασύρματη λειτουργία;',
  switch_autoCtrl_confirmToSpeedMode_desc: 'Στην Πολύ γρήγορη λειτουργία, οι αυτοματισμοί με διπλό πάτημα και παρατεταμένο πάτημα δεν εκτελούνται.',
  switch_autoCtrl_confirmToSpeedMode_title: 'Μετάβαση σε Πολύ γρήγορη λειτουργία;',
  switch_autoCtrl_confirmToTraditional_desc: 'Μετά τη μετάβαση, το κουμπί δεν θα ελέγχει πλέον τις έξυπνες συσκευές και οι σχετικοί αυτοματισμοί δεν θα εκτελούνται.',
  switch_autoCtrl_confirmToTraditional_title: 'Μετάβαση σε ενσύρματη λειτουργία;',
  switch_autoCtrl_ctrlSection: 'Έλεγχος',
  switch_autoCtrl_modeSection: 'Λειτουργία',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'Όταν είναι απενεργοποιημένο, οι συνδεδεμένες συσκευές θα χάσουν την παροχή ρεύματος και θα εμφανιστούν εκτός σύνδεσης',
  switch_autoCtrl_powerSwitch_title: 'Έλεγχος ισχύος',
  switch_autoCtrl_selectControlDevice_title: 'Επιλέξτε συσκευές',
  switch_autoCtrl_smartMode_desc: 'Χρησιμοποιήστε το κουμπί για να ελέγχετε έξυπνες συσκευές, όπως έξυπνα φώτα ή έξυπνους διακόπτες',
  switch_autoCtrl_smartMode_title: 'Ασύρματη λειτουργία',
  switch_autoCtrl_traditionalMode_desc: 'Χρησιμοποιήστε αυτή τη λειτουργία όταν είστε συνδεδεμένοι με τυπικές συσκευές, όπως απλά φωτιστικά ή εξαεριστήρες',
  switch_autoCtrl_traditionalMode_title: 'Ενσύρματη λειτουργία',
  switch_autoCtrl_wirelessHint_title: 'Οι αυτοματισμοί για μονό πάτημα, διπλό πάτημα και παρατεταμένο πάτημα είναι διαθέσιμοι αφού μεταβείτε σε ασύρματη λειτουργία',
  switch_controlType_advancedConfig: 'Προχωρημένη ρύθμιση',
  switch_controlType_manualScene_desc: 'Εκτέλεση υπαρχουσών χειροκίνητων αυτοματισμών (π.χ. “Επιστροφή στο σπίτι”)',
  switch_controlType_manualScene_title: 'Χειροκίνητος έλεγχος',
  switch_controlType_otherSmartDevice_desc: 'Έλεγχος άλλων έξυπνων συσκευών σε αυτό το σπίτι',
  switch_controlType_otherSmartDevice_title: 'Δημιουργία αυτοματισμού',
  switch_controlType_quickConfig: 'Γρήγορη ρύθμιση',
  switch_controlType_smartLight_desc: 'Ενεργοποίηση ή απενεργοποίηση του έξυπνου φωτισμού',
  switch_controlType_smartLight_title: 'Έξυπνος φωτισμός',
  switch_controlType_switchDualControl_desc: 'Ενεργοποίηση ή απενεργοποίηση άλλων έξυπνων διακοπτών',
  switch_controlType_switchDualControl_title: 'Έλεγχος διπλού διακόπτη',
  switch_layoutDetail_editIcon: 'Αλλαγή εικονιδίου',
  switch_layoutDetail_name: 'Όνομα',
  switch_layoutDetail_room: 'Δωμάτιο',
  switch_list_empty_light: 'Δεν υπάρχουν υποστηριζόμενα φώτα σε αυτό το σπίτι',
  switch_list_empty_manualScene: 'Δεν υπάρχουν χειροκίνητοι έλεγχοι σε αυτό το σπίτι. Προσθέστε τους από την αρχική σελίδα του Xiaomi Home.',
  switch_list_empty_switch: 'Δεν υπάρχουν υποστηριζόμενοι διακόπτες σε αυτό το σπίτι',
  switch_menu_deleteConfig: 'Διαγραφή διαμόρφωσης',
  switch_multikey_iconCategory_default: 'Προεπιλογή',
  switch_multikey_iconCategory_light: 'Φωτισμός',
  switch_multikey_iconCategory_other: 'Άλλο',
  switch_multikey_iconSelect_title: 'Εικονίδιο',
  switch_multikey_roomSelect_createFail: 'Δεν ήταν δυνατή η δημιουργία δωματίου',
  switch_multikey_roomSelect_createNew: 'Δημιουργία δωματίου',
  switch_multikey_roomSelect_inputPlaceholder: 'Εισαγωγή ονόματος δωματίου',
