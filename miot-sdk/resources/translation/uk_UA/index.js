export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'Якщо цю функцію увімкнено, фізичні кнопки не зможуть керувати схемами. Ви все ще зможете використовувати їх для смарт-сценарієв.',
  ...
  switch_listItem_title_voiceControlLoop: 'Схеми керування за допомогою голосових команд',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Схеми керування з Mi AI',
  switch_listItem_value_voiceControlLoopOn: 'Увімк.',
  switch_listItem_value_voiceControlLoopOff: 'Вимк.',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Вмикайте та вимикайте ланцюги за допомогою Mi AI. Якщо в ланцюг включені розумні лампи, вони можуть бути вимкнені або відключені.',
  ...
  switch_listItem_subtile_speedModeDescription: 'Якщо автоматизація потрібна лише для дії «натискання», рекомендується вибрати цю опцію. Після вибору вимикач буде швидко реагувати на дію натискання, покращуючи швидкість реакції автоматики.',
  switch_listItem_subtile_standardModeDescription: 'Якщо для автоматизаціяя необхідна для дії "подвійне натиснення" або "натисніть та утримуйте", то виберіть цю опцію.',
  switch_dia_msg_speedModeMessage: 'Автоматизація, налаштована на поточному пристрої, включає "подвійне натиснення " або "натисніть та утримуйте". Смарт-сцена не реагує, коли увімкнено Супершвидкісний режим. Увімкнути?',
