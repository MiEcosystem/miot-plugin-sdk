export default {
  ...
  updateWarningTip: 'Не вимикайте та не використовуйте пристрій під час оновлення',
  basicPerformanceUpdate: 'Базова продуктивність',
  productFunctionUpdate: 'Функції пристрою',
  updateFailed: 'Не вдалося оновити',
  partialUpdateFailed: 'Не вдалося завершити частину оновлення',
  checkUpdateFailed: 'Не вдалося перевірити оновлення',
  updated: 'Оновлено',
  deviceOfflineCheckNetwork: 'Пристрій офлайн. Перевірте налаштування мережі.',
  checkNetworkError: 'Сталася мережева помилка. Зачекайте хвилину-дві та спробуйте знову.',
  alreadyLatest: 'Установлено найновішу версію',
  ...
  cloutStorageSetting: 'Додаткові налаштування хмарного сховища',
  open: 'Увімк.',
  close: 'Вимк.',
  other: 'Інше',
  ...
  switch_dia_msg_repeatScene: 'Ця кнопка вже має автоматизацію при одноразовому натисканні. Підключення пристрою може призвести до її багаторазового спрацьовування. Видалити підключений пристрій?',
  common_loading: 'Зачекайте хвилинку…',
  ...
  select_control_type: 'Виберіть тип керування',
  non_smart_device_wired: 'Керування не смарт-пристроями через дротове з\'єднання',
  control_smart_lights_group: 'Керуйте розумним освітленням або групами освітлення в цьому будинку',
  switch_double_control: 'Керування подвійним перемикачем',
  link_other_switches_intercontrol: 'Підключіться до інших розумних перемикачів, щоб вони керували один одним',
  execute_scene: 'Запустити сценарій',
  execute_manual_scenes_home: 'Запустити існуючий ручний сценарій (наприклад, «Повернення додому»)',
  more_smart_devices: 'Більше смарт-пристроїв',
  control_other_devices_home: 'Керуйте іншими смарт-пристроями в цьому будинку (наприклад, кондиціонером)',
  power_switch: 'Вимикач живлення',
  turn_off_light_offline: 'Якщо ви вимкнете це, підключене розумне освітлення втратить живлення і перейде в офлайн-режим',
  manage_switch_power: 'Увімкніть або вимкніть перемикач. Щоб розумне освітлення залишалося онлайн, залиште його ввімкненим.',
  automation_toggle_btn: 'Перемикнутися',
  save: 'Зберегти',
  add_device_type: 'Додати тип пристрою',
  common_brand_produced_by: 'Розроблено ${}',
  automation_add_control_device: 'Додати пристрої',
  automation_edit_btn: 'Редагувати',
  switch_autoCtrl_confirmToSmart_desc: 'Після перемикання ця кнопка більше не буде вмикати чи вимикати перемикач, а слугуватиме для керування смарт-пристроями в цьому будинку.',
  switch_autoCtrl_confirmToSmart_title: 'Перемкнутися в бездротовий режим?',
  switch_autoCtrl_confirmToSpeedMode_desc: 'У режимі Супершвидкість автоматичні функції, що передбачають подвійне натискання або натискання з утриманням, не працюють.',
  switch_autoCtrl_confirmToSpeedMode_title: 'Перейти в режим Супершвидкість?',
  switch_autoCtrl_confirmToTraditional_desc: 'Після перемикання ця кнопка більше не керуватиме смарт-пристроями, а відповідні автоматизовані дії не виконуватимуться.',
  switch_autoCtrl_confirmToTraditional_title: 'Перемкнутися в дротовий режим?',
  switch_autoCtrl_ctrlSection: 'Контроль',
  switch_autoCtrl_modeSection: 'Режим',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'У вимкненому стані підключені пристрої втратять живлення та перейдуть в автономний режим',
  switch_autoCtrl_powerSwitch_title: 'Керування живленням',
  switch_autoCtrl_selectControlDevice_title: 'Вибрати пристрої',
  switch_autoCtrl_smartMode_desc: 'Використовуйте цю кнопку для керування смарт-пристроями, такими як смарт-світильники або смарт-перемикачі',
  switch_autoCtrl_smartMode_title: 'Бездротовий режим',
  switch_autoCtrl_traditionalMode_desc: 'Використовуйте цей режим під час підключення до стандартних пристроїв, таких як звичайні світильники або витяжні вентилятори',
  switch_autoCtrl_traditionalMode_title: 'Дротовий режим',
  switch_autoCtrl_wirelessHint_title: 'Після переходу в бездротовий режим доступні функції одноразового натискання, подвійного натискання та натискання з утриманням',
  switch_controlType_advancedConfig: 'Розширене налаштування',
  switch_controlType_manualScene_desc: 'Запустити існуючі ручні сценарії (наприклад, «Повернення додому»)',
  switch_controlType_manualScene_title: 'Ручне керування',
  switch_controlType_otherSmartDevice_desc: 'Керуйте іншими смарт-пристроями в цьому будинку',
  switch_controlType_otherSmartDevice_title: 'Створити автоматизацію',
  switch_controlType_quickConfig: 'Швидке налаштування',
  switch_controlType_smartLight_desc: 'Увімкнути або вимкнути смарт-світильники',
  switch_controlType_smartLight_title: 'Смарт-світильники',
  switch_controlType_switchDualControl_desc: 'Увімкнути або вимкнути інші смарт-перемикачі',
  switch_controlType_switchDualControl_title: 'Подвійне керування перемикачем',
  switch_layoutDetail_editIcon: 'Змінити значок',
  switch_layoutDetail_name: 'Назва',
  switch_layoutDetail_room: 'Кімната',
  switch_list_empty_light: 'У цьому будинку немає підтримуваних світильників',
  switch_list_empty_manualScene: 'У цьому будинку немає ручних елементів керування. Додайте їх зі стартової сторінки Xiaomi Home.',
  switch_list_empty_switch: 'У цьому будинку немає підтримуваних перемикачів',
  switch_menu_deleteConfig: 'Видалити конфігурацію',
  switch_multikey_iconCategory_default: 'За замовчуванням',
  switch_multikey_iconCategory_light: 'Підсвітка',
  switch_multikey_iconCategory_other: 'Інше',
  switch_multikey_iconSelect_title: 'Значок',
  switch_multikey_roomSelect_createFail: 'Не вдалося створити кімнату',
  switch_multikey_roomSelect_createNew: 'Створить кімнату',
  switch_multikey_roomSelect_inputPlaceholder: 'Введіть назву кімнати',
  ...
  switch_autoCtrl_confirmToTraditionalDeleteConfig_desc: 'Після перемикання ця кнопка більше не керуватиме смарт-пристроями, а відповідні налаштування керування будуть видалені.',
  switch_autoCtrl_speedModeDescription: 'Підтримує одноразове натискання для швидшої реакції',
  switch_autoCtrl_standardModeDescription: 'Підтримує одноразове натискання, подвійне натискання та натискання з утриманням',
  switch_autoCtrl_multipleControlsHint: 'Підключіть лише один елемент керування',
};