export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'Tombol fisik tidak akan bisa mengontrol sirkuit saat fitur ini hidup. Anda masih bisa menggunakannya untuk adegan cerdas.',
  ...
  switch_listItem_title_voiceControlLoop: 'Kontrol sirkuit dengan perintah suara',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Kontrol sirkuit dengan Mi AI',
  switch_listItem_value_voiceControlLoopOn: 'Hidup',
  switch_listItem_value_voiceControlLoopOff: 'Mati',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Aktifkan dan nonaktifkan sirkuit menggunakan Mi AI. Jika lampu cerdas disertakan dalam sirkuit, lampu tersebut dapat dimatikan dan diputuskan.',
  ...
  switch_listItem_subtile_speedModeDescription: 'Jika otomatisasi hanya diperlukan untuk tindakan "tekan", maka disarankan untuk memilih opsi ini. Setelah dipilih, sakelar akan merespons tindakan menekan dengan cepat, yang meningkatkan kecepatan respons otomatisasi.',
  switch_listItem_subtile_standardModeDescription: 'Jika otomatisasi diperlukan untuk "tekan 2x" dan "tekan lama", pilih opsi ini.',
  switch_dia_msg_speedModeMessage: 'Otomatisasi yang dikonfigurasi pada perangkat saat ini mencakup "tekan 2x" atau "tekan lama". Adegan cerdas tidak akan merespons saat mode Kecepatan Super dihidupkan. Tetap hidupkan?',
