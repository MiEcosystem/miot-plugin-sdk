export default {
  ...
  updateWarningTip: 'Jangan matikan atau gunakan perangkat selama proses pembaruan',
  basicPerformanceUpdate: 'Performa dasar',
  productFunctionUpdate: 'Fitur produk',
  updateFailed: 'Tidak dapat memperbarui',
  partialUpdateFailed: 'Tak dapat menyelesaikan bagian dari pembaruan ini',
  checkUpdateFailed: 'Tidak dapat memeriksa pembaruan',
  updated: 'Diperbarui',
  deviceOfflineCheckNetwork: 'Perangkat sedang offline. Periksa setelan jaringan.',
  checkNetworkError: 'Terjadi kesalahan jaringan. Tunggu sebentar dan coba lagi.',
  alreadyLatest: 'Versi saat ini sudah paling baru',
  ...
  cloutStorageSetting: 'Setelan penyimpanan cloud lainnya',
  open: 'Hidup',
  close: 'Mati',
  other: 'Lainnya',
  ...
  switch_dia_msg_repeatScene: 'Tombol ini sudah punya otomasi sekali tekan. Menghubungkan perangkat mungkin menyebabkannya terpicu berulang kali. Copot perangkat terhubung?',
  common_loading: 'Tunggu sebentar…',
  ...
  select_control_type: 'Pilih jenis kontrol',
  non_smart_device_wired: 'Kontrol perangkat non-cerdas melalui koneksi kabel',
  control_smart_lights_group: 'Kontrol lampu cerdas atau kelompok lampu di rumah ini',
  switch_double_control: 'Kontrol sakelar ganda',
  link_other_switches_intercontrol: 'Hubungkan ke sakelar cerdas lainnya sehingga dapat saling mengontrol',
  execute_scene: 'Jalankan skenario',
  execute_manual_scenes_home: 'Jalankan skenario manual yang ada (mis. "Kembali ke rumah")',
  more_smart_devices: 'Perangkat cerdas lainnya',
  control_other_devices_home: 'Kontrol perangkat cerdas lain di rumah ini (mis. AC)',
  power_switch: 'Sakelar daya',
  turn_off_light_offline: 'Jika dinonaktifkan, lampu cerdas yang terhubung akan kehilangan daya dan menjadi offline',
  manage_switch_power: 'Aktifkan atau nonaktifkan sakelar. Agar lampu cerdas tetap online, biarkan sakelar aktif.',
  automation_toggle_btn: 'Alihkan',
  save: 'Simpan',
  add_device_type: 'Tambahkan jenis perangkat',
  common_brand_produced_by: 'Dirancang oleh ${}',
  automation_add_control_device: 'Tambahkan perangkat',
  automation_edit_btn: 'Edit',
  switch_autoCtrl_confirmToSmart_desc: 'Setelah beralih, tombol tidak akan mengaktifkan atau menonaktifkan sakelar lagi, dan dapat digunakan untuk mengontrol perangkat cerdas di rumah ini.',
  switch_autoCtrl_confirmToSmart_title: 'Beralih ke mode nirkabel?',
  switch_autoCtrl_confirmToSpeedMode_desc: 'Dalam mode Kecepatan super, otomatisasi tekan dua kali dan tekan lama tidak akan berjalan.',
  switch_autoCtrl_confirmToSpeedMode_title: 'Beralih ke mode Kecepatan super?',
  switch_autoCtrl_confirmToTraditional_desc: 'Setelah beralih, tombol tidak akan mengontrol perangkat cerdas lagi, dan otomatisasi terkait tidak akan berjalan.',
  switch_autoCtrl_confirmToTraditional_title: 'Beralih ke mode kabel?',
  switch_autoCtrl_ctrlSection: 'Kontrol',
  switch_autoCtrl_modeSection: 'Mode',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'Saat dinonaktifkan, perangkat yang terhubung akan kehilangan daya dan offline',
  switch_autoCtrl_powerSwitch_title: 'Kontrol daya',
  switch_autoCtrl_selectControlDevice_title: 'Pilih perangkat',
  switch_autoCtrl_smartMode_desc: 'Gunakan tombol untuk mengontrol perangkat cerdas, seperti lampu cerdas atau sakelar cerdas',
  switch_autoCtrl_smartMode_title: 'Mode nirkabel',
  switch_autoCtrl_traditionalMode_desc: 'Gunakan mode ini saat terhubung ke perangkat standar, seperti lampu biasa atau kipas angin',
  switch_autoCtrl_traditionalMode_title: 'Mode kabel',
  switch_autoCtrl_wirelessHint_title: 'Otomatisasi tekan satu kali, tekan dua kali, dan tekan lama tersedia setelah Anda beralih ke mode nirkabel',
  switch_controlType_advancedConfig: 'Pengaturan lanjutan',
  switch_controlType_manualScene_desc: 'Jalankan skenario manual yang ada (misalnya "Kembali ke rumah")',
  switch_controlType_manualScene_title: 'Kontrol manual',
  switch_controlType_otherSmartDevice_desc: 'Kontrol perangkat cerdas lainnya di rumah ini',
  switch_controlType_otherSmartDevice_title: 'Buat otomatisasi',
  switch_controlType_quickConfig: 'Pengaturan cepat',
  switch_controlType_smartLight_desc: 'Nyalakan atau matikan lampu cerdas',
  switch_controlType_smartLight_title: 'Lampu cerdas',
  switch_controlType_switchDualControl_desc: 'Aktifkan atau nonaktifkan sakelar cerdas lainnya',
  switch_controlType_switchDualControl_title: 'Kontrol sakelar ganda',
  switch_layoutDetail_editIcon: 'Ubah ikon',
  switch_layoutDetail_name: 'Nama',
  switch_layoutDetail_room: 'Ruangan',
  switch_list_empty_light: 'Tidak ada lampu yang didukung di rumah ini',
  switch_list_empty_manualScene: 'Tidak ada kontrol manual di rumah ini. Tambahkan dari halaman awal Xiaomi Home.',
  switch_list_empty_switch: 'Tidak ada sakelar yang didukung di rumah ini',
  switch_menu_deleteConfig: 'Hapus konfigurasi',
  switch_multikey_iconCategory_default: 'Default',
  switch_multikey_iconCategory_light: 'Lampu',
  switch_multikey_iconCategory_other: 'Lainnya',
  switch_multikey_iconSelect_title: 'Ikon',
  switch_multikey_roomSelect_createFail: 'Tidak dapat membuat ruangan',
  switch_multikey_roomSelect_createNew: 'Buat ruangan',
  switch_multikey_roomSelect_inputPlaceholder: 'Masukkan nama kamar',
