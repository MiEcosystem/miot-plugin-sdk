export default {
  ...
  updateWarningTip: '업데이트 중에 전원을 끄거나 기기를 사용하지 마세요.',
  basicPerformanceUpdate: '기본 성능',
  productFunctionUpdate: '제품 기능',
  updateFailed: '업데이트 실패',
  partialUpdateFailed: '업데이트 일부를 완료할 수 없습니다.',
  checkUpdateFailed: '업데이트 확인 실패',
  updated: '업데이트됨',
  deviceOfflineCheckNetwork: '기기가 오프라인 상태입니다. 네트워크 설정을 확인하세요.',
  checkNetworkError: '네트워크 오류가 발생했습니다. 1-2분 후 다시 시도하세요.',
  alreadyLatest: '현재 버전은 최신 상태입니다.',
  ...
  cloutStorageSetting: '클라우드 저장소 설정 더 보기',
  open: '켜짐',
  close: '꺼짐',
  other: '기타',
  ...
  switch_dia_msg_repeatScene: '이 버튼에는 이미 단일 클릭 자동화가 설정되어 있습니다. 기기를 연결하면 자동 실행이 반복될 수 있습니다. 연결된 기기를 제거할까요?',
  common_loading: '잠시만 기다려주세요…',
  pairMode: '페어링 모드',
  ...
  select_control_type: '제어 유형 선택',
  non_smart_device_wired: '유선 연결을 통해 스마트 기능이 없는 기기 제어',
  control_smart_lights_group: '이 집의 스마트 조명 또는 조명 그룹 제어',
  switch_double_control: '이중 스위치 제어',
  link_other_switches_intercontrol: '다른 스마트 스위치와 연결하여 서로 제어하도록 설정',
  execute_scene: '씬 실행',
  execute_manual_scenes_home: '기존 수동 씬(예: "귀가") 실행',
  more_smart_devices: '스마트 기기 더 보기',
  control_other_devices_home: '이 집의 다른 스마트 기기 제어',
  power_switch: '전원 스위치',
  turn_off_light_offline: '스위치를 끄면 연결된 스마트 조명의 전원이 차단되어 오프라인 상태로 전환됩니다.',
  manage_switch_power: '스위치를 켜거나 끌 수 있습니다. 스마트 조명을 온라인 상태로 유지하려면 켜두세요.',
  automation_toggle_btn: '스위치',
  save: '저장',
  add_device_type: '기기 유형 추가',
  common_brand_produced_by: '디자인: ${}',
  automation_add_control_device: '기기 추가',
  automation_edit_btn: '편집',
  switch_autoCtrl_confirmToSmart_desc: '전환 후에는 버튼으로 더 이상 스위치를 켜거나 끌 수 없지만 이 집의 스마트 기기를 제어할 수 있습니다.',
  switch_autoCtrl_confirmToSmart_title: '무선 모드로 전환하시겠습니까?',
  switch_autoCtrl_confirmToSpeedMode_desc: '슈퍼 스피드 모드에서는 두 번 누르기 및 길게 누르기 자동화가 실행되지 않습니다.',
  switch_autoCtrl_confirmToSpeedMode_title: '슈퍼 스피드 모드로 전환하시겠습니까?',
  switch_autoCtrl_confirmToTraditional_desc: '전환 후에는 버튼으로 더 이상 스마트 기기를 제어할 수 없으며 관련 자동화가 실행되지 않습니다.',
  switch_autoCtrl_confirmToTraditional_title: '유선 모드로 전환하시겠습니까?',
  switch_autoCtrl_ctrlSection: '제어',
  switch_autoCtrl_modeSection: '모드',
  switch_autoCtrl_powerSwitch_confirmOff_desc: '기능을 끄면 연결된 기기의 전원이 꺼지고 오프라인 상태가 됩니다.',
  switch_autoCtrl_powerSwitch_title: '전원 제어',
  switch_autoCtrl_selectControlDevice_title: '기기 선택',
  switch_autoCtrl_smartMode_desc: '스마트 조명, 스마트 스위치 같은 스마트 기기를 제어하려면 버튼을 사용하세요.',
  switch_autoCtrl_smartMode_title: '무선 모드',
  switch_autoCtrl_traditionalMode_desc: '일반 조명, 환풍기 같은 표준 기기에 연결할 때 이 모드를 사용하세요.',
  switch_autoCtrl_traditionalMode_title: '유선 모드',
  switch_autoCtrl_wirelessHint_title: '무선 모드로 전환하면 한 번 누르기, 두 번 누르기, 길게 누르기 자동화를 사용할 수 있습니다.',
  switch_controlType_advancedConfig: '고급 설정',
  switch_controlType_manualScene_desc: '기존 수동 씬(예: "귀가") 실행',
  switch_controlType_manualScene_title: '수동 제어',
  switch_controlType_otherSmartDevice_desc: '이 집의 다른 스마트 기기 제어',
  switch_controlType_otherSmartDevice_title: '자동화 만들기',
  switch_controlType_quickConfig: '빠른 설정',
  switch_controlType_smartLight_desc: '스마트 조명 켜기 또는 끄기',
  switch_controlType_smartLight_title: '스마트 조명',
  switch_controlType_switchDualControl_desc: '다른 스마트 스위치 켜기 또는 끄기',
  switch_controlType_switchDualControl_title: '이중 스위치 제어',
  switch_layoutDetail_editIcon: '아이콘 변경',
  switch_layoutDetail_name: '이름',
  switch_layoutDetail_room: '방',
  switch_list_empty_light: '이 집에는 지원되는 조명이 없음',
  switch_list_empty_manualScene: '이 집에는 수동 제어 기능이 없습니다. Xiaomi Home 시작 페이지에서 추가하세요.',
  switch_list_empty_switch: '이 집에는 지원되는 스위치가 없음',
  switch_menu_deleteConfig: '구성 삭제',
  switch_multikey_iconCategory_default: '기본값',
  switch_multikey_iconCategory_light: '조명',
  switch_multikey_iconCategory_other: '기타',
  switch_multikey_iconSelect_title: '아이콘',
  switch_multikey_roomSelect_createFail: '방을 만들 수 없음',
  switch_multikey_roomSelect_createNew: '방 만들기',
  switch_multikey_roomSelect_inputPlaceholder: '방 이름 입력',
