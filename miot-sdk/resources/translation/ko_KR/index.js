export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: '해당 기능이 켜져 있을 때는 물리 버튼으로 회로를 조정할 수 없습니다. 다만 스마트 씬에는 여전히 버튼을 사용할 수 있습니다.',
  switch_dia_msg_wirelessSwitchSetting: '이 버튼은 다른 항목 (${})과 연관되어 있습니다. 무선 스위치로 변경하여 사용하십시오.',
  switch_listItem_title_voiceControlLoop: '음성 명령으로 회로 제어',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Mi AI로 회로 제어',
  switch_listItem_value_voiceControlLoopOn: '켜짐',
  switch_listItem_value_voiceControlLoopOff: '꺼짐',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Mi AI를 이용해 회로를 활성화/비활성화합니다. 회로에 포함된 스마트 조명은 전원이 꺼지고 연결이 끊어질 수도 있습니다.',
  ...
  switch_listItem_subtile_speedModeDescription: '"누르기" 동작에만 자동화가 필요하다면 이 옵션을 선택하는 것이 좋습니다. 해당 옵션을 선택하면 스위치가 누르기 동작에 신속하게 반응하여 자동화 응답 속도가 향상됩니다.',
  switch_listItem_subtile_standardModeDescription: '"두 번 누르기" 및 "길게 누르기" 동작에 자동화가 필요하다면 이 옵션을 선택하십시오.',
  switch_dia_msg_speedModeMessage: '현재 기기에 구성된 자동화에 "두 번 누르기" 또는 "길게 누르기"가 포함됩니다. 슈퍼 스피드 모드가 켜져 있으면 스마트 씬이 응답하지 않게 됩니다. 그래도 켜시겠습니까?',
