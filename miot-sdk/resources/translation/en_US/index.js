export default {
  ...
  updateWarningTip: 'Do not power off or operate the device during the update to avoid exceptions or failure.',
  basicPerformanceUpdate: 'Basic Performance Update',
  productFunctionUpdate: 'Product Function Update',
  updateFailed: 'Update Failed',
  checkUpdateFailed: 'Failed to Check for Updates',
  updated: 'Updated',
  deviceOfflineCheckNetwork: 'Device is offline. Please check your network.',
  checkNetworkError: 'Network error. Please check your network and try again.',
  alreadyLatest: 'Device is already up to date.',
