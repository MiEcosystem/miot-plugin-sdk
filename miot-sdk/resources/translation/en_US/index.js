export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'Physical buttons won\'t be able to control circuits when this feature is on. You\'ll still be able to use them for smart scenes.',
  switch_dia_msg_wirelessSwitchSetting: 'This button is associated with another item (${}). Change to wireless switch to use it.',
  switch_listItem_title_voiceControlLoop: 'Control circuits with voice commands',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Control circuits with Mi AI',
  switch_listItem_value_voiceControlLoopOn: 'On',
  switch_listItem_value_voiceControlLoopOff: 'Off',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Activate and deactivate circuits using Mi AI. If smart lights are included in the circuit, they might be powered off and disconnected.',
