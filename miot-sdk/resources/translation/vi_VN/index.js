export default {
  ...
  updateWarningTip: 'Không tắt nguồn hoặc sử dụng thiết bị trong suốt quá trình cập nhật',
  basicPerformanceUpdate: 'Hiệu năng cơ bản',
  productFunctionUpdate: 'Tính năng sản phẩm',
  updateFailed: 'Không thể cập nhật',
  partialUpdateFailed: 'Không thể hoàn thành một phần của bản cập nhật này',
  checkUpdateFailed: 'Không thể kiểm tra cập nhật',
  updated: 'Đã cập nhật',
  deviceOfflineCheckNetwork: 'Thiết bị đang ngoại tuyến. Vui lòng kiểm tra cài đặt mạng.',
  checkNetworkError: 'Đã xảy ra lỗi mạng. Vui lòng chờ một hoặc hai phút và thử lại.',
  alreadyLatest: 'Phiên bản hiện tại đã là phiên bản mới nhất',
  ...
  cloutStorageSetting: 'Cài đặt lưu trữ đám mây khác',
  open: 'Bật',
  close: 'Tắt',
  other: 'Khác',
  ...
  switch_dia_msg_repeatScene: 'Nút này đã được thiết lập tự động hóa khi nhấn một lần. Kết nối thiết bị có thể khiến nó kích hoạt liên tục. Bạn có muốn gỡ thiết bị đã kết nối không?',
  ...
  select_control_type: 'Chọn loại điều khiển',
  non_smart_device_wired: 'Điều khiển thiết bị không thông minh qua kết nối có dây',
  control_smart_lights_group: 'Điều khiển đèn hoặc cụm đèn thông minh trong ngôi nhà này',
  switch_double_control: 'Điều khiển công tắc kép',
  link_other_switches_intercontrol: 'Kết nối với các công tắc thông minh khác để chúng điều khiển lẫn nhau',
  execute_scene: 'Chạy cảnh',
  execute_manual_scenes_home: 'Chạy một cảnh thủ công hiện có (ví dụ: "Về nhà")',
  more_smart_devices: 'Thiết bị thông minh khác',
  control_other_devices_home: 'Điều khiển các thiết bị thông minh khác trong ngôi nhà này (ví dụ: điều hòa)',
  power_switch: 'Công tắc nguồn',
  turn_off_light_offline: 'Nếu bạn tắt công tắc này, đèn thông minh đã kết nối sẽ mất nguồn và chuyển sang trạng thái ngoại tuyến',
  manage_switch_power: 'Bật hoặc tắt công tắc. Để giữ cho đèn thông minh luôn trực tuyến, hãy để ở trạng thái bật.',
  automation_toggle_btn: 'Chuyển',
  save: 'Lưu',
  add_device_type: 'Thêm loại thiết bị',
  common_brand_produced_by: 'Được thiết kế bởi ${}',
  automation_add_control_device: 'Thêm thiết bị',
  automation_edit_btn: 'Chỉnh sửa',
  switch_autoCtrl_confirmToSmart_desc: 'Sau khi chuyển, nút sẽ không còn bật/tắt công tắc nữa và có thể dùng để điều khiển các thiết bị thông minh trong nhà này.',
  switch_autoCtrl_confirmToSmart_title: 'Chuyển sang chế độ không dây?',
  switch_autoCtrl_confirmToSpeedMode_desc: 'Trong chế độ Siêu tốc, các tự động hóa nhấn hai lần và nhấn giữ sẽ không hoạt động.',
  switch_autoCtrl_confirmToSpeedMode_title: 'Chuyển sang chế độ Siêu tốc?',
  switch_autoCtrl_confirmToTraditional_desc: 'Sau khi chuyển, nút sẽ không còn điều khiển các thiết bị thông minh nữa và các tự động hóa liên quan sẽ không hoạt động.',
  switch_autoCtrl_confirmToTraditional_title: 'Chuyển sang chế độ có dây?',
  switch_autoCtrl_ctrlSection: 'Điều khiển',
  switch_autoCtrl_modeSection: 'Chế độ',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'Khi tắt, các thiết bị được kết nối sẽ mất điện và ngừng hoạt động',
  switch_autoCtrl_powerSwitch_title: 'Điều khiển nguồn điện',
  switch_autoCtrl_selectControlDevice_title: 'Chọn thiết bị',
  switch_autoCtrl_smartMode_desc: 'Sử dụng nút để điều khiển các thiết bị thông minh, chẳng hạn như đèn thông minh hoặc công tắc thông minh',
  switch_autoCtrl_smartMode_title: 'Chế độ không dây',
  switch_autoCtrl_traditionalMode_desc: 'Sử dụng chế độ này khi kết nối với các thiết bị tiêu chuẩn, chẳng hạn như đèn thông thường hoặc quạt hút',
  switch_autoCtrl_traditionalMode_title: 'Chế độ có dây',
  switch_autoCtrl_wirelessHint_title: 'Các tự động hóa nhấn một lần, nhấn hai lần và nhấn giữ sẽ khả dụng sau khi bạn chuyển sang chế độ không dây',
  switch_controlType_advancedConfig: 'Thiết lập nâng cao',
  switch_controlType_manualScene_desc: 'Chạy các tình huống thủ công hiện có (ví dụ: "Về nhà")',
  switch_controlType_manualScene_title: 'Điều khiển thủ công',
  switch_controlType_otherSmartDevice_desc: 'Điều khiển các thiết bị thông minh khác trong nhà này',
  switch_controlType_otherSmartDevice_title: 'Tạo tự động hóa',
  switch_controlType_quickConfig: 'Thiết lập nhanh',
  switch_controlType_smartLight_desc: 'Bật hoặc tắt đèn thông minh',
  switch_controlType_smartLight_title: 'Đèn thông minh',
  switch_controlType_switchDualControl_desc: 'Bật hoặc tắt các công tắc thông minh khác',
  switch_controlType_switchDualControl_title: 'Điều khiển công tắc kép',
  switch_layoutDetail_editIcon: 'Thay đổi biểu tượng',
  switch_layoutDetail_name: 'Tên',
  switch_layoutDetail_room: 'Phòng',
  switch_list_empty_light: 'Không có đèn nào được hỗ trợ trong nhà này',
  switch_list_empty_manualScene: 'Không có điều khiển thủ công nào trong nhà này. Hãy thêm từ trang bắt đầu của Xiaomi Home.',
  switch_list_empty_switch: 'Không có công tắc nào được hỗ trợ trong nhà này',
  switch_menu_deleteConfig: 'Xóa cấu hình',
  switch_multikey_iconCategory_default: 'Mặc định',
  switch_multikey_iconCategory_light: 'Đèn',
  switch_multikey_iconCategory_other: 'Khác',
  switch_multikey_iconSelect_title: 'Biểu tượng',
  switch_multikey_roomSelect_createFail: 'Không thể tạo phòng',
  switch_multikey_roomSelect_createNew: 'Tạo phòng',
  switch_multikey_roomSelect_inputPlaceholder: 'Nhập tên phòng',
