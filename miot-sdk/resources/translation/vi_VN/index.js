export default {
  ...
  switch_listItem_title_voiceControlLoop: 'Điều khiển mạch bằng lệnh thoại',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Điều khiển mạch bằng Mi AI',
  switch_listItem_value_voiceControlLoopOn: 'Bật',
  switch_listItem_value_voiceControlLoopOff: 'Tắt',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Kích hoạt và hủy kích hoạt mạch bằng Mi AI. Nếu trong mạch có đèn thông minh, thì chúng có thể bị tắt nguồn và ngắt kết nối.',
  ...
  switch_listItem_subtile_speedModeDescription: 'Nếu tự động hóa chỉ được yêu cầu cho hành động "bấm", thì bạn nên chọn tùy chọn này. Sau khi chọn, công tắc sẽ phản hồi nhanh chóng với hành động bấm, giúp cải thiện tốc độ phản hồi của quá trình tự động hóa.',
  switch_listItem_subtile_standardModeDescription: 'Nếu cần tự động hóa cho thao tác "bấm đúp" và "bấm và giữ", hãy chọn tùy chọn này.',
  switch_dia_msg_speedModeMessage: 'Tự động hóa được định cấu hình trên thiết bị hiện tại bao gồm "bấm đúp" hoặc "bấm và giữ". Tình huống thông minh sẽ không phản hồi khi bật Chế độ siêu tốc. Vẫn bật?',
