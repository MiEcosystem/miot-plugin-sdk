export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'لن تتمكن الأزرار المادية من التحكم في الدوائر عند تشغيل هذه الميزة. ستظل قادرًا على استخدامها للمشاهد الذكية.',
  switch_dia_msg_wirelessSwitchSetting: 'هذا الزر مرتبط بعنصر آخر (${}). لاستخدامه، قم بتغييره إلى مفتاح لاسلكي.',
  switch_listItem_title_voiceControlLoop: 'دوائر التحكم بالأوامر الصوتية',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'دوائر التحكم مع مساعد Mi AI الذكي',
  switch_listItem_value_voiceControlLoopOn: 'مشغل',
  switch_listItem_value_voiceControlLoopOff: 'متوقف',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'تنشيط وإلغاء تنشيط الدوائر باستخدام مساعد Mi AI الذكي. إذا تم تضمين المصابيح الذكية في الدائرة، فقد يتم إيقاف تشغيلها وفصلها.',
  ...
  switch_listItem_subtile_speedModeDescription: 'إذا كانت الأتمتة مطلوبة فقط لإجراء "الضغط"، فمن المستحسن تحديد هذا الخيار. بمجرد تحديده، سيستجيب المفتاح بسرعة لعمل الضغط، مما يؤدي إلى تحسين سرعة استجابة الأتمتة.',
  switch_listItem_subtile_standardModeDescription: 'حدد هذا الخيار إذا كانت الأتمتة مطلوبة لإجراءات "النقر المزدوج" و"الاستمرار".',
  switch_dia_msg_speedModeMessage: 'تتضمن عملية الأتمتة التي تم تكوينها على جهاز موجود "النقر المزدوج" أو "الضغط المستمر". لن يستجيب المشهد الذكي عند تشغيل وضع التسارع الفائق. هل مازلت تريد تشغيله؟',
