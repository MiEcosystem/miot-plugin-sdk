export default {
  ...
  updateWarningTip: 'يُرجى عدم إيقاف تشغيل الجهاز أو استخدامه أثناء التحديث',
  basicPerformanceUpdate: 'الأداء الأساسي',
  productFunctionUpdate: 'ميزات المنتج',
  updateFailed: 'تعذّر التحديث',
  partialUpdateFailed: 'تعذّر إكمال جزء من هذا التحديث',
  checkUpdateFailed: 'تعذّر التحقق من وجود تحديثات',
  updated: 'تم التحديث',
  deviceOfflineCheckNetwork: 'الجهاز غير متصل بالإنترنت. تحقق من إعدادات الشبكة.',
  checkNetworkError: 'حدث خطأ في الشبكة. انتظر دقيقة أو دقيقتين ثم حاول مجددًا.',
  alreadyLatest: 'الإصدار الحالي هو أحدث إصدار',
  ...
  cloutStorageSetting: 'المزيد من إعدادات تخزين cloud السحابي',
  open: 'مشغل',
  close: 'متوقف',
  other: 'أخرى',
  ...
  deviceOffline: 'غير متصل بالإنترنت',
  ...
  switch_dia_msg_repeatScene: 'يحتوي هذا الزر بالفعل على التشغيل الآلي بضغطة واحدة. قد يؤدي توصيل جهاز إلى تشغيله بشكل متكرر. هل تريد إزالة الجهاز المتصل؟',
  common_loading: 'لحظة من فضلك…',
  ...
  usedOnMiHome: 'الاستخدام مع Xiaomi Home',
  operation_failed: 'تعذّر إكمال هذا الإجراء',
  operation_cancel: 'تم إلغاء الإجراء',
  operation_success: 'تم',
  select_control_type: 'حدّد نوع التحكم',
  non_smart_device_wired: 'التحكم في الأجهزة غير الذكية عبر اتصال سلكي',
  control_smart_lights_group: 'التحكم في الأضواء الذكية أو مجموعات الإضاءة في هذا المنزل',
  switch_double_control: 'التحكم بمفتاح مزدوج',
  link_other_switches_intercontrol: 'الاتصال بمفاتيح ذكية أخرى حتى تتمكن من التحكم المتبادل فيما بينها',
  execute_scene: 'تشغيل المشهد',
  execute_manual_scenes_home: 'تشغيل مشهد يدوي مُعد مسبقًا (مثل "العودة إلى المنزل")',
  more_smart_devices: 'المزيد من الأجهزة الذكية',
  control_other_devices_home: 'التحكم في الأجهزة الذكية الأخرى في هذا المنزل (مثل مكيف الهواء)',
  power_switch: 'مفتاح الطاقة',
  turn_off_light_offline: 'إذا قمت بإيقاف تشغيل هذا، فسوف يفقد الضوء الذكي المتصل الطاقة ويصبح غير متصل بالإنترنت',
  manage_switch_power: 'قم بتشغيل أو إيقاف المفتاح. للحفاظ على اتصال الأضواء الذكية، اتركه في وضع التشغيل.',
  automation_toggle_btn: 'تبديل',
  save: 'حفظ',
  add_device_type: 'إضافة نوع الجهاز',
  common_brand_produced_by: 'تصميم: ${}',
  automation_add_control_device: 'إضافة الأجهزة',
  automation_edit_btn: 'تعديل',
  switch_autoCtrl_confirmToSmart_desc: 'بعد التبديل، لن يقوم الزر بتشغيل المفتاح أو إيقاف تشغيله، ويمكن استخدامه للتحكم في الأجهزة الذكية في هذا المنزل.',
  switch_autoCtrl_confirmToSmart_title: 'هل تريد التبديل إلى الوضع اللاسلكي؟',
  switch_autoCtrl_confirmToSpeedMode_desc: 'في وضع التسريع الفائق، لن يتم تشغيل عمليات التشغيل التلقائي بالضغط المزدوج أو الضغط المطول.',
  switch_autoCtrl_confirmToSpeedMode_title: 'هل تريد التبديل إلى وضع التسريع الفائق؟',
  switch_autoCtrl_confirmToTraditional_desc: 'بعد التبديل، لن يتمكن الزر من التحكم في الأجهزة الذكية، ولن تعمل عمليات التشغيل التلقائي المرتبطة به.',
  switch_autoCtrl_confirmToTraditional_title: 'هل تريد التبديل إلى الوضع السلكي؟',
  switch_autoCtrl_ctrlSection: 'التحكم',
  switch_autoCtrl_modeSection: 'الوضع',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'عند إيقاف التشغيل، ستفقد الأجهزة المتصلة الكهرباء وتصبح غير متصلة بالشبكة.',
  switch_autoCtrl_powerSwitch_title: 'التحكم في الطاقة',
  switch_autoCtrl_selectControlDevice_title: 'تحديد الأجهزة',
  switch_autoCtrl_smartMode_desc: 'استخدم الزر للتحكم في الأجهزة الذكية، مثل المصابيح الذكية أو المفاتيح الذكية.',
  switch_autoCtrl_smartMode_title: 'الوضع اللاسلكي',
  switch_autoCtrl_traditionalMode_desc: 'استخدم هذا الوضع عند الاتصال بالأجهزة القياسية، مثل المصابيح العادية أو مراوح الشفط.',
  switch_autoCtrl_traditionalMode_title: 'الوضع السلكي',
  switch_autoCtrl_wirelessHint_title: 'تتوفر خاصية التشغيل التلقائي بضغطة واحدة، أو ضغطتين، أو الضغط المطول، بعد التبديل إلى الوضع اللاسلكي.',
  switch_controlType_advancedConfig: 'إعداد متقدم',
  switch_controlType_manualScene_desc: 'تشغيل المشاهد اليدوية الموجودة (مثل "العودة إلى المنزل")',
  switch_controlType_manualScene_title: 'التحكم اليدوي',
  switch_controlType_otherSmartDevice_desc: 'التحكم في الأجهزة الذكية الأخرى في هذا المنزل',
  switch_controlType_otherSmartDevice_title: 'إنشاء تشغيل تلقائي',
  switch_controlType_quickConfig: 'إعداد سريع',
  switch_controlType_smartLight_desc: 'تشغيل الأضواء الذكية أو إيقاف تشغيلها',
  switch_controlType_smartLight_title: 'الأضواء الذكية',
  switch_controlType_switchDualControl_desc: 'تشغيل المفاتيح الذكية الأخرى أو إيقاف تشغيلها',
  switch_controlType_switchDualControl_title: 'التحكم بمفتاح مزدوج',
  switch_layoutDetail_editIcon: 'تغيير الأيقونة',
  switch_layoutDetail_name: 'الاسم',
  switch_layoutDetail_room: 'غرفة',
  switch_list_empty_light: 'لا توجد مصابيح مدعومة في هذا المنزل',
  switch_list_empty_manualScene: 'لا توجد عناصر تحكم يدوية في هذا المنزل. أضفها من الصفحة الرئيسية لتطبيق Xiaomi Home.',
  switch_list_empty_switch: 'لا توجد مفاتيح مدعومة في هذا المنزل',
  switch_menu_deleteConfig: 'حذف التكوين',
  switch_multikey_iconCategory_default: 'افتراضي',
  switch_multikey_iconCategory_light: 'الأضواء',
  switch_multikey_iconCategory_other: 'خيار آخر',
  switch_multikey_iconSelect_title: 'أيقونة',
  switch_multikey_roomSelect_createFail: 'تعذر إنشاء الغرفة',
  switch_multikey_roomSelect_createNew: 'إنشاء غرفة',
  switch_multikey_roomSelect_inputPlaceholder: 'أدخل اسم الغرفة',
