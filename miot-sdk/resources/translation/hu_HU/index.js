export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'Fizikai gombokkal nem lehet áramköröket vezérelni, ha ez a funkció be van kapcsolva. Az intelligens jelenetekhez továbbra is használhatja őket.',
  ...
  switch_listItem_title_voiceControlLoop: 'Vezérlőáramkörök hangutasításokkal',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Vezérlőáramkörök Mi AI-val',
  switch_listItem_value_voiceControlLoopOn: 'Be',
  switch_listItem_value_voiceControlLoopOff: 'Ki',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Áramkörök aktiválása és deaktiválása a Mi AI segítségével. Ha az áramkörben intelligens lámpák is szerepelnek, akkor azok kikapcsolhatók és lekapcsolhatók.',
  ...
  switch_listItem_subtile_speedModeDescription: 'Ha az automatizálás csak a „nyomás” művelethez szükséges, ajánlott ezt az opciót választani. Kiválasztás után a kapcsoló gyorsan reagál a megnyomásra, javítva az automatizmus válaszsebességét.',
  switch_listItem_subtile_standardModeDescription: 'Ha a "dupla megnyomás" és a "nyomva tartás" automatizálása szükséges, válassza ezt az opciót.',
  switch_dia_msg_speedModeMessage: 'Az adott készüléken konfigurált automatizálás tartalmazza a "dupla megnyomás" vagy a "nyomva tartás" funkciót. Az intelligens jelenet nem reagál, ha a szupersebesség üzemmód be van kapcsolva. Mindenképpen bekapcsolja?',
