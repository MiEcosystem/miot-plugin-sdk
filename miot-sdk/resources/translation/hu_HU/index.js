export default {
  ...
  updateWarningTip: 'Ne kapcsolja ki és ne használja a készüléket a frissítés során',
  basicPerformanceUpdate: 'Alap teljesítmény',
  productFunctionUpdate: 'Termék jellemzői',
  updateFailed: 'Sikertelen frissítés',
  partialUpdateFailed: 'Nem sikerült végrehajtani a frissítés egy részét',
  checkUpdateFailed: 'Nem sikerült ellenőrizni a frissítéseket',
  updated: 'Frissítve',
  deviceOfflineCheckNetwork: 'A készülék offline állapotban van. Ellenőrizze a hálózati beállításokat.',
  checkNetworkError: 'Hálózati hiba történt. Várjon egy-két percet, majd próbálja újra.',
  alreadyLatest: 'A jelenlegi verzió naprakész',
  ...
  cloutStorageSetting: 'További felhőalapú tárolási beállítások',
  open: 'Be',
  close: 'Ki',
  other: 'Egyéb',
  ...
  switch_dia_msg_repeatScene: 'Ennek a gombnak már van egynyomású automatizálása. Eszköz csatlakoztatása ismételt aktiválódást okozhat. Eltávolítja a csatlakoztatott eszközt?',
  common_loading: 'Egy pillanat…',
  ...
  select_control_type: 'Válassza ki a vezérlés típusát',
  non_smart_device_wired: 'Nem intelligens eszközök vezérlése vezetékes kapcsolaton keresztül',
  control_smart_lights_group: 'Intelligens lámpák vagy lámpacsoportokat vezérlése ebben a háztartásban',
  switch_double_control: 'Kettős kapcsoló vezérlés',
  link_other_switches_intercontrol: 'Csatlakozás más intelligens kapcsolókhoz, hogy azok egymást vezéreljék',
  execute_scene: 'Jelenet futtatása',
  execute_manual_scenes_home: 'Futtasson egy meglévő manuális jelenetet (pl. „Újra otthon”)',
  more_smart_devices: 'További intelligens eszközök',
  control_other_devices_home: 'Más intelligens eszközök vezérlése ebben a háztartásban (pl. légkondicionáló)',
  power_switch: 'Tápkapcsoló',
  turn_off_light_offline: 'Ha ezt kikapcsolja, a csatlakoztatott intelligens lámpa áramellátása megszűnik, és offline módba kerül',
  manage_switch_power: 'Kapcsoló be- vagy kikapcsolása. Az intelligens lámpák online állapotának fenntartásához hagyja bekapcsolva.',
  automation_toggle_btn: 'Kapcsoló',
  save: 'Mentés',
  add_device_type: 'Készüléktípus hozzáadása',
  common_brand_produced_by: 'Tervezte ${}',
  automation_add_control_device: 'Készülék hozzáadása',
  automation_edit_btn: 'Szerkesztés',
  switch_autoCtrl_confirmToSmart_desc: 'A kapcsoló átállítása után a gomb már nem a kapcsoló be- vagy kikapcsolására, hanem az otthonban található intelligens eszközök vezérlésére használható.',
  switch_autoCtrl_confirmToSmart_title: 'Átvált vezeték nélküli módra?',
  switch_autoCtrl_confirmToSpeedMode_desc: 'A Szupersebesség módban a kétszeri gombnyomás és a hosszú nyomás nem működik.',
  switch_autoCtrl_confirmToSpeedMode_title: 'Átvált Szupersebesség módra?',
  switch_autoCtrl_confirmToTraditional_desc: 'Az átváltás után a gomb már nem fogja vezérelni az intelligens eszközöket, és a kapcsolódó automatizálások sem fognak futni.',
  switch_autoCtrl_confirmToTraditional_title: 'Átvált vezetékes módra?',
  switch_autoCtrl_ctrlSection: 'Vezérlés',
  switch_autoCtrl_modeSection: 'Mód',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'Kikapcsoláskor a csatlakoztatott eszközök áramellátása megszűnik, és offline állapotba kerülnek',
  switch_autoCtrl_powerSwitch_title: 'Bekapcsológomb-vezérlés',
  switch_autoCtrl_selectControlDevice_title: 'Készülékek kiválasztása',
  switch_autoCtrl_smartMode_desc: 'Használja ezt a gombot az intelligens eszközök, például intelligens világítás vagy intelligens kapcsolók vezérléséhez',
  switch_autoCtrl_smartMode_title: 'Vezeték nélküli mód',
  switch_autoCtrl_traditionalMode_desc: 'Használja ezt a módot, ha standard készülékekhez csatlakozik, például hagyományos lámpákhoz vagy elszívó ventilátorokhoz',
  switch_autoCtrl_traditionalMode_title: 'Vezetékes mód',
  switch_autoCtrl_wirelessHint_title: 'A vezeték nélküli módra való átállás után az egyszeri, kétszeri és hosszú megnyomás funkciók is elérhetővé válnak',
  switch_controlType_advancedConfig: 'Speciális beállítás',
  switch_controlType_manualScene_desc: 'A meglévő manuális jelenetek futtatása (pl. „Újra otthon”)',
  switch_controlType_manualScene_title: 'Manuális vezérlők',
  switch_controlType_otherSmartDevice_desc: 'Egyéb intelligens eszközök vezérlése ezen a címen',
  switch_controlType_otherSmartDevice_title: 'Automatizálás létrehozása',
  switch_controlType_quickConfig: 'Gyors beállítás',
  switch_controlType_smartLight_desc: 'Intelligens világítás be- és kikapcsolása',
  switch_controlType_smartLight_title: 'Intelligens világítás',
  switch_controlType_switchDualControl_desc: 'Egyéb kapcsolók be- vagy kikapcsolása',
  switch_controlType_switchDualControl_title: 'Kettős kapcsoló vezérlés',
  switch_layoutDetail_editIcon: 'Ikon módosítása',
  switch_layoutDetail_name: 'Név',
  switch_layoutDetail_room: 'Szoba',
  switch_list_empty_light: 'Ezen a címen nincs támogatott világítás',
  switch_list_empty_manualScene: 'Ezen a címen nincsenek manuális vezérlők. Adja hozzá a Xiaomi Home kezdőlapjáról.',
  switch_list_empty_switch: 'Ezen a címen nincs támogatott kapcsoló',
  switch_menu_deleteConfig: 'Konfiguráció törlése',
  switch_multikey_iconCategory_default: 'Alapértelmezett',
  switch_multikey_iconCategory_light: 'Világítás',
  switch_multikey_iconCategory_other: 'Egyéb',
  switch_multikey_iconSelect_title: 'Ikon',
  switch_multikey_roomSelect_createFail: 'Szoba létrehozása sikertelen',
  switch_multikey_roomSelect_createNew: 'Szoba létrehozása',
  switch_multikey_roomSelect_inputPlaceholder: 'Szoba nevének létrehozása',
