export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'Po włączeniu tej funkcji nie będzie można już sterować układem za pomocą fizycznych przycisków. Nadal będą jednak dostępne w trybie inteligentnych scen.',
  ...
  switch_listItem_title_voiceControlLoop: 'Obsługa układów poleceniami głosowymi',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Obsługa układów przez Mi SI',
  switch_listItem_value_voiceControlLoopOn: 'Wł.',
  switch_listItem_value_voiceControlLoopOff: 'Wył.',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Aktywuj i dezaktywuj układy za pomocą Mi SI. Jeśli układ zawiera inteligentne światła, mogą one zostać odłączone od zasilania i rozłączone.',
  ...
  switch_listItem_subtile_speedModeDescription: 'Ta opcja jest rekomendowana w sytuacji, gdy automatyzacja dotyczy jedynie czynności „naciśnięcia”. Po jej włączeniu, przełącznik będzie szybko reagował na naciskanie, poprawiając czas reakcji automatyzacji.',
  switch_listItem_subtile_standardModeDescription: 'Wybierz tę opcję, jeśli automatyzacja jest wymagana dla „podwójnego naciśnięcia” i „naciśnięcia i przytrzymania”.',
  switch_dia_msg_speedModeMessage: 'Automatyzacja skonfigurowana na bieżącym urządzeniu obejmuje „podówjne naciśnięcie” lub „naciśnij i przytrzymaj”. Inteligentna scena nie reaguje, gdy włączony jest Tryb superszybki. Włączyć mimo to?',
