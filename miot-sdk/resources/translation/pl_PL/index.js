export default {
  ...
  updateWarningTip: 'Nie wyłączaj ani nie używaj urządzenia przez cały czas trwania aktualizacji',
  basicPerformanceUpdate: 'Podstawowa wydajność',
  productFunctionUpdate: 'Cechy produktu',
  updateFailed: 'Nie udało się zaktualizować',
  partialUpdateFailed: 'Częściowe niepowodzenie aktualizacji',
  checkUpdateFailed: 'Nie można sprawdzić aktualizacji',
  updated: 'Zaktualizowano',
  deviceOfflineCheckNetwork: 'Urządzenie jest odłączone. Sprawdź ustawienia sieci.',
  checkNetworkError: 'Wystąpił błąd sieci. Poczekaj minutę lub dwie i spróbuj ponownie.',
  alreadyLatest: 'Ta wersja jest aktualna',
  checkingUpdate: 'Sprawdzanie aktualizacji…',
  foundNewVersion: 'Dostępna jest aktualizacja',
  version: 'Wersja',
  ...
  cloutStorageSetting: 'Więcej ustawień przechowywania w chmurze',
  open: 'Wł.',
  close: 'Wył.',
  other: 'Inne',
  ...
  fireSafeCodeTitle: 'Zgodność urządzenia z przepisami bezpieczeństwa pożarowego',
  ...
  switch_dia_msg_repeatScene: 'Z tym przyciskiem powiązano już funkcję automatyzacji uruchamianą pojedynczym wciśnięciem. Podłączenie urządzenia może spowodować, że automatyzacja uruchomi się wiele razy z rzędu. Usunąć podłączone urządzenie?',
  common_loading: 'Chwileczkę…',
  ...
  usedOnMiHome: 'Używaj z Xiaomi Home',
  operation_failed: 'Nie udało się dokończyć akcji',
  operation_cancel: 'Anulowano akcję',
  operation_success: 'Gotowe',
  select_control_type: 'Wybierz typ sterowania',
  non_smart_device_wired: 'Sterowanie urządzeniami nieinteligentnymi za pomocą połączenia przewodowego',
  control_smart_lights_group: 'Sterowanie inteligentnym oświetleniem lub grupą świateł w tym domu',
  switch_double_control: 'Sterowanie dwoma przełącznikami',
  link_other_switches_intercontrol: 'Nawiąż połączenie z innymi przełącznikami inteligentnymi, aby mogły się wzajemnie kontrolować',
  execute_scene: 'Uruchom scenę',
  execute_manual_scenes_home: 'Uruchom wcześniej utworzoną scenę ręczną (np. „Powrót do domu”)',
  more_smart_devices: 'Więcej inteligentnych urządzeń',
  control_other_devices_home: 'Sterowanie innymi inteligentnymi urządzeniami w tym domu (np. klimatyzatorem)',
  power_switch: 'Przełącznik zasilania',
  turn_off_light_offline: 'Wyłączenie spowoduje utratę zasilania przez oświetlenie inteligentne i przejście w tryb offline',
  manage_switch_power: 'Włącz lub wyłącz przełącznik. Aby oświetlenie inteligentne pozostało aktywne, nie wyłączaj przełącznika.',
  automation_toggle_btn: 'Przełącz',
  save: 'Zapisz',
  add_device_type: 'Dodaj typ urządzenia',
  common_brand_produced_by: 'Zaprojektowane przez ${}',
  automation_add_control_device: 'Dodaj urządzenia',
  automation_edit_btn: 'Edytuj',
  switch_autoCtrl_confirmToSmart_desc: 'Po przełączeniu przycisk nie będzie już aktywował ani dezaktywował przełącznika i może być używany do sterowania inteligentnymi urządzeniami w tym domu.',
  switch_autoCtrl_confirmToSmart_title: 'Przełączyć na tryb bezprzewodowy?',
  switch_autoCtrl_confirmToSpeedMode_desc: 'W trybie superszybkim nie działają automatyzacje powiązane z dwukrotnym wciśnięciem ani naciśnięciem i przytrzymaniem.',
  switch_autoCtrl_confirmToSpeedMode_title: 'Przełączyć na tryb superszybki?',
  switch_autoCtrl_confirmToTraditional_desc: 'Po przełączeniu przycisk nie będzie już obsługiwać urządzeń inteligentnych, a powiązane automatyzacje nie będą działać.',
  switch_autoCtrl_confirmToTraditional_title: 'Przełączyć na tryb przewodowy?',
  switch_autoCtrl_ctrlSection: 'Sterowanie',
  switch_autoCtrl_modeSection: 'Tryb',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'Wyłączenie spowoduje utratę zasilania przez podłączone urządzenia i przejście w tryb offline',
  switch_autoCtrl_powerSwitch_title: 'Sterowanie zasilaniem',
  switch_autoCtrl_selectControlDevice_title: 'Wybierz urządzenia',
  switch_autoCtrl_smartMode_desc: 'Użyj przycisku, by sterować urządzeniami inteligentnymi, np. oświetleniem lub przełącznikami',
  switch_autoCtrl_smartMode_title: 'Tryb bezprzewodowy',
  switch_autoCtrl_traditionalMode_desc: 'Tryb przeznaczony dla standardowych urządzeń, np. zwykłego oświetlenia lub wentylatorów',
  switch_autoCtrl_traditionalMode_title: 'Tryb przewodowy',
  switch_autoCtrl_wirelessHint_title: 'Automatyzacje powiązane z pojedynczym naciśnięciem, dwukrotnym naciśnięciem oraz naciśnięciem i przytrzymaniem są dostępne po przełączeniu na tryb bezprzewodowy',
  switch_controlType_advancedConfig: 'Zaawansowana konfiguracja',
  switch_controlType_manualScene_desc: 'Uruchamianie wcześniej utworzonych scen ręcznych (np. „Powrót do domu”)',
  switch_controlType_manualScene_title: 'Obsługa ręczna',
  switch_controlType_otherSmartDevice_desc: 'Sterowanie innymi inteligentnymi urządzeniami w tym domu',
  switch_controlType_otherSmartDevice_title: 'Utwórz automatyzację',
  switch_controlType_quickConfig: 'Szybka konfiguracja',
  switch_controlType_smartLight_desc: 'Włączanie i wyłączanie inteligentnego oświetlenia',
  switch_controlType_smartLight_title: 'Inteligentne światła',
  switch_controlType_switchDualControl_desc: 'Włączanie i wyłączanie innych przełączników inteligentnych',
  switch_controlType_switchDualControl_title: 'Sterowanie dwoma przełącznikami',
  switch_layoutDetail_editIcon: 'Zmień ikonę',
  switch_layoutDetail_name: 'Nazwa',
  switch_layoutDetail_room: 'Pomieszczenie',
  switch_list_empty_light: 'W tym domu nie ma obsługiwanych świateł',
  switch_list_empty_manualScene: 'Brak metod obsługi ręcznej w tym domu. Dodaj je z poziomu strony startowej Xiaomi Home.',
  switch_list_empty_switch: 'W tym domu nie ma obsługiwanych przełączników',
  switch_menu_deleteConfig: 'Usuń konfigurację',
  switch_multikey_iconCategory_default: 'Domyślne',
  switch_multikey_iconCategory_light: 'Światła',
  switch_multikey_iconCategory_other: 'Inne',
  switch_multikey_iconSelect_title: 'Ikona',
  switch_multikey_roomSelect_createFail: 'Nie udało się utworzyć pomieszczenia',
  switch_multikey_roomSelect_createNew: 'Utwórz pomieszczenie',
  switch_multikey_roomSelect_inputPlaceholder: 'Wprowadź nazwę pomieszczenia',
