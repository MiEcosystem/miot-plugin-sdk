export default {
  ...
  updateWarningTip: 'Stäng inte av eller använd inte enheten under uppdateringen',
  basicPerformanceUpdate: 'Grundläggande prestanda',
  productFunctionUpdate: 'Produktfunktioner',
  updateFailed: 'Kunde inte uppdatera',
  partialUpdateFailed: 'Det gick inte att slutföra en del av uppdateringen',
  checkUpdateFailed: 'Det gick inte att söka efter uppdateringar',
  updated: 'Uppdaterad',
  deviceOfflineCheckNetwork: 'Enheten är offline. Kontrollera nätverksinställningarna.',
  checkNetworkError: 'Ett nätverksfel inträffade. Vänta en minut eller två och försök igen.',
  alreadyLatest: 'Aktuell version är uppdaterad',
  ...
  cloutStorageSetting: 'Fler inställningar för molnlagring',
  open: 'På',
  close: 'Av',
  other: 'Övrigt',
  ...
  moreDeviceInfo: 'Mer enhetsinformation',
  ...
  switch_dia_msg_repeatScene: 'Den här knappen har redan en automatisering med en tryckning. Om du ansluter en enhet kan den utlösas upprepade gånger. Vill du ta bort den anslutna enheten?',
  common_loading: 'Vänta en stund…',
  ...
  select_control_type: 'Välj typ av styrning',
  non_smart_device_wired: 'Styr icke-smarta enheter via en kabelanslutning',
  control_smart_lights_group: 'Styr smarta lampor eller ljusgrupper i det här hemmet',
  switch_double_control: 'Dubbelväxlande styrning',
  link_other_switches_intercontrol: 'Anslut till andra smarta brytare så att de kontrollerar varandra',
  execute_scene: 'Kör scen',
  execute_manual_scenes_home: 'Kör en befintlig manuell scen (t.ex. ”Hemma igen”)',
  more_smart_devices: 'Fler smarta enheter',
  control_other_devices_home: 'Styr andra smarta enheter i hemmet (t.ex. luftkonditionering)',
  power_switch: 'Strömbrytare',
  turn_off_light_offline: 'Om du stänger av det här förlorar den anslutna smarta lampan strömmen och förblir offline',
  manage_switch_power: 'Slå på eller av strömbrytaren. Om du vill ha smarta lampor online låter du dem vara påslagna.',
  automation_toggle_btn: 'Byt',
  save: 'Spara',
  add_device_type: 'Lägg till enhetstyp',
  common_brand_produced_by: 'Utformad av ${}',
  automation_add_control_device: 'Lägg till enheter',
  automation_edit_btn: 'Redigera',
  switch_autoCtrl_confirmToSmart_desc: 'När du har svept på knappen, aktiveras den, eller avaktiveras den inte längre och kan användas för att styra smarta enheter i det här hemmet.',
  switch_autoCtrl_confirmToSmart_title: 'Vill du byta till trådlöst läge?',
  switch_autoCtrl_confirmToSpeedMode_desc: 'I superhastighetsläget körs inte automatiseringarna Dubbeltryck och Tryck och håll.',
  switch_autoCtrl_confirmToSpeedMode_title: 'Byt till läget Superhastighet?',
  switch_autoCtrl_confirmToTraditional_desc: 'När du har bytt, styr knappen inte längre smarta enheter och relaterade automatiseringar körs inte.',
  switch_autoCtrl_confirmToTraditional_title: 'Byt till trådlöst läge?',
  switch_autoCtrl_ctrlSection: 'Styrning',
  switch_autoCtrl_modeSection: 'Läge',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'I avstängt läge förlorar anslutna enheter strömmen och förblir offline',
  switch_autoCtrl_powerSwitch_title: 'Strömstyrning',
  switch_autoCtrl_selectControlDevice_title: 'Välj enheter',
  switch_autoCtrl_smartMode_desc: 'Använd knappen för att styra smarta enheter, t.ex. smarta lampor eller smarta strömbrytare',
  switch_autoCtrl_smartMode_title: 'Trådlöst läge',
  switch_autoCtrl_traditionalMode_desc: 'Använd det här läget när du är ansluten till standardenheter, t.ex. vanliga lampor eller utluftsfläktar',
  switch_autoCtrl_traditionalMode_title: 'Kabelanslutet läge',
  switch_autoCtrl_wirelessHint_title: 'Automatisering med enkel tryckning, dubbel tryckning och tryck och håll ned, är tillgänglig efter att du har bytt till trådlöst läge',
  switch_controlType_advancedConfig: 'Avancerad installation',
  switch_controlType_manualScene_desc: 'Kör befintliga manuella scener (t.ex. ”Hemma igen”)',
  switch_controlType_manualScene_title: 'Manuella kontroller',
  switch_controlType_otherSmartDevice_desc: 'Styr andra smarta enheter i det här hemmet',
  switch_controlType_otherSmartDevice_title: 'Skapa automatisering',
  switch_controlType_quickConfig: 'Snabbinställning',
  switch_controlType_smartLight_desc: 'Tänd eller släck smarta lampor',
  switch_controlType_smartLight_title: 'Smart belysning',
  switch_controlType_switchDualControl_desc: 'Aktivera eller avaktivera andra smarta strömbrytare',
  switch_controlType_switchDualControl_title: 'Dubbelväxlande styrning',
  switch_layoutDetail_editIcon: 'Ändra ikon',
  switch_layoutDetail_name: 'Namn',
  switch_layoutDetail_room: 'Rum',
  switch_list_empty_light: 'Inga lampor som stöds i det här hemmet',
  switch_list_empty_manualScene: 'Inga manuella kontroller i det här hemmet. Lägg till från Xiaomi startsida.',
  switch_list_empty_switch: 'Inga strömbrytare som stöds i det här hemmet',
  switch_menu_deleteConfig: 'Radera konfiguration',
  switch_multikey_iconCategory_default: 'Standard',
  switch_multikey_iconCategory_light: 'Belysning',
  switch_multikey_iconCategory_other: 'Övrigt',
  switch_multikey_iconSelect_title: 'Ikon',
  switch_multikey_roomSelect_createFail: 'Kunde inte skapa rum',
  switch_multikey_roomSelect_createNew: 'Skapa rum',
  switch_multikey_roomSelect_inputPlaceholder: 'Ange rumsnamn',
