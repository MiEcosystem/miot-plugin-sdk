export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'Fysiska knappar kommer inte att kunna styra kretsar när den här funktionen är på. Du kommer fortfarande kunna använda dem för smarta scener.',
  ...
  switch_listItem_title_voiceControlLoop: 'Styr kretsar med röstkommandon',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Styr kretsar med Mi AI',
  switch_listItem_value_voiceControlLoopOn: 'På',
  switch_listItem_value_voiceControlLoopOff: 'Avstängd',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Aktivera och avaktivera kretsar med hjälp av Mi AI. Om smart belysning är inkluderad i kretsen kan de stängas av och kopplas bort.',
  ...
  switch_listItem_subtile_speedModeDescription: 'Om automatisering endast krävs för åtgärden att "trycka", rekommenderas det att man väljer det här alternativet. När det är valt kommer strömbrytaren att svara snabbt vid åtgärden tryckning, och förbättra svarshastigheten på automatiseringen.',
  switch_listItem_subtile_standardModeDescription: 'Välj det här alternativet om automatisering krävs för "Dubbeltryck" och "Tyck och håll".',
  switch_dia_msg_speedModeMessage: 'Automatiseringen som konfigureras på den aktuella enheten inkluderar "Dubbeltryck" eller "Tryck och håll". Smart-scenen kommer inte att svara när Superhastighetsläget är aktiverat. Aktivera ändå?',
