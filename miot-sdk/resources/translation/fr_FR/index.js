export default {
  ...
  updateWarningTip: 'Ne pas éteindre l’appareil ou l’utiliser pendant la mise à jour',
  basicPerformanceUpdate: 'Performance de base',
  productFunctionUpdate: 'Caractéristiques du produit',
  updateFailed: 'Mise à jour impossible',
  partialUpdateFailed: 'Impossible de terminer une partie de cette mise à jour',
  checkUpdateFailed: 'Impossible de rechercher des mises à jour',
  updated: 'Mis à jour',
  deviceOfflineCheckNetwork: 'L’appareil est déconnecté. Vérifiez les paramètres réseau.',
  checkNetworkError: 'Une erreur réseau est survenue. Patientez une minute ou deux, puis réessayez.',
  alreadyLatest: 'La version actuelle est à jour',
  checkingUpdate: 'Recherche de mises à jour…',
  foundNewVersion: 'Une mise à jour est disponible',
  version: 'Version',
  ...
  cloutStorageSetting: 'Plus de paramètres de stockage dans le cloud',
  open: 'Activé',
  close: 'Désactivé',
  other: 'Autre',
  ...
  switch_dia_msg_repeatScene: 'Ce bouton dispose déjà d\'une fonction d\'automatisation à pression unique. La connexion d\'un appareil peut entraîner son déclenchement répété. Retirer l\'appareil connecté ?',
  common_loading: 'Un instant…',
  pairMode: 'Mode d\'appariement',
  switch_title_buttonControlDevice_oneGang: 'Contrôles de l\'appareil',
  retry: 'Réessayer',
  bluetooth_connecting: 'Connexion via Bluetooth…',
  bluetooth_connection_phone: 'Cette fonctionnalité nécessite une connexion Bluetooth sur votre téléphone',
  connection_successful: 'Connexion réussie',
  connection_failed: 'Connexion impossible',
  usedOnMiHome: 'Utiliser avec Xiaomi Home',
  operation_failed: 'Impossible d\'effectuer cette action',
  operation_cancel: 'Action annulée',
  operation_success: 'Terminé',
  select_control_type: 'Sélectionnez le type de commande',
  non_smart_device_wired: 'Contrôlez les appareils non intelligents via une connexion filaire',
  control_smart_lights_group: 'Contrôlez les groupes de lumières et les lumières intelligentes dans cette maison',
  switch_double_control: 'Commande à double interrupteur',
  link_other_switches_intercontrol: 'Connectez d\'autres interrupteurs intelligents pour qu\'ils se contrôlent mutuellement',
  execute_scene: 'Exécuter la scène',
  execute_manual_scenes_home: 'Exécutez une scène manuelle existante (par exemple « Retour à la maison »)',
  more_smart_devices: 'Plus de dispositifs intelligents',
  control_other_devices_home: 'Contrôlez d\'autres appareils intelligents dans cette maison (la climatisation, par exemple)',
  power_switch: 'Interrupteur d\'alimentation',
  turn_off_light_offline: 'Si vous désactivez cette fonctionnalité, la lampe connectée sera mise hors tension et se déconnectera',
  manage_switch_power: 'Allumez ou éteignez l\'interrupteur. Pour que les lampes intelligentes restent connectées, laissez-le allumé.',
  automation_toggle_btn: 'Changer',
  save: 'Sauvegarder',
  add_device_type: 'Ajouter un type d\'appareil',
  common_brand_produced_by: 'Conçu par ${}',
  automation_add_control_device: 'Ajouter un appareil',
  automation_edit_btn: 'Modifier',
  switch_autoCtrl_confirmToSmart_desc: 'Une fois le changement effectué, le bouton ne servira plus à activer ou désactiver l\'interrupteur, mais il permettra de contrôler les appareils connectés de ce domicile.',
  switch_autoCtrl_confirmToSmart_title: 'Passer en mode Sans Fil ?',
  switch_autoCtrl_confirmToSpeedMode_desc: 'En mode Super Vitesse, les automatismes par double pression et par pression prolongée ne sont pas exécutés.',
  switch_autoCtrl_confirmToSpeedMode_title: 'Passer en mode Super Vitesse ?',
  switch_autoCtrl_confirmToTraditional_desc: 'Une fois le changement effectué, le bouton ne permettra plus de contrôler les appareils connectés et les automatismes associés ne seront plus exécutés.',
  switch_autoCtrl_confirmToTraditional_title: 'Passer en mode Filaire ?',
  switch_autoCtrl_ctrlSection: 'Commande',
  switch_autoCtrl_modeSection: 'Mode',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'Une fois éteints, les appareils connectés seront privés d\'alimentation et se déconnecteront',
  switch_autoCtrl_powerSwitch_title: 'Commande de la puissance',
  switch_autoCtrl_selectControlDevice_title: 'Sélectionnez les appareils',
  switch_autoCtrl_smartMode_desc: 'Utilisez ce bouton pour contrôler des appareils connectés, tels que des ampoules connectées ou des interrupteurs connectés',
  switch_autoCtrl_smartMode_title: 'Mode Sans Fil',
  switch_autoCtrl_traditionalMode_desc: 'Utilisez ce mode lorsque vous êtes connecté à des appareils standard, tels que des ampoules classiques ou des ventilateurs d\'extraction',
  switch_autoCtrl_traditionalMode_title: 'Mode Filaire',
  switch_autoCtrl_wirelessHint_title: 'Les automatismes par simple pression, double pression et pression prolongée seront disponibles lorsque vous serez passé en mode sans fil',
  switch_controlType_advancedConfig: 'Configuration avancée',
  switch_controlType_manualScene_desc: 'Exécutez les scénarios manuels existants (par exemple « Retour à la maison »)',
  switch_controlType_manualScene_title: 'Commandes manuelles',
  switch_controlType_otherSmartDevice_desc: 'Contrôlez les autres appareils connectés de ce domicile',
  switch_controlType_otherSmartDevice_title: 'Créer un automatisme',
  switch_controlType_quickConfig: 'Configuration rapide',
  switch_controlType_smartLight_desc: 'Allumez ou éteignez les ampoules connectées',
  switch_controlType_smartLight_title: 'Ampoules connectées',
  switch_controlType_switchDualControl_desc: 'Allumez ou éteignez d\'autres interrupteurs connectés',
  switch_controlType_switchDualControl_title: 'Commande à double interrupteur',
  switch_layoutDetail_editIcon: 'Changer l\'icône',
  switch_layoutDetail_name: 'Nom',
  switch_layoutDetail_room: 'Pièce',
  switch_list_empty_light: 'Aucune ampoule prise en charge détectée',
  switch_list_empty_manualScene: 'Ce domicile ne dispose d\'aucune commande manuelle. Ajoutez-en une sur la page d\'accueil de Xiaomi Home.',
  switch_list_empty_switch: 'Aucun interrupteur pris en charge détecté',
  switch_menu_deleteConfig: 'Supprimer la configuration',
  switch_multikey_iconCategory_default: 'Par défaut',
  switch_multikey_iconCategory_light: 'Ampoules',
  switch_multikey_iconCategory_other: 'Autres',
  switch_multikey_iconSelect_title: 'Icône',
  switch_multikey_roomSelect_createFail: 'Impossible de créer la pièce',
  switch_multikey_roomSelect_createNew: 'Créer une pièce',
  switch_multikey_roomSelect_inputPlaceholder: 'Saisissez le nom de la pièce',
