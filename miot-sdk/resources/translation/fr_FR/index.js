export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'Les boutons physiques ne pourront pas contrôler les circuits lorsque cette fonction est activée. Vous pourrez toujours les utiliser pour les scènes intelligentes.',
  ...
  switch_listItem_title_voiceControlLoop: 'Contrôler les circuits par commande vocale',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Contrôler les circuits avec Mi AI',
  switch_listItem_value_voiceControlLoopOn: 'Activé',
  switch_listItem_value_voiceControlLoopOff: 'Désactivé',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Activer et désactiver les circuits avec Mi AI. Si des lumières intelligentes sont incluses dans le circuit, elles peuvent être mises hors tension et déconnectées.',
  ...
  switch_listItem_subtile_speedModeDescription: 'Si l’automatisation n’est requise que pour l’action « appuyer », il est recommandé de sélectionner cette option. L’interrupteur répondra alors rapidement, améliorant ainsi la vitesse de réponse de l’automatisation.',
  switch_listItem_subtile_standardModeDescription: 'Si l’automatisation est requise pour "Double appui" et "Appuyer et maintenir", sélectionnez cette option.',
  switch_dia_msg_speedModeMessage: 'L’automatisation configurée sur l’appareil actuel comprend "Double appui" ou "appuyer et maintenir". La scène intelligente ne répondra pas lorsque le mode Super vitesse est activé. Activer quand même ?',
