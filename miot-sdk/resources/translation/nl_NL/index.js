export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'Fysieke knoppen kunnen geen circuits bedienen als deze functie is ingeschakeld. U kunt ze nog steeds gebruiken voor slimme scènes.',
  ...
  switch_listItem_title_voiceControlLoop: 'Bedien circuits met spraakopdrachten',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Bedien circuits met Mi AI',
  switch_listItem_value_voiceControlLoopOn: 'Aan',
  switch_listItem_value_voiceControlLoopOff: 'Uit',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Activeer en deactiveer circuits met Mi AI. Als het circuit slimme lichten bevat, kunnen ze worden uitgeschakeld en losgekoppeld.',
  ...
  switch_listItem_subtile_speedModeDescription: 'Het is aanbevolen deze optie te selecteren als automatisering alleen voor "drukken" is vereist. Zodra de optie is geselecteerd, reageert de schakelaar snel op "drukken" en wordt de reactiesnelheid van de automatisering verbeterd.',
  switch_listItem_subtile_standardModeDescription: 'Als automatisering vereist is voor "twee keer drukken" en "ingedrukt houden", selecteert u deze optie.',
  switch_dia_msg_speedModeMessage: 'De automatisering die op het huidige apparaat is geconfigureerd, omvat "twee keer drukken" of "ingedrukt houden". Slimme scène reageert niet wanneer de Supersnelle modus is ingeschakeld. Toch inschakelen?',
