export default {
  ...
  updateWarningTip: 'Het apparaat niet uitschakelen of gebruiken tijdens de update',
  basicPerformanceUpdate: 'Basisprestaties',
  productFunctionUpdate: 'Productkenmerken',
  updateFailed: 'Bijwerken is mislukt',
  partialUpdateFailed: 'Een deel van deze update kon niet voltooid worden',
  checkUpdateFailed: 'Er kon niet op updates worden gecontroleerd',
  updated: 'Bijgewerkt',
  deviceOfflineCheckNetwork: 'Het apparaat is offline. Controleer de netwerkinstellingen.',
  checkNetworkError: 'Er is een netwerkfout opgetreden. Wacht een minuut of twee en probeer het opnieuw.',
  alreadyLatest: 'De huidige versie is up-to-date',
  ...
  cloutStorageSetting: 'Meer instellingen voor de cloudopslag',
  open: 'Aan',
  close: 'Uit',
  other: 'Andere',
  ...
  // 房间
  room: 'Ruimte',
  room_nameInputTips: 'Voer een ruimtenaam in',
  ...
  switch_dia_msg_repeatScene: 'Deze knop heeft al een "één keer drukken"-automatisering. Als u een apparaat aansluit, kan dit herhaaldelijk worden geactiveerd. Het aangesloten apparaat verwijderen?',
  common_loading: 'Even geduld a.u.b.…',
  ...
  select_control_type: 'Type bediening selecteren',
  non_smart_device_wired: 'Niet-slimme apparaten via een bekabelde verbinding bedienen',
  control_smart_lights_group: 'Slimme lampen of lichtgroepen in dit huis bedienen',
  switch_double_control: 'Bediening met dubbele schakelaar',
  link_other_switches_intercontrol: 'Verbinding maken met andere slimme schakelaars zodat ze elkaar bedienen',
  execute_scene: 'Scène uitvoeren',
  execute_manual_scenes_home: 'Een bestaande handmatige scène uitoeren (bijv. "Weer thuis")',
  more_smart_devices: 'Meer slimme apparaten',
  control_other_devices_home: 'Andere slimme apparaten in dit huis bedienen (bijv. airco)',
  power_switch: 'Stroomschakelaar',
  turn_off_light_offline: 'Als u dit uitschakelt, krijgt de aangesloten slimme lamp geen stroom meer en gaat offline',
  manage_switch_power: 'Schakel de schakelaar in of uit. Laat hem ingeschakeld om slimme lampen online te houden.',
  automation_toggle_btn: 'Schakelaar',
  save: 'Opslaan',
  add_device_type: 'Apparaattype toevoegen',
  common_brand_produced_by: 'Ontwikkeld door ${}',
  automation_add_control_device: 'Apparaten toevoegen',
  automation_edit_btn: 'Bewerken',
  switch_autoCtrl_confirmToSmart_desc: 'Na het overschakelen schakelt de knop de schakelaar niet meer in of uit en kan deze worden gebruikt om slimme apparaten in dit huis te bedienen.',
  switch_autoCtrl_confirmToSmart_title: 'Overschakelen naar draadloze modus?',
  switch_autoCtrl_confirmToSpeedMode_desc: 'In de supersnelle modus worden automatische instellingen met dubbel drukken en ingedrukt houden niet uitgevoerd.',
  switch_autoCtrl_confirmToSpeedMode_title: 'Overschakelen naar de supersnelle modus?',
  switch_autoCtrl_confirmToTraditional_desc: 'Na het overschakelen zal de knop niet langer slimme apparaten bedienen en worden gerelateerde automatiseringen niet meer uitgevoerd.',
  switch_autoCtrl_confirmToTraditional_title: 'Overschakelen naar bedrade modus?',
  switch_autoCtrl_ctrlSection: 'Bediening',
  switch_autoCtrl_modeSection: 'Modus',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'Als dit uitgeschakeld is, krijgen verbonden apparaten geen stroom meer en gaan offline',
  switch_autoCtrl_powerSwitch_title: 'Energiebeheer',
  switch_autoCtrl_selectControlDevice_title: 'Apparaten selecteren',
  switch_autoCtrl_smartMode_desc: 'Gebruik de knop om slimme apparaten te bedienen, zoals slimme lampen of slimme schakelaars',
  switch_autoCtrl_smartMode_title: 'Draadloze modus',
  switch_autoCtrl_traditionalMode_desc: 'Gebruik deze modus bij een verbinding met standaardapparaten, zoals gewone lampen of afzuigventilatoren',
  switch_autoCtrl_traditionalMode_title: 'Bedrade modus',
  switch_autoCtrl_wirelessHint_title: 'Automatiseringen met één keer drukken, twee keer drukken en ingedrukt houden zijn beschikbaar nadat u overgeschakt naar de draadloze modus',
  switch_controlType_advancedConfig: 'Geavanceerd instellen',
  switch_controlType_manualScene_desc: 'Bestaande handmatige scènes uitoeren (bijv. "Terug naar huis")',
  switch_controlType_manualScene_title: 'Handmatige bedieningselementen',
  switch_controlType_otherSmartDevice_desc: 'Andere slimme apparaten in dit huis bedienen',
  switch_controlType_otherSmartDevice_title: 'Automatisering aanmaken',
  switch_controlType_quickConfig: 'Snel instellen',
  switch_controlType_smartLight_desc: 'Slimme lichten in of -uitschakelen',
  switch_controlType_smartLight_title: 'Slimme lichten',
  switch_controlType_switchDualControl_desc: 'Andere slimme schakelaars in- of uitschakelen',
  switch_controlType_switchDualControl_title: 'Bediening met dubbele schakelaar',
  switch_layoutDetail_editIcon: 'Pictogram wijzigen',
  switch_layoutDetail_name: 'Naam',
  switch_layoutDetail_room: 'Kamer',
  switch_list_empty_light: 'Geen ondersteunde lichten in dit huis',
  switch_list_empty_manualScene: 'Geen handmatige bedieningselementen in dit huis. Voeg ze toe vanaf de startpagina van Xiaomi Home.',
  switch_list_empty_switch: 'Geen ondersteunde schakelaars in dit huis',
  switch_menu_deleteConfig: 'Configuratie verwijderen',
  switch_multikey_iconCategory_default: 'Standaard',
  switch_multikey_iconCategory_light: 'Lichten',
  switch_multikey_iconCategory_other: 'Overig',
  switch_multikey_iconSelect_title: 'Pictogram',
  switch_multikey_roomSelect_createFail: 'Kon kamer niet aanmaken',
  switch_multikey_roomSelect_createNew: 'Kamer aanmaken',
  switch_multikey_roomSelect_inputPlaceholder: 'Kamernaam invoeren',
