export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'כאשר תכונה זו מופעלת, לחצנים פיזיים לא יוכלו לשלוט במעגלים חשמליים. עדיין תוכל להשתמש בהם עבור סצנות חכמות.',
  switch_dia_msg_wirelessSwitchSetting: 'לחצן זה משויך לפריט אחר (${}). שנה למתג אלחוטי כדי להשתמש בו.',
  switch_listItem_title_voiceControlLoop: 'שליטה במעגלים חשמליים באמצעות פקודות קוליות',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'שליטה במעגלים חשמליים באמצעות Mi AI',
  switch_listItem_value_voiceControlLoopOn: 'מופעל',
  switch_listItem_value_voiceControlLoopOff: 'כבוי',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'הפעלה וכיבוי של מעגלים חשמליים באמצעות Mi AI. אם המעגל כולל נורות חכמות, ייתכן שהן כבויות ומנותקות.',
  ...
  switch_listItem_subtile_speedModeDescription: 'אם האוטומציה נדרשת רק לצורך פעולת "לחיצה", מומלץ לבחור באפשרות זו. לאחר הבחירה, המתג יגיב במהירות לפעולת הלחיצה, מה שישפר את מהירות התגובה של האוטומציה.',
  switch_listItem_subtile_standardModeDescription: 'אם נדרשת אוטומציה עבור "לחיצה כפולה" ו"לחץ והחזק", בחר באפשרות זו.',
  switch_dia_msg_speedModeMessage: 'האוטומציה המוגדרת במכשיר הנוכחי כוללת את "לחיצה כפולה" או "לחץ והחזק". סצנה חכמה לא תגיב כאשר מצב מהירות על מופעל. להפעיל בכל זאת?',
