export default {
  ...
  updateWarningTip: 'อย่าปิดเครื่องหรือใช้อุปกรณ์ตลอดการอัปเดต',
  basicPerformanceUpdate: 'ประสิทธิภาพขั้นพื้นฐาน',
  productFunctionUpdate: 'คุณสมบัติของผลิตภัณฑ์',
  updateFailed: 'ไม่สามารถอัปเดตได้',
  partialUpdateFailed: 'ไม่สามารถดำเนินการอัปเดตในส่วนนี้ให้เสร็จสมบูรณ์ได้',
  checkUpdateFailed: 'ไม่สามารถตรวจสอบการอัปเดตได้',
  updated: 'อัปเดตแล้ว',
  deviceOfflineCheckNetwork: 'อุปกรณ์ออฟไลน์ โปรดตรวจสอบการตั้งค่าเครือข่าย',
  checkNetworkError: 'เครือข่ายเกิดข้อผิดพลาด รอสักครู่แล้วลองอีกครั้ง',
  alreadyLatest: 'เวอร์ชันปัจจุบันเป็นข้อมูลล่าสุดแล้ว',
  checkingUpdate: 'กำลังตรวจสอบการอัปเดต…',
  foundNewVersion: 'มีการอัปเดตพร้อมใช้งาน',
  version: 'เวอร์ชัน',
  ...
  cloutStorageSetting: 'การตั้งค่าพื้นที่เก็บข้อมูลบนคลาวด์เพิ่มเติม',
  open: 'เปิด',
  close: 'ปิด',
  other: 'อื่นๆ',
  ...
  switch_dia_msg_repeatScene: 'ปุ่มนี้มีระบบอัตโนมัติแบบกดครั้งเดียวอยู่แล้ว การเชื่อมต่ออุปกรณ์อาจทำให้เกิดการเรียกใช้งานซ้ำๆ ถอดอุปกรณ์ที่เชื่อมต่อออกหรือไม่',
  common_loading: 'รอสักครู่…',
  ...
  select_control_type: 'เลือกประเภทการควบคุม',
  non_smart_device_wired: 'ควบคุมอุปกรณ์ที่ไม่ใช่อุปกรณ์สมาร์ทผ่านการเชื่อมต่อแบบใช้สาย',
  control_smart_lights_group: 'ควบคุมระบบไฟอัจฉริยะหรือกลุ่มไฟในบ้านหลังนี้',
  switch_double_control: 'การควบคุมสวิตช์คู่',
  link_other_switches_intercontrol: 'เชื่อมต่อกับสวิตช์อัจฉริยะอื่นๆ เพื่อให้สามารถควบคุมซึ่งกันและกันได้',
  execute_scene: 'เรียกใช้ฉากที่สมาร์ท',
  execute_manual_scenes_home: 'เรียกใช้ฉากแบบกำหนดเองที่มีอยู่ (เช่น "กลับบ้าน")',
  more_smart_devices: 'อุปกรณ์สมาร์ทเพิ่มเติม',
  control_other_devices_home: 'ควบคุมอุปกรณ์สมาร์ทอื่นๆ ในบ้านหลังนี้ (เช่น เครื่องปรับอากาศ)',
  power_switch: 'สวิตช์ไฟ',
  turn_off_light_offline: 'หากคุณปิดสวิตช์นี้ ระบบไฟอัจฉริยะที่เชื่อมต่ออยู่จะขาดการจ่ายไฟและออฟไลน์',
  manage_switch_power: 'เปิดหรือปิดสวิตช์ หากต้องการให้ระบบไฟอัจฉริยะออนไลน์อยู่ ให้เปิดทิ้งไว้',
  automation_toggle_btn: 'สลับ',
  save: 'บันทึก',
  add_device_type: 'เพิ่มประเภทอุปกรณ์',
  common_brand_produced_by: 'ออกแบบโดย ${}',
  automation_add_control_device: 'เพิ่มอุปกรณ์',
  automation_edit_btn: 'แก้ไข',
  switch_autoCtrl_confirmToSmart_desc: 'หลังจากที่สลับ ปุ่มจะไม่เปิดหรือปิดสวิตช์อีกต่อไป และสามารถใช้เพื่อควบคุมอุปกรณ์อัจฉรินะในบ้านหลังนี้ได้',
  switch_autoCtrl_confirmToSmart_title: 'สลับไปเป็นโหมดไร้สายหรือไม่',
  switch_autoCtrl_confirmToSpeedMode_desc: 'ในโหมดความเร็วสูง การแตะสองครั้งและการกดค้างที่ระบบอัตโนมัติจะไม่ทำงาน',
  switch_autoCtrl_confirmToSpeedMode_title: 'สลับไปเป็นโหมดความเร็วสูงหรือไม่',
  switch_autoCtrl_confirmToTraditional_desc: 'หลังจากที่สลับ ปุ่มจะไม่ควบคุมอุปกรณ์อัจฉริยะอีกต่อไป และระบบอัตโนมัติที่เกี่ยวข้องจะไม่ทำงาน',
  switch_autoCtrl_confirmToTraditional_title: 'สลับไปเป็นโหมดใช้สายหรือไม่',
  switch_autoCtrl_ctrlSection: 'ควบคุม',
  switch_autoCtrl_modeSection: 'โหมด',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'เมื่อปิดแล้ว อุปกรณ์ที่เชื่อมต่อจะขาดพลังงานและจะออฟไลน์',
  switch_autoCtrl_powerSwitch_title: 'การควบคุมพลังงาน',
  switch_autoCtrl_selectControlDevice_title: 'เลือกอุปกรณ์',
  switch_autoCtrl_smartMode_desc: 'ใช้ปุ่มนี้เพื่อควบคุมอุปกรณ์สมาร์ท เช่น ไฟอัจฉริยะหรือสวิตช์อัจฉริยะ',
  switch_autoCtrl_smartMode_title: 'โหมดไร้สาย',
  switch_autoCtrl_traditionalMode_desc: 'ใช้โหมดนี้เมื่อเชื่อมต่อกับอุปกรณ์มาตรฐาน เช่น ระบบไฟทั่วไปหรือพัดลมระบายอากาศ',
  switch_autoCtrl_traditionalMode_title: 'โหมดใช้สาย',
  switch_autoCtrl_wirelessHint_title: 'การกดหนี่งครั้ง การกดสองครั้ง และการกดค้างที่ระบบอัตโนมัติจะพร้อมใช้งานหลังจากที่คุณสลับไปเป็นโหมดไร้สาย',
  switch_controlType_advancedConfig: 'การตั้งค่าขั้นสูง',
  switch_controlType_manualScene_desc: 'เรียกใช้ฉากแบบกำหนดเองที่มีอยู่ (เช่น "กลับบ้าน")',
  switch_controlType_manualScene_title: 'การควบคุมด้วยตนเอง',
  switch_controlType_otherSmartDevice_desc: 'ควบคุมอุปกรณ์สมาร์ทอื่นๆ ในบ้านหลังนี้',
  switch_controlType_otherSmartDevice_title: 'สร้างระบบอัตโนมัติ',
  switch_controlType_quickConfig: 'การรตั้งค่าด่วน',
  switch_controlType_smartLight_desc: 'เปิดหรือปิดไฟอัจฉริยะ',
  switch_controlType_smartLight_title: 'ไฟอัจฉริยะ',
  switch_controlType_switchDualControl_desc: 'เปิดหรือปิดสวิตช์อัจฉริยะอื่นๆ',
  switch_controlType_switchDualControl_title: 'การควบคุมสวิตช์คู่',
  switch_layoutDetail_editIcon: 'เปลี่ยนไอคอน',
  switch_layoutDetail_name: 'ชื่อ',
  switch_layoutDetail_room: 'ห้อง',
  switch_list_empty_light: 'ไม่มีไฟที่รองรับในบ้านหลังนี้',
  switch_list_empty_manualScene: 'ไม่มีการควบคุมด้วยตนเองในบ้านหลังนี้ โปรดเพิ่มจากหน้าเริ่มต้นของ Xiaomi Home',
  switch_list_empty_switch: 'ไม่มีสวิตช์ที่รองรับในบ้านหลังนี้',
  switch_menu_deleteConfig: 'ลบการกำหนดค่า',
  switch_multikey_iconCategory_default: 'ค่าเริ่มต้น',
  switch_multikey_iconCategory_light: 'ไฟ',
  switch_multikey_iconCategory_other: 'อื่นๆ',
  switch_multikey_iconSelect_title: 'ไอคอน',
  switch_multikey_roomSelect_createFail: 'ไม่สามารถสร้างห้องได้',
  switch_multikey_roomSelect_createNew: 'สร้างห้อง',
  switch_multikey_roomSelect_inputPlaceholder: 'ป้อนชื่อห้อง',
