export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'ปุ่มทางกายภาพจะไม่สามารถควบคุมวงจรได้เมื่อคุณสมบัตินี้เปิดอยู่ คุณยังคงสามารถใช้ได้สำหรับฉากอัจฉริยะได้',
  switch_dia_msg_wirelessSwitchSetting: 'ปุ่มนี้เชื่อมโยงกับรายการอื่น (${}) เปลี่ยนเป็นสวิตช์ไร้สายเพื่อใช้งาน',
  switch_listItem_title_voiceControlLoop: 'ควบคุมวงจรไฟฟ้าด้วยคำสั่งเสียง',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'ควบคุมวงจรไฟฟ้าด้วย Mi AI',
  switch_listItem_value_voiceControlLoopOn: 'เปิด',
  switch_listItem_value_voiceControlLoopOff: 'ปิด',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'เปิดใช้งานและปิดใช้งานวงจรไฟฟ้าโดยใช้ Mi AI หากรวมไฟอัจฉริยะไว้ในวงจรไฟฟ้าแล้ว โคมไฟเหล่านั้นอาจถูกปิดและไม่ได้เชื่อมต่อ',
  ...
  switch_listItem_subtile_speedModeDescription: 'หากจำเป็นต้องใช้ระบบอัตโนมัติสำหรับการดำเนินการ "กด" เท่านั้น ขอแนะนำให้เลือกตัวเลือกนี้ เมื่อเลือกแล้ว สวิตช์จะตอบสนองต่อการกดอย่างรวดเร็ว ซึ่งจะช่วยเพิ่มความเร็วในการตอบสนองของระบบอัตโนมัติ',
  switch_listItem_subtile_standardModeDescription: 'หากจำเป็นต้องมีระบบอัตโนมัติสำหรับ "กดสองครั้ง" และ "กดค้างไว้" ให้เลือกตัวเลือกนี้',
  switch_dia_msg_speedModeMessage: 'ระบบอัตโนมัติที่กำหนดค่าไว้ในอุปกรณ์ปัจจุบันประกอบด้วย "กดสองครั้ง" หรือ "กดค้างไว้" ฉากอัจฉริยะจะไม่ตอบสนองเมื่อเปิดโหมดความเร็วพิเศษ เปิดใช่ไหม?',
