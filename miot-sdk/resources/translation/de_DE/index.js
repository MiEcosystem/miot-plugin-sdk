export default {
  ...
  updateWarningTip: 'Das Gerät während des Updates nicht ausschalten oder verwenden',
  basicPerformanceUpdate: 'Grundleistung',
  productFunctionUpdate: 'Produktfunktionen',
  updateFailed: 'Aktualisierung fehlgeschlagen',
  partialUpdateFailed: 'Ein Teil dieses Updates konnte nicht abgeschlossen werden',
  checkUpdateFailed: 'Es konnte nicht nach Aktualisierungen gesucht werden',
  updated: 'Aktualisiert',
  deviceOfflineCheckNetwork: 'Gerät ist offline. Netzwerkeinstellungen überprüfen.',
  checkNetworkError: 'Ein Netzwerkfehler ist aufgetreten. Warte ein bis zwei Minuten und versuche es erneut.',
  alreadyLatest: 'Die aktuelle Version ist auf dem neuesten Stand',
  checkingUpdate: 'Nach Aktualisierungen suchen…',
  foundNewVersion: 'Ein Update ist verfügbar',
  version: 'Version',
  ...
  cloutStorageSetting: 'Mehr Cloud-Speicher-Einstellungen',
  open: 'Ein',
  close: 'Aus',
  other: 'Sonstiges',
  ...
  fireSafeCode: 'Brandschutzvorschriften',
  fireSafeCodeTitle: 'Brandschutzvorschriften für Geräte',
  ...
  switch_dia_msg_repeatScene: 'Diese Taste verfügt bereits über eine Automatisierung mit einmaligem Drücken. Das Verbinden eines Geräts kann dazu führen, dass sie wiederholt ausgelöst wird. Das verbundene Gerät entfernen?',
  common_loading: 'Einen Moment…',
  ...
  usedOnMiHome: 'Mit Xiaomi Home verwenden',
  operation_failed: 'Diese Aktion konnte nicht abgeschlossen werden',
  operation_cancel: 'Aktion abgebrochen',
  operation_success: 'Fertig',
  select_control_type: 'Steuerungstyp auswählen',
  non_smart_device_wired: 'Nicht-Smarte-Geräte über eine kabelgebundene Verbindung steuern',
  control_smart_lights_group: 'Smarte Lichter oder Lichtgruppen in diesem Zuhause steuern',
  switch_double_control: 'Duale Schaltersteuerung',
  link_other_switches_intercontrol: 'Stelle eine Verbindung zu anderen smarten Schaltern her, damit diese sich gegenseitig steuern können',
  execute_scene: 'Szene ausführen',
  execute_manual_scenes_home: 'Eine existierende Szene ausführen (z. B. „Wieder zuhause“)',
  more_smart_devices: 'Weitere smarte Geräte',
  control_other_devices_home: 'Steuere anderes smarte Geräte in diesem Zuhause (z. B. AC)',
  power_switch: 'Stromschalter',
  turn_off_light_offline: 'Wenn du das ausschaltest, verliert das verbundene smarte Licht Strom und geht offline',
  manage_switch_power: 'Schalte den Schalter ein oder aus. Damit die smarten Lichter online bleiben, lasse ihn eingeschaltet.',
  automation_toggle_btn: 'Wechseln',
  save: 'Speichern',
  add_device_type: 'Gerätetyp hinzufügen',
  common_brand_produced_by: 'Entworfen von ${}',
  automation_add_control_device: 'Geräte hinzufügen',
  automation_edit_btn: 'Bearbeiten',
  switch_autoCtrl_confirmToSmart_desc: 'Nach dem Wechsel schaltet die Schaltfläche den Schalter nicht mehr ein oder aus, sondern dient zur Steuerung der smarten Geräte in diesem Zuhause.',
  switch_autoCtrl_confirmToSmart_title: 'Zum kabellosen Modus wechseln?',
  switch_autoCtrl_confirmToSpeedMode_desc: 'Im Super-Speed-Modus werden Automatisierungen mit Doppelklicken und Drücken und Halten nicht ausgeführt.',
  switch_autoCtrl_confirmToSpeedMode_title: 'Zum Super-Speed-Modus wechseln?',
  switch_autoCtrl_confirmToTraditional_desc: 'Nach dem Wechsel steuert die Schaltfläche keine smarten Geräte mehr und die damit verbundenen Automatisierungen werden nicht mehr ausgeführt.',
  switch_autoCtrl_confirmToTraditional_title: 'Zum kabelgebundenen Modus wechseln?',
  switch_autoCtrl_ctrlSection: 'Steuerung',
  switch_autoCtrl_modeSection: 'Modus',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'Wenn das Gerät ausgeschaltet wird, werden die verbundenen Geräte nicht mehr mit Strom versorgt und gehen offline',
  switch_autoCtrl_powerSwitch_title: 'Steuerung der Stromversorgung',
  switch_autoCtrl_selectControlDevice_title: 'Geräte auswählen',
  switch_autoCtrl_smartMode_desc: 'Verwende die Schaltfläche, um smarte Geräte wie smarte Lichter oder smarte Schalter zu steuern',
  switch_autoCtrl_smartMode_title: 'Kabelloser Modus',
  switch_autoCtrl_traditionalMode_desc: 'Verwende diesen Modus, wenn du Standardgeräte wie normale Lichter oder Abluftventilatoren verbindest',
  switch_autoCtrl_traditionalMode_title: 'Kabelgebundener Modus',
  switch_autoCtrl_wirelessHint_title: 'Nach dem Wechsel in den kabellosen Modus stehen die Automatisierungsfunktionen „Einmal drücken“, „Zweimal drücken“ und „Drücken und halten“ zur Verfügung',
  switch_controlType_advancedConfig: 'Erweiterte Einrichtung',
  switch_controlType_manualScene_desc: 'Führe existierende manuelle Szenen aus (z. B. „Wieder zuhause“)',
  switch_controlType_manualScene_title: 'Manuelle Steuerungen',
  switch_controlType_otherSmartDevice_desc: 'Steuere anderes smarte Geräte in diesem Zuhause',
  switch_controlType_otherSmartDevice_title: 'Automatisierung erstellen',
  switch_controlType_quickConfig: 'Schnelleinrichtung',
  switch_controlType_smartLight_desc: 'Smarte Lichter ein- oder ausschalten',
  switch_controlType_smartLight_title: 'Smarte Lichter',
  switch_controlType_switchDualControl_desc: 'Smarte Schalter ein- oder ausschalten',
  switch_controlType_switchDualControl_title: 'Duale Schaltersteuerung',
  switch_layoutDetail_editIcon: 'Symbol ändern',
  switch_layoutDetail_name: 'Name',
  switch_layoutDetail_room: 'Raum',
  switch_list_empty_light: 'Keine unterstützten Lichter in diesem Zuhause',
  switch_list_empty_manualScene: 'Keine manuellen Steuerungen in diesem Zuhause. Füge sie von der Xiaomi-Home-Startseite hinzu.',
  switch_list_empty_switch: 'Keiner unterstützten Schalter in diesem Zuhause',
  switch_menu_deleteConfig: 'Konfiguration löschen',
  switch_multikey_iconCategory_default: 'Standard',
  switch_multikey_iconCategory_light: 'Lichter',
  switch_multikey_iconCategory_other: 'Sonstiges',
  switch_multikey_iconSelect_title: 'Symbol',
  switch_multikey_roomSelect_createFail: 'Raum konnte nicht erstellt werden',
  switch_multikey_roomSelect_createNew: 'Raum erstellen',
  switch_multikey_roomSelect_inputPlaceholder: 'Raumname eingeben',
  ...
  switch_autoCtrl_confirmToTraditionalDeleteConfig_desc: 'Nach dem Wechsel steuert die Schaltfläche keine smarten Geräte mehr und die damit verbundene Steuerungseinstellungen werden gelöscht.',
  switch_autoCtrl_speedModeDescription: 'Unterstützt einzelnes Drücken für eine schnellere Reaktion',
  switch_autoCtrl_standardModeDescription: 'Unterstützt einzelnes Drücken, doppeltes Drücken und drücken und halten',
  switch_autoCtrl_multipleControlsHint: 'Nur eine Steuerung verknüpfen',
};