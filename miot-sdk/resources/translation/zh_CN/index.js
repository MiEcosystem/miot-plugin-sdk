export default {
  ...
  firmwareUpdate: '固件更新',
  updateWarningTip: '更新过程中，请勿断电或进行其他操作，以免更新异常或失败',
  ...
  checkNetworkError: '网络异常，请检查网络后重试',
  ...
  switch_dia_msg_repeatScene: "当前按键已创建了单击自动化，关联控制设备后，自动化可能会重复执行，是否需删除关联控制的设备？",
  common_loading: '加载中，请稍候…',
  pairMode: "配对模式",
  ...
  select_control_type: "选择控制的类型",
  non_smart_device_wired: "通过电线连接的非智能设备",
  control_smart_lights_group: "控制当前家庭下的智能灯或灯组",
  switch_double_control: "开关双控",
  link_other_switches_intercontrol: "关联其他智能开关，实现开关互控",
  execute_scene: "执行场景",
  execute_manual_scenes_home: "执行当前家庭已创建的手动场景，如回家模式",
  more_smart_devices: "更多智能设备",
  control_other_devices_home: "控制当前家庭下的其他智能设备，如空调等",
  power_switch: "电源开关",
  ...
  switch_autoCtrl_modeSection: "模式",
  switch_autoCtrl_ctrlSection: "控制",
  switch_autoCtrl_traditionalMode_title: "有线模式",
  switch_autoCtrl_traditionalMode_desc: "连接普通设备时使用（如普通灯、排气扇）",
  switch_autoCtrl_smartMode_title: "无线模式",
  switch_autoCtrl_smartMode_desc: "按键用于控制智能设备（如智能灯、智能开关）",
  switch_autoCtrl_confirmToSpeedMode_title: "确认切换为疾速模式吗",
  switch_autoCtrl_confirmToSpeedMode_desc: "疾速模式下，双击和长按的自动化将无法执行",
  switch_autoCtrl_confirmToSmart_title: "确认切换无线模式吗",
  switch_autoCtrl_confirmToSmart_desc: "切换后，按键不再控制开关的通断，可用于控制当前家庭下的智能设备",
  switch_autoCtrl_confirmToTraditional_title: "确认切换有线模式吗",
  switch_autoCtrl_confirmToTraditional_desc: "切换后，操作按键时，不再控制智能设备，相关自动化将无法执行",
  switch_multikey_iconSelect_title: '图标',
  switch_multikey_iconCategory_light: '灯',
  switch_multikey_iconCategory_other: '其他',
  switch_multikey_iconCategory_default: '默认',
  switch_multikey_roomSelect_createNew: '创建新房间',
  switch_multikey_roomSelect_inputPlaceholder: '输入房间名称',
  switch_multikey_roomSelect_createFail: '创建房间失败',
  switch_layoutDetail_editIcon: '修改图标',
  switch_layoutDetail_name: '名称',
  switch_layoutDetail_room: '房间',
  switch_autoCtrl_powerSwitch_title: '开关电源',
  switch_autoCtrl_powerSwitch_confirmOff_desc: '关闭后，开关连接的智能设备会断电离线',
  switch_nav_subtitle_buttonControlLight_v2: "单击按键时，打开或关闭所选的灯",
  switch_nav_subtitle_buttonControlSwitch_v2: "单击按键时，打开或关闭所选的开关",
  switch_nav_subtitle_buttonControlManualScene_v2: "单击按键时，执行所有的手动控制",
  switch_controlType_quickConfig: "快速配置",
  switch_controlType_advancedConfig: "高阶配置",
  switch_controlType_otherSmartDevice_title: "创建自动化",
  switch_controlType_otherSmartDevice_desc: "控制当前家庭下的其他智能设备",
  switch_controlType_smartLight_title: "智能灯",
  switch_controlType_smartLight_desc: "打开或关闭智能灯",
  switch_controlType_switchDualControl_title: "开关双控",
  switch_controlType_switchDualControl_desc: "打开或关闭其他智能开关",
  switch_controlType_manualScene_title: "手动控制",
  switch_controlType_manualScene_desc: "执行已创建的手动场景，如“回家模式”",
  switch_menu_deleteConfig: "删除配置",
  ...
  "scene_some_people_active": "一些用户已使用",
  "scene_upgrade_subtitle": "体验更多设备联动场景",
  // ====== 4G 流量卡详情页(MobileCardPage)======
  mobileCard_title: "流量卡",
  mobileCard_tabBuiltIn: "内置卡{0}",
  mobileCard_tabExternal: "外置卡{0}",
  mobileCard_inUse: "使用中",
  mobileCard_noCard: "无流量卡",
  mobileCard_operatorUnknown: "未知运营商",
  mobileCard_operatorMobile: "中国移动",
  mobileCard_operatorUnicom: "中国联通",
  mobileCard_operatorTelecom: "中国电信",
  mobileCard_iccidCopied: "卡号复制成功",
  mobileCard_signalSnr: "SNR",
  mobileCard_signalRsrp: "RSRP",
  mobileCard_signalRsrq: "RSRQ",
  mobileCard_signalBand: "Band",
  mobileCard_signalDownlink: "下行通道",
  mobileCard_autoSwitchTitle: "智能切换SIM卡",
  mobileCard_autoSwitchSubtitle: "使用中的SIM卡不可用时，会自动切换",
  mobileCard_switchConfirmTitle: "切换流量卡？",
  mobileCard_switchConfirmContent: "切换流量卡时，设备预计会离线3分钟左右，确认切换？",
  mobileCard_switchConfirm: "切换",
  mobileCard_switching: "流量卡切换中…",
  mobileCard_switchSuccess: "流量卡切换成功",
  mobileCard_switchFailed: "流量卡切换失败",
  mobileCard_offlineCannotSwitch: "设备已离线，无法切换",
  mobileCard_setFailed: "设置失败",
  mobileCard_freeFlowFooter: "免费流量使用说明：根据运营商标准，物联网卡是与设备绑定的机卡。免费流量使用时长与设备生命周期相关，摄像机设备如无法使用，免费流量即视为到期，即：无法将此卡转移到其他设备上使用。",
