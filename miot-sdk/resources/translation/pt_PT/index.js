export default {
  ...
  productFunctionUpdate: 'Funcionalidades do produto',
  updateFailed: 'Não foi possível atualizar',
  partialUpdateFailed: 'Não foi possível concluir parte desta atualização',
  checkUpdateFailed: 'Não foi possível procurar atualizações',
  updated: 'Atualizado(a)',
  deviceOfflineCheckNetwork: 'O dispositivo está \'offline\'. Verifique as definições de rede.',
  checkNetworkError: 'Ocorreu um erro na rede. Espere um minuto ou dois e tente novamente.',
  alreadyLatest: 'A versão atual está atualizada',
  checkingUpdate: 'A procurar atualizações…',
  foundNewVersion: 'Está disponível uma atualização',
  version: 'Versão',
  ...
  cloutStorageSetting: 'Mais definições de armazenamento na nuvem',
  open: 'Ligado',
  close: 'Desligado',
  other: 'Outro',
  ...
  // 房间
  room: 'Divisão',
  room_nameInputTips: 'Introduzir um nome de uma sala',
  ...
  fireSafeCode: 'Código de segurança contra incêndio',
  fireSafeCodeTitle: 'Código de segurança contra incêndio do dispositivo',
  ...
  switch_dia_msg_repeatScene: 'Este botão já possui uma automação de pressão única. Ligar um dispositivo pode fazer com que ele seja acionado repetidamente. Remover o dispositivo ligado?',
  common_loading: 'Só um segundo…',
  pairMode: 'Modo de Emparelhamento',
  switch_title_buttonControlDevice_oneGang: 'Controlos de dispositivos',
  retry: 'Repetir',
  bluetooth_connecting: 'A ligar via Bluetooth…',
  bluetooth_connection_phone: 'Esta funcionalidade requer a ligação Bluetooth do seu telefone',
  connection_successful: 'Ligado com sucesso',
  connection_failed: 'Não foi possível ligar',
  usedOnMiHome: 'Usar com a Xiaomi Home',
  operation_failed: 'Não foi possível completar a ação',
  operation_cancel: 'Ação cancelada',
  operation_success: 'Concluído',
  select_control_type: 'Selecionar o tipo de controlo',
  non_smart_device_wired: 'Controle os dispositivos não inteligentes através de uma ligação por cabo',
  control_smart_lights_group: 'Controle as luzes inteligentes ou grupos de luzes nesta casa',
  switch_double_control: 'Controlo de interruptor duplo',
  link_other_switches_intercontrol: 'Ligue-se a outros interruptores inteligentes para se controlarem entre si',
  ...
  control_other_devices_home: 'Controle outros dispositivos inteligentes nesta casa (ex., AC)',
  power_switch: 'Interruptor de energia',
  turn_off_light_offline: 'Se desativar esta opção, a luz inteligente ligada perderá energia e ficará \'offline\'',
  manage_switch_power: 'Ligue ou desligue o interruptor. Para manter as luzes inteligentes \'online\', deixe-o ligado.',
  automation_toggle_btn: 'Alternar',
  save: 'Guardar',
  add_device_type: 'Adicionar um tipo de dispositivo',
  common_brand_produced_by: 'Projetado por ${}',
  automation_add_control_device: 'Adicionar dispositivos',
  automation_edit_btn: 'Editar',
  switch_autoCtrl_confirmToSmart_desc: 'Após a mudança, o botão já não ligará nem desligará o interruptor e poderá ser utilizado para controlar os dispositivos inteligentes nesta casa.',
  switch_autoCtrl_confirmToSmart_title: 'Mudar para o modo sem fios?',
  switch_autoCtrl_confirmToSpeedMode_desc: 'No modo super-rápido, não serão executadas as automatizações de "dupla pressão" e "pressão contínua".',
  switch_autoCtrl_confirmToSpeedMode_title: 'Mudar para o modo super-rápido?',
  switch_autoCtrl_confirmToTraditional_desc: 'Após a mudança, o botão já não controlará os dispositivos inteligentes e as automatizações relacionadas não serão executadas.',
  switch_autoCtrl_confirmToTraditional_title: 'Mudar para o modo com fios?',
  switch_autoCtrl_ctrlSection: 'Controlo',
  switch_autoCtrl_modeSection: 'Modo',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'Se desativar, os dispositivos ligados perderão energia e ficarão \'offline\'',
  switch_autoCtrl_powerSwitch_title: 'Controlo de energia',
  switch_autoCtrl_selectControlDevice_title: 'Selecionar dispositivos',
  switch_autoCtrl_smartMode_desc: 'Utilize o botão para controlar os dispositivos inteligentes, como luzes ou interruptores inteligentes',
  switch_autoCtrl_smartMode_title: 'Modo sem fios',
  switch_autoCtrl_traditionalMode_desc: 'Utilize este modo quando se ligar a dispositivos padrão, como luzes normais ou exaustores',
  switch_autoCtrl_traditionalMode_title: 'Modo com fios',
  switch_autoCtrl_wirelessHint_title: 'As automatizações de "pressão única", "dupla pressão" e "pressão contínua" ficam disponíveis após mudar para o modo sem fios',
  switch_controlType_advancedConfig: 'Configuração avançada',
  switch_controlType_manualScene_desc: 'Executar as cenas manuais existentes (ex. "Voltar para casa")',
  switch_controlType_manualScene_title: 'Controlos manuais',
  switch_controlType_otherSmartDevice_desc: 'Controlar outros dispositivos inteligentes nesta casa',
  switch_controlType_otherSmartDevice_title: 'Criar automatização',
  switch_controlType_quickConfig: 'Configuração rápida',
  switch_controlType_smartLight_desc: 'Acender ou apagar as luzes inteligentes',
  switch_controlType_smartLight_title: 'Luzes inteligentes',
  switch_controlType_switchDualControl_desc: 'Acenda ou apague outros interruptores inteligentes',
  switch_controlType_switchDualControl_title: 'Controlo de interruptor duplo',
  switch_layoutDetail_editIcon: 'Alterar o ícone',
  switch_layoutDetail_name: 'Nome',
  switch_layoutDetail_room: 'Sala',
  switch_list_empty_light: 'Não existem luzes compatíveis nesta casa',
  switch_list_empty_manualScene: 'Não existem controlos manuais nesta casa. Adicione a partir da página inicial da Xiaomi Home.',
  switch_list_empty_switch: 'Não existem interruptores compatíveis nesta casa',
  switch_menu_deleteConfig: 'Eliminar a configuração',
  switch_multikey_iconCategory_default: 'Predefinição',
  switch_multikey_iconCategory_light: 'Luzes',
  switch_multikey_iconCategory_other: 'Outro(a)',
  switch_multikey_iconSelect_title: 'Ícone',
  switch_multikey_roomSelect_createFail: 'Não foi possível criar a sala',
  switch_multikey_roomSelect_createNew: 'Criar a sala',
  switch_multikey_roomSelect_inputPlaceholder: 'Introduzir o nome da sala',
