export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'Butoanele fizice nu vor putea controla circuitele atunci când această funcție este activată. Vei putea totuși să le utilizezi pentru scene inteligente.',
  ...
  switch_listItem_title_voiceControlLoop: 'Controlați circuitele cu ajutorul comenzilor vocale',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Controlați circuitele cu Mi IA',
  switch_listItem_value_voiceControlLoopOn: 'Pornit',
  switch_listItem_value_voiceControlLoopOff: 'Oprit',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Activați și dezactivați circuite cu ajutorul Mi IA. Dacă luminile inteligente sunt incluse în circuit, ele trebuie stinse și deconectate.',
  ...
  switch_listItem_subtile_speedModeDescription: 'Dacă automatizarea este necesară doar pentru acțiunea de „apăsare”, se recomandă selectarea acestei opțiuni. După selectare, comutatorul va reacționa rapid la acțiunea de apăsare, îmbunătățind viteza răspunsului automatizării.',
  switch_listItem_subtile_standardModeDescription: 'Dacă este necesară automatizarea pentru "apasă de două ori" și "țineți apăsat", selectați această opțiune.',
  switch_dia_msg_speedModeMessage: 'Automatizarea configurată pe dispozitivul curent include "apasă de două ori" sau "țineți apăsat". Scena inteligentă nu va răspunde când modul Super viteză este activat. Activați oricum?',
