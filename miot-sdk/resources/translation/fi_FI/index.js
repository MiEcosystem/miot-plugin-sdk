export default {
  ...
  updateWarningTip: 'Älä sammuta laitetta tai käytä sitä päivityksen aikana',
  basicPerformanceUpdate: 'Perussuorituskyky',
  productFunctionUpdate: 'Tuotteen ominaisuudet',
  updateFailed: 'Päivittäminen ei onnistunut',
  partialUpdateFailed: 'Osaa tästä päivityksestä ei voitu suorittaa loppuun',
  checkUpdateFailed: 'Päivityksien hakeminen ei onnistunut',
  updated: 'Päivitetty',
  deviceOfflineCheckNetwork: 'Laite on offline-tilassa. Tarkista verkkoasetukset.',
  checkNetworkError: 'Tapahtui verkkovirhe. Odota pari minuuttia ja yritä uudelleen.',
  alreadyLatest: 'Nykyinen versio on ajan tasalla',
  ...
  cloutStorageSetting: 'Lisää pilvitallennustilan asetuksia',
  open: 'Päällä',
  close: 'Pois päältä',
  other: 'Muu',
  ...
  switch_dia_msg_repeatScene: 'Tällä painikkeella on jo yhden painalluksen automaatio. Laitteen yhdistäminen voi aiheuttaa sen toistuvan laukaisun. Poistetaanko yhdistetty laite?',
  common_loading: 'Hetki vain…',
  ...
  select_control_type: 'Valitse hallintatyyppi',
  non_smart_device_wired: 'Muiden kuin älylaitteiden ohjaaminen langallisen yhteyden kautta',
  control_smart_lights_group: 'Ohjaa älyvaloja tai valoryhmiä tässä kodissa',
  switch_double_control: 'Kaksoiskytkimen ohjaus',
  link_other_switches_intercontrol: 'Muodosta yhteys muihin älykytkimiin, jotta ne hallitsevat toisiaan',
  execute_scene: 'Suorita näkymä',
  execute_manual_scenes_home: 'Suorita aiemmin luotu manuaalinen näkymä (esim. "Takaisin kotona")',
  more_smart_devices: 'Lisää älylaitteita',
  control_other_devices_home: 'Hallitse muita kodin älylaitteita (esim. ilmastointi)',
  power_switch: 'Virtakytkin',
  turn_off_light_offline: 'Jos kytket tämän pois päältä, kytketty älyvalo menettää virran ja siirtyy offline-tilaan',
  manage_switch_power: 'Kytke päälle tai pois päältä. Jos haluat pitää älyvalot päällä, jätä päälle.',
  automation_toggle_btn: 'Vaihda',
  save: 'Tallenna',
  add_device_type: 'Lisää laitetyyppi',
  common_brand_produced_by: 'Suunnittelija ${}',
  automation_add_control_device: 'Lisää laitteita',
  automation_edit_btn: 'Muokkaa',
  switch_autoCtrl_confirmToSmart_desc: 'Vaihtamisen jälkeen painike ei enää kytke kytkintä päälle tai pois päältä, ja sitä voidaan käyttää kodin älylaitteiden ohjaamiseen.',
  switch_autoCtrl_confirmToSmart_title: 'Vaihda langattomaan tilaan?',
  switch_autoCtrl_confirmToSpeedMode_desc: 'Supernopeustilassa automaatiot eivät käynnisty kaksoispainalluksella tai painamalla ja pitämällä.',
  switch_autoCtrl_confirmToSpeedMode_title: 'Vaihda Supernopeustilaan?',
  switch_autoCtrl_confirmToTraditional_desc: 'Vaihtamisen jälkeen painike ei enää ohjaa älylaitteita, eikä siihen liittyviä automaatioita suoriteta.',
  switch_autoCtrl_confirmToTraditional_title: 'Vaihda langalliseen tilaan?',
  switch_autoCtrl_ctrlSection: 'Ohjaa',
  switch_autoCtrl_modeSection: 'Tila',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'Sammutettaessa yhdistettyjen laitteiden virta katkeaa ja ne siirtyvät offline-tilaan',
  switch_autoCtrl_powerSwitch_title: 'Virranhallinta',
  switch_autoCtrl_selectControlDevice_title: 'Valitse laitteet',
  switch_autoCtrl_smartMode_desc: 'Painikkeella voit ohjata älylaitteita, kuten älyvaloja tai älykytkimiä',
  switch_autoCtrl_smartMode_title: 'Langaton tila',
  switch_autoCtrl_traditionalMode_desc: 'Käytä tätä tilaa, kun laite on liitetty tavallisiin laitteisiin, kuten tavallisiin valoihin tai poistoilmapuhaltimiin',
  switch_autoCtrl_traditionalMode_title: 'Langallinen tila',
  switch_autoCtrl_wirelessHint_title: 'Langattomaan tilaan siirtymisen jälkeen automaatiot ovat käytettävissä yhdellä painalluksella, kaksoispainalluksella ja painamalla ja pitämällä',
  switch_controlType_advancedConfig: 'Lisäasetukset',
  switch_controlType_manualScene_desc: 'Suorita aiemmin luotu manuaalinen kohtaus (esim. "Takaisin kotona")',
  switch_controlType_manualScene_title: 'Manuaaliset säätimet',
  switch_controlType_otherSmartDevice_desc: 'Hallitse muita kodin älylaitteita',
  switch_controlType_otherSmartDevice_title: 'Luo automaatio',
  switch_controlType_quickConfig: 'Pika-asetukset',
  switch_controlType_smartLight_desc: 'Älyvalojen kytkeminen päälle ja pois',
  switch_controlType_smartLight_title: 'Älyvalot',
  switch_controlType_switchDualControl_desc: 'Muiden älykytkinten kytkeminen päälle ja pois päältä',
  switch_controlType_switchDualControl_title: 'Kaksoiskytkimen ohjaus',
  switch_layoutDetail_editIcon: 'Muokkaa kuvaketta',
  switch_layoutDetail_name: 'Nimi',
  switch_layoutDetail_room: 'Huone',
  switch_list_empty_light: 'Tässä kodissa ei ole tuettuja valoja',
  switch_list_empty_manualScene: 'Tässä kodissa ei ole manuaalisia säätimiä. Lisää niitä Xiaomi Home -aloitussivulta.',
  switch_list_empty_switch: 'Tässä kodissa ei ole tuettuja kytkimiä',
  switch_menu_deleteConfig: 'Poista määritys',
  switch_multikey_iconCategory_default: 'Oletus',
  switch_multikey_iconCategory_light: 'Valot',
  switch_multikey_iconCategory_other: 'Muu',
  switch_multikey_iconSelect_title: 'Kuvake',
  switch_multikey_roomSelect_createFail: 'Huonetta ei voitu luoda',
  switch_multikey_roomSelect_createNew: 'Luo huone',
  switch_multikey_roomSelect_inputPlaceholder: 'Syötä huoneen nimi',
