export default {
  ...
  updateWarningTip: 'No apagues ni utilice el dispositivo durante la actualización',
  basicPerformanceUpdate: 'Rendimiento básico',
  productFunctionUpdate: 'Características del producto',
  updateFailed: 'No se ha podido actualizar',
  partialUpdateFailed: 'No se ha podido completar parte de esta actualización',
  checkUpdateFailed: 'No ha sido posible comprobar si hay actualizaciones',
  updated: 'Actualizado',
  deviceOfflineCheckNetwork: 'El dispositivo está desconectado. Comprueba los ajustes de red.',
  checkNetworkError: 'Se ha producido un error de red. Espera uno o dos minutos y vuelve a intentarlo.',
  alreadyLatest: 'La versión actual está actualizada',
  ...
  cloutStorageSetting: 'Más ajustes del almacenamiento en la nube',
  open: 'Activado',
  close: 'Desactivado',
  other: 'Otros',
  ...
  switch_dia_msg_repeatScene: 'Este botón ya tiene una automatización de una sola pulsación. La conexión de un dispositivo puede provocar que se active repetidamente. ¿Deseas quitar el dispositivo conectado?',
  ...
  operation_failed: 'No se ha podido completar esta acción',
  operation_cancel: 'Acción cancelada',
  operation_success: 'Hecho',
  select_control_type: 'Seleccionar tipo de control',
  non_smart_device_wired: 'Controlar los dispositivos no inteligentes a través de una conexión por cable',
  control_smart_lights_group: 'Controlar las luces o grupos de luces inteligentes en esta casa',
  switch_double_control: 'Control de interruptor dual',
  link_other_switches_intercontrol: 'Conectar con otros interruptores inteligentes para que se controlen entre sí',
  execute_scene: 'Ejecutar escena',
  execute_manual_scenes_home: 'Ejecutar una escena manual existente (por ejemplo, "Volver a casa")',
  more_smart_devices: 'Más dispositivos inteligentes',
  control_other_devices_home: 'Controlar otros dispositivos inteligentes en esta casa (por ejemplo, aire acondicionado)',
  power_switch: 'Interruptor de corriente',
  turn_off_light_offline: 'Si desactivas esto, la luz inteligente conectada perderá energía y se desconectará',
  manage_switch_power: 'Activa o desactiva el interruptor. Para mantener las luces inteligentes en línea, déjalo activado.',
  automation_toggle_btn: 'Cambiar',
  save: 'Guardar',
  add_device_type: 'Añadir tipo de dispositivo',
  common_brand_produced_by: 'Diseñado por ${}',
  automation_add_control_device: 'Añadir dispositivos',
  ...
  switch_autoCtrl_confirmToSpeedMode_desc: 'En el Modo de supervelocidad, no se ejecutarán las automatizaciones de "pulsar dos veces" y "mantener pulsado".',
  ...
  switch_autoCtrl_smartMode_desc: 'Utiliza el botón para controlar dispositivos inteligentes, como luces inteligentes o interruptores inteligentes',
  switch_autoCtrl_smartMode_title: 'Modo inalámbrico',
  switch_autoCtrl_traditionalMode_desc: 'Utiliza este modo cuando te conectes a dispositivos estándar, como luces normales o extractores de aire',
  switch_autoCtrl_traditionalMode_title: 'Modo con cable',
  switch_autoCtrl_wirelessHint_title: 'Las automatizaciones de "pulsar una vez", "pulsar dos veces" y "mantener pulsado" están disponibles una vez que cambies al modo inalámbrico',
  ...
  switch_controlType_smartLight_desc: 'Enciende o apaga las luces inteligentes',
  switch_controlType_smartLight_title: 'Luces inteligentes',
  switch_controlType_switchDualControl_desc: 'Enciende o apaga otros interruptores inteligentes',
  switch_controlType_switchDualControl_title: 'Control de interruptor dual',
  switch_layoutDetail_editIcon: 'Cambiar icono',
  ...
  switch_list_empty_manualScene: 'No hay controles manuales en este hogar. Añádelos desde la página de inicio de Xiaomi Home.',
  switch_list_empty_switch: 'No hay interruptores compatibles en este hogar',
  switch_menu_deleteConfig: 'Eliminar configuración',
  switch_multikey_iconCategory_default: 'Predeterminado',
  switch_multikey_iconCategory_light: 'Luces',
  switch_multikey_iconCategory_other: 'Otro',
  switch_multikey_iconSelect_title: 'Icono',
  switch_multikey_roomSelect_createFail: 'No se ha podido crear la habitación',
  switch_multikey_roomSelect_createNew: 'Crear habitación',
  switch_multikey_roomSelect_inputPlaceholder: 'Introducir el nombre de la habitación',
