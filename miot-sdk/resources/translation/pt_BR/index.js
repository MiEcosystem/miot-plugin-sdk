export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'Os botões físicos não poderão controlar circuitos quando este recurso estiver ativado. Você ainda poderá utilizá-los para cenas inteligentes.',
  ...
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Controlar circuitos com o Mi AI',
  switch_listItem_value_voiceControlLoopOn: 'Ativado',
  switch_listItem_value_voiceControlLoopOff: 'Desativado',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Ativar e desativar circuitos usando o Mi AI. Se luzes inteligentes estiverem presentes no circuito, elas poderão ser desligadas e desconectadas.',
  ...
  switch_listItem_subtile_speedModeDescription: 'Se a automação só for necessária para a ação de "pressionar", recomenda-se selecionar esta opção. Uma vez selecionada, o interruptor responderá rapidamente à ação de pressionar, melhorando a velocidade de resposta da automação.',
