export default {
  ...
  updateWarningTip: 'Não desligue nem use o dispositivo durante a atualização',
  basicPerformanceUpdate: 'Desempenho básico',
  productFunctionUpdate: 'Recursos do produto',
  updateFailed: 'Não foi possível atualizar',
  partialUpdateFailed: 'Não foi possível concluir parte desta atualização',
  checkUpdateFailed: 'Não foi possível verificar atualizações',
  updated: 'Atualizado',
  deviceOfflineCheckNetwork: 'O dispositivo está offline. Verifique as configurações de rede.',
  checkNetworkError: 'Ocorreu um erro de rede. Aguarde alguns minutos e tente novamente.',
  alreadyLatest: 'A versão atual está atualizada',
  checkingUpdate: 'Verificando atualizações…',
  foundNewVersion: 'Uma atualização está disponível',
  version: 'Versão',
  ...
  cloutStorageSetting: 'Mais configurações de armazenamento em nuvem',
  open: 'Ativado',
  close: 'Desativado',
  other: 'Outros',
  ...
  // 房间
  room: 'Cômodo',
  room_nameInputTips: 'Inserir nome de cômodo',
  ...
  fireSafeCodeTitle: 'Código de segurança contra incêndios do dispositivo',
  ...
  switch_dia_msg_repeatScene: 'Este botão já possui automação de um único toque. Conectar um dispositivo pode fazê-lo ser acionado repetidamente. Remover o dispositivo conectado?',
  common_loading: 'Aguarde um minuto...',
  ...
  usedOnMiHome: 'Usar com Xiaomi Home',
  operation_failed: 'Não foi possível concluir esta ação',
  operation_cancel: 'Ação cancelada',
  operation_success: 'Concluído',
  select_control_type: 'Selecione o tipo de controle',
  non_smart_device_wired: 'Controle dispositivos não inteligentes através de uma conexão com fio',
  control_smart_lights_group: 'Controle luzes inteligentes ou grupos de luzes nesta casa',
  switch_double_control: 'Controle de interruptor duplo',
  link_other_switches_intercontrol: 'Conecte a outros interruptores inteligentes para que controlem uns aos outros',
  execute_scene: 'Executar cena',
  execute_manual_scenes_home: 'Executar uma cena manual existente (ex., "voltar para casa")',
  more_smart_devices: 'Mais dispositivos inteligentes',
  control_other_devices_home: 'Controle outros dispositivos inteligentes nesta casa (ex., ar condicionado)',
  power_switch: 'Interruptor de energia',
  turn_off_light_offline: 'Se esta opção for desligada, a lâmpada inteligente conectada perderá energia e ficará off-line',
  manage_switch_power: 'Ligue ou desligue o interruptor. Para manter as luzes inteligentes on-line, deixe-o ligado.',
  automation_toggle_btn: 'Trocar',
  save: 'Salvar',
  add_device_type: 'Adicionar tipo de dispositivo',
  common_brand_produced_by: 'Projetado por ${}',
  automation_add_control_device: 'Adicionar dispositivos',
  automation_edit_btn: 'Editar',
  switch_autoCtrl_confirmToSmart_desc: 'Após a mudança, o botão não ligará ou desligará mais o interruptor e poderá ser usado para controlar dispositivos inteligentes nesta casa.',
  switch_autoCtrl_confirmToSmart_title: 'Mudar para o modo sem fio?',
  switch_autoCtrl_confirmToSpeedMode_desc: 'No modo super-rápido, as automações de pressionar duas vezes e pressionar e segurar não funcionarão.',
  switch_autoCtrl_confirmToSpeedMode_title: 'Mudar para o modo super-rápido?',
  switch_autoCtrl_confirmToTraditional_desc: 'Após a mudança, o botão não controlará mais dispositivos inteligentes e as automações relacionadas não funcionarão.',
  switch_autoCtrl_confirmToTraditional_title: 'Mudar para o modo com fio?',
  switch_autoCtrl_ctrlSection: 'Controle',
  switch_autoCtrl_modeSection: 'Modo',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'Quando desativado, os dispositivos conectados perderão a energia e ficarão offline',
  switch_autoCtrl_powerSwitch_title: 'Controle de energia',
  switch_autoCtrl_selectControlDevice_title: 'Selecionar dispositivos',
  switch_autoCtrl_smartMode_desc: 'Use o botão para controlar dispositivos inteligentes, como lâmpadas ou interruptores inteligentes',
  switch_autoCtrl_smartMode_title: 'Modo sem fio',
  switch_autoCtrl_traditionalMode_desc: 'Use este modo quando estiver conectado a dispositivos padrão, como lâmpadas comuns ou exaustores',
  switch_autoCtrl_traditionalMode_title: 'Modo com fio',
  switch_autoCtrl_wirelessHint_title: 'As automações de pressionar uma vez, pressionar duas vezes e pressionar e segurar estarão disponíveis após mudar para o modo sem fio',
  switch_controlType_advancedConfig: 'Configuração avançada',
  switch_controlType_manualScene_desc: 'Executar cenários manuais existentes (ex: "Voltar para a casa")',
  switch_controlType_manualScene_title: 'Controles manuais',
  switch_controlType_otherSmartDevice_desc: 'Controlar outros dispositivos inteligentes nesta casa',
  switch_controlType_otherSmartDevice_title: 'Criar automação',
  switch_controlType_quickConfig: 'Configuração rápida',
  switch_controlType_smartLight_desc: 'Ligar ou desligar luzes inteligentes',
  switch_controlType_smartLight_title: 'Luzes inteligentes',
  switch_controlType_switchDualControl_desc: 'Ligar ou desligar outros interruptores inteligentes',
  switch_controlType_switchDualControl_title: 'Controle de interruptor duplo',
  switch_layoutDetail_editIcon: 'Alterar ícone',
  switch_layoutDetail_name: 'Nome',
  switch_layoutDetail_room: 'Cômodo',
  switch_list_empty_light: 'Não há luzes compatíveis nesta casa',
  switch_list_empty_manualScene: 'Não há controles manuais nesta casa. Adicione-os na página inicial do Xiaomi Home.',
  switch_list_empty_switch: 'Não há interruptores compatíveis nesta casa',
  switch_menu_deleteConfig: 'Excluir configuração',
  switch_multikey_iconCategory_default: 'Padrão',
  switch_multikey_iconCategory_light: 'Luzes',
  switch_multikey_iconCategory_other: 'Outro',
  switch_multikey_iconSelect_title: 'Ícone',
  switch_multikey_roomSelect_createFail: 'Não foi possível criar o cômodo',
  switch_multikey_roomSelect_createNew: 'Criar cômodo',
  switch_multikey_roomSelect_inputPlaceholder: 'Insira o nome do cômodo',
  ...
  switch_autoCtrl_confirmToTraditionalDeleteConfig_desc: 'Após a mudança, o botão não controlará mais dispositivos inteligentes e as configurações de controle relacionadas serão excluídas.',
  switch_autoCtrl_speedModeDescription: 'Compatível com pressionamento único para responder mais rapidamente',
  switch_autoCtrl_standardModeDescription: 'Compatível com pressionamento único, pressionamento duplo e pressionar e segurar',
  switch_autoCtrl_multipleControlsHint: 'Vincule apenas um controle',
};