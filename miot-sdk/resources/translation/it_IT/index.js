export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'I tasti fisici non saranno in grado di controllare i circuiti quando questa funzionalità è attiva. Sarai comunque in grado di usarli per le scene smart.',
  ...
  switch_listItem_title_voiceControlLoop: 'Controlla i circuiti tramite comandi vocali',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Controlla i circuiti tramite Mi AI',
  switch_listItem_value_voiceControlLoopOn: 'Attivo',
  switch_listItem_value_voiceControlLoopOff: 'Disattivato',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Attiva e disattiva i circuiti tramite Mi AI. Se le luci smart sono incluse nel circuito, potrebbero essere spente e disconnesse.',
  ...
  switch_listItem_subtile_speedModeDescription: 'Se è richiesta l\'automazione solo per l\'azione di "pressione", ti consigliamo di selezionare questa opzione. Una volta selezionata, l\'interruttore risponderà rapidamente all\'azione della pressione, migliorando la velocità di risposta dell\'automazione.',
  switch_listItem_subtile_standardModeDescription: 'Se è necessaria l\'automazione per la "doppia pressione" e la "pressione prolungata", seleziona questa opzione.',
  switch_dia_msg_speedModeMessage: 'L\'automazione configurata sul dispositivo corrente include la "doppia pressione" o la "pressione prolungata". La scena smart non risponde quando la modalità Super veloce è attiva. Attivare comunque?',
