export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'Bu özellik açıkken fiziksel düğmeler devreleri kontrol edemez. Akıllı sahneler için hâlâ bunları kullanmaya devam edebileceksiniz.',
  switch_dia_msg_wirelessSwitchSetting: 'Bu tuş başka bir öge (${}) ile ilişkilidir. Kullanmak için kablosuz anahtara geçin.',
  switch_listItem_title_voiceControlLoop: 'Sesli komutlarla kontrol devreleri',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Mi AI ile kontrol devreleri',
  switch_listItem_value_voiceControlLoopOn: 'Açık',
  switch_listItem_value_voiceControlLoopOff: 'Kapalı',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Mi AI\'ı kullanarak devreleri etkinleştirin ve devre dışı bırakın. Devrede akıllı ışıklar varsa bunlar kapatılabilir veya bağlantısı kesilebilir.',
  ...
  switch_listItem_subtile_speedModeDescription: 'Otomasyon yalnızca \'\'basın\'\' eylemi için gerekliyse bu seçeneği seçmeniz önerilir. Anahtar bir kez seçildiğinde basma eylemine hızlı bir şekilde yanıt vererek otomasyonun yanıt verme hızını arttırır.',
  switch_listItem_subtile_standardModeDescription: 'Otomasyon "çift basın" ve "basılı tutun" için gerekliyse bu seçeneği seçin.',
  switch_dia_msg_speedModeMessage: 'Mevcut cihazda yapılandırılan otomasyon \'\'çift basın\'\' veya \'\'basılı tutun\'\'u içerir. Süper hız modu açıkken akıllı sahne yanıt vermeyecek. Yine de açılsın mı?',
