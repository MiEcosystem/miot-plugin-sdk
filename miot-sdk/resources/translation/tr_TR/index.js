export default {
  ...
  updateWarningTip: 'Güncelleme işlemi boyunca cihazı kapatmayın veya kullanmayın',
  basicPerformanceUpdate: 'Temel performans',
  productFunctionUpdate: 'Ürün özellikleri',
  updateFailed: 'Güncelleme yapılamadı',
  partialUpdateFailed: 'Bu güncellemenin bir kısmı tamamlanamadı',
  checkUpdateFailed: 'Güncellemeler kontrol edilemedi',
  updated: 'Güncellendi',
  deviceOfflineCheckNetwork: 'Cihaz çevrim dışı. Ağ ayarlarını kontrol edin.',
  checkNetworkError: 'Bir ağ hatası oluştu. Bir iki dakika bekleyin ve tekrar deneyin.',
  alreadyLatest: 'Mevcut sürüm güncel',
  ...
  cloutStorageSetting: 'Daha fazla cloud depolama ayarı',
  open: 'Açık',
  close: 'Kapalı',
  other: 'Diğer',
  ...
  switch_dia_msg_repeatScene: 'Bu düğmede zaten tek basmalı otomasyon mevcut. Bir cihaz bağlamak, tekrar tekrar tetiklenmesine neden olabilir. Bağlı cihaz kaldırılsın mı?',
  common_loading: 'Yalnızca bir sn.…',
  ...
  select_control_type: 'Kontrol türünü seç',
  non_smart_device_wired: 'Akıllı olmayan cihazları kablolu bir bağlantı üzerinden kontrol et',
  control_smart_lights_group: 'Bu evdeki akıllı ışıkları veya ışık gruplarını kontrol et',
  switch_double_control: 'Çift anahtar kontrolü',
  link_other_switches_intercontrol: 'Diğer akıllı anahtarlarla bağlantı kurarak birbirlerini kontrol etmelerini sağla',
  execute_scene: 'Sahneyi çalıştır',
  execute_manual_scenes_home: 'Mevcut manuel bir sahneyi çalıştır (ör. "Eve dönüş")',
  more_smart_devices: 'Daha fazla akıllı cihaz',
  control_other_devices_home: 'Bu evdeki diğer akıllı cihazları kontrol et (ör. AC)',
  power_switch: 'Güç anahtarı',
  turn_off_light_offline: 'Bunu kapatırsanız bağlı akıllı ışık güç kaybeder ve çevrim dışı olur',
  manage_switch_power: 'Anahtarı açın veya kapatın. Akıllı ışıkların çevrim içi kalması için anahtarı açık bırakın.',
  automation_toggle_btn: 'Değiştir',
  save: 'Kaydet',
  add_device_type: 'Cihaz türü ekle',
  common_brand_produced_by: '${} tarafından tasarlandı',
  automation_add_control_device: 'Cihazlar ekle',
  automation_edit_btn: 'Düzenle',
  switch_autoCtrl_confirmToSmart_desc: 'Geçiş sonrası düğme artık anahtarı açık veya kapalı konuma getirmez ve bu evdeki akıllı cihazları kontrol etmek için kullanılabilir.',
  switch_autoCtrl_confirmToSmart_title: 'Kablosuz moda geçilsin mi?',
  switch_autoCtrl_confirmToSpeedMode_desc: 'Süper hız modunda çift basmalı ve basılı tutmalı otomasyonlar çalışmaz.',
  switch_autoCtrl_confirmToSpeedMode_title: 'Süper hız moduna geçilsin mi?',
  switch_autoCtrl_confirmToTraditional_desc: 'Geçiş sonrası düğme artık akıllı cihazları kontrol etmeyecek ve ilgili otomasyonlar çalışmayacak.',
  switch_autoCtrl_confirmToTraditional_title: 'Kablolu moda geçilsin mi?',
  switch_autoCtrl_ctrlSection: 'Kontrol',
  switch_autoCtrl_modeSection: 'Mod',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'Kapatıldığında bağlı cihazlar güç kaybeder ve çevrim dışı olur',
  switch_autoCtrl_powerSwitch_title: 'Güç kontrolü',
  switch_autoCtrl_selectControlDevice_title: 'Cihaz seçimi',
  switch_autoCtrl_smartMode_desc: 'Akıllı ışıklar veya akıllı anahtarlar gibi akıllı cihazları kontrol etmek için düğmeyi kullanın',
  switch_autoCtrl_smartMode_title: 'Kablosuz mod',
  switch_autoCtrl_traditionalMode_desc: 'Normal ışık veya davlumbaz fanı gibi standart cihazlara bağlıyken bu modu kullanın',
  switch_autoCtrl_traditionalMode_title: 'Kablolu mod',
  switch_autoCtrl_wirelessHint_title: 'Kablosuz moduna geçtikten sonra tek basmalı, çift basmalı ve basılı tutmalı otomasyonları kullanabilirsiniz',
  switch_controlType_advancedConfig: 'Gelişmiş kurulum',
  switch_controlType_manualScene_desc: 'Mevcut manuel sahneleri (ör. "Eve dönüş") çalıştırın',
  switch_controlType_manualScene_title: 'Manuel kontroller',
  switch_controlType_otherSmartDevice_desc: 'Bu evdeki diğer akıllı cihazları kontrol edin',
  switch_controlType_otherSmartDevice_title: 'Otomasyon oluşturma',
  switch_controlType_quickConfig: 'Hızlı kurulum',
  switch_controlType_smartLight_desc: 'Akıllı ışıkları açık veya kapalı konuma getirin',
  switch_controlType_smartLight_title: 'Akıllı ışıklar',
  switch_controlType_switchDualControl_desc: 'Diğer akıllı anahtarları açık veya kapalı konuma getirin',
  switch_controlType_switchDualControl_title: 'İkili anahtar kontrolü',
  switch_layoutDetail_editIcon: 'Simgeyi değiştir',
  switch_layoutDetail_name: 'Ad',
  switch_layoutDetail_room: 'Oda',
  switch_list_empty_light: 'Bu evde desteklenen ışık yok',
  switch_list_empty_manualScene: 'Bu evde manuel kontrol yok. Xiaomi Home başlangıç sayfasından ekleyin.',
  switch_list_empty_switch: 'Bu evde desteklenen anahtar yok',
  switch_menu_deleteConfig: 'Yapılandırmayı sil',
  switch_multikey_iconCategory_default: 'Varsayılan',
  switch_multikey_iconCategory_light: 'Işıklar',
  switch_multikey_iconCategory_other: 'Diğer',
  switch_multikey_iconSelect_title: 'Simge',
  switch_multikey_roomSelect_createFail: 'Oda oluşturulamadı',
  switch_multikey_roomSelect_createNew: 'Oda oluştur',
  switch_multikey_roomSelect_inputPlaceholder: 'Oda adı girin',
