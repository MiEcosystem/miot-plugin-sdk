export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'Los botones físicos no podrán controlar circuitos cuando está función está habilitada. Podrá seguir utilizándolos para escenas inteligentes.',
  ...
  switch_listItem_title_voiceControlLoop: 'Controlar los circuitos mediante comandos de voz',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Controlar los circuitos mediante Mi IA',
  switch_listItem_value_voiceControlLoopOn: 'Activado',
  switch_listItem_value_voiceControlLoopOff: 'Desactivado',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Active y desactive los circuitos mediante Mi IA. Si las luces inteligentes están incluidas en el circuito, puede que se apaguen y se desconecten.',
  ...
  switch_listItem_subtile_speedModeDescription: 'Si solo se requiere automatización para la acción de "pulsar", se recomienda seleccionar esta opción. Una vez seleccionada, el interruptor responderá rápidamente a la acción de pulsar, mejorando la velocidad de respuesta de la automatización.',
  switch_listItem_subtile_standardModeDescription: 'Si se requiere automatización para "pulsar dos veces" y "mantener pulsado", seleccione esta opción.',
  switch_dia_msg_speedModeMessage: 'La automatización configurada en el dispositivo actual incluye "pulsar dos veces" o "mantener pulsado". La escena inteligente no responde cuando el Modo de supervelocidad está activado. ¿Activar de todos modos?',
