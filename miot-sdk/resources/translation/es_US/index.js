export default {
  ...
  updateWarningTip: 'No apague ni utilice el dispositivo durante la actualización',
  basicPerformanceUpdate: 'Rendimiento básico',
  productFunctionUpdate: 'Funciones del producto',
  updateFailed: 'No se pudo actualizar',
  partialUpdateFailed: 'No se pudo completar parte de esta actualización',
  checkUpdateFailed: 'No se pudo buscar actualizaciones',
  updated: 'Actualizado',
  deviceOfflineCheckNetwork: 'El dispositivo no está en línea. Verifique la configuración de red.',
  checkNetworkError: 'Se produjo un error del servidor. Espere uno o dos minutos e intente nuevamente.',
  alreadyLatest: 'Está versión es la más reciente',
  checkingUpdate: 'Verificando actualizaciones…',
  foundNewVersion: 'Hay una actualización disponible',
  version: 'Versión',
  ...
  cloutStorageSetting: 'Más configuraciones de almacenamiento en la nube',
  open: 'Activado',
  close: 'Desactivado',
  other: 'Otro',
  ...
  // 房间
  room: 'Habitación',
  room_nameInputTips: 'Escriba un nombre de habitación',
  ...
  fireSafeCodeTitle: 'Código de seguridad contra incendios para dispositivos',
  ...
  switch_dia_msg_repeatScene: 'Este botón ya tiene una automatización de un solo toque. Conectar un dispositivo puede hacer que se active varias veces. ¿Desea eliminar el dispositivo conectado?',
  common_loading: 'Un momento…',
  ...
  select_control_type: 'Seleccione el tipo de control',
  non_smart_device_wired: 'Controlar dispositivos no inteligentes mediante una conexión por cable',
  control_smart_lights_group: 'Controlar luces inteligentes o grupos de luces en este hogar',
  switch_double_control: 'Control de interruptor doble',
  link_other_switches_intercontrol: 'Conectarse con otros interruptores inteligentes para que se controlen entre sí',
  execute_scene: 'Ejecutar escena',
  execute_manual_scenes_home: 'Ejecutar una escena manual existente (p. ej., "Volver a casa")',
  more_smart_devices: 'Más dispositivos inteligentes',
  control_other_devices_home: 'Controlar otros dispositivos inteligentes en este hogar (p. ej., aire acondicionado)',
  power_switch: 'Interruptor de corriente',
  turn_off_light_offline: 'Si apaga esto, la luz inteligente conectada perderá energía y se desconectará',
  manage_switch_power: 'Encienda o apague el interruptor. Para mantener las luces inteligentes conectadas, déjelo encendido.',
  automation_toggle_btn: 'Cambiar',
  save: 'Guardar',
  add_device_type: 'Añadir tipo de dispositivo',
  common_brand_produced_by: 'Diseñado por ${}',
  automation_add_control_device: 'Añadir dispositivo',
  automation_edit_btn: 'Editar',
  switch_autoCtrl_confirmToSmart_desc: 'Una vez realizado el cambio, el botón ya no servirá para encender ni apagar el interruptor, sino que se podrá usar para controlar los dispositivos inteligentes de este hogar.',
  switch_autoCtrl_confirmToSmart_title: '¿Cambiar al modo inalámbrico?',
  switch_autoCtrl_confirmToSpeedMode_desc: 'En el Modo de supervelocidad, no se ejecutarán las automatizaciones de "presionar dos veces" y "mantener presionado".',
  switch_autoCtrl_confirmToSpeedMode_title: '¿Cambiar al Modo de supervelocidad?',
  switch_autoCtrl_confirmToTraditional_desc: 'Una vez realizado el cambio, el botón ya no controlará los dispositivos inteligentes y las automatizaciones relacionadas no se ejecutarán.',
  switch_autoCtrl_confirmToTraditional_title: '¿Cambiar al modo con cable?',
  switch_autoCtrl_ctrlSection: 'Control',
  switch_autoCtrl_modeSection: 'Modo',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'Al apagarse, los dispositivos conectados se quedarán sin energía y se desconectarán',
  switch_autoCtrl_powerSwitch_title: 'Control de energía',
  switch_autoCtrl_selectControlDevice_title: 'Seleccionar dispositivos',
  switch_autoCtrl_smartMode_desc: 'Use el botón para controlar dispositivos inteligentes, como luces inteligentes o interruptores inteligentes',
  switch_autoCtrl_smartMode_title: 'Modo inalámbrico',
  switch_autoCtrl_traditionalMode_desc: 'Use este modo cuando se conecte a dispositivos estándar, como luces normales o extractores de aire',
  switch_autoCtrl_traditionalMode_title: 'Modo con cable',
  switch_autoCtrl_wirelessHint_title: 'Las automatizaciones de "presionar una vez", "presionar dos veces" y "mantener presionado" están disponibles una vez que cambie al modo inalámbrico',
  switch_controlType_advancedConfig: 'Configuración avanzada',
  switch_controlType_manualScene_desc: 'Ejecutar escenas manuales existentes (p. ej., "Volver a casa")',
  switch_controlType_manualScene_title: 'Controles manuales',
  switch_controlType_otherSmartDevice_desc: 'Controla otros dispositivos inteligentes de este hogar',
  switch_controlType_otherSmartDevice_title: 'Crear automatización',
  switch_controlType_quickConfig: 'Configuración rápida',
  switch_controlType_smartLight_desc: 'Encienda o apague las luces inteligentes',
  switch_controlType_smartLight_title: 'Luces inteligentes',
  switch_controlType_switchDualControl_desc: 'Encienda o apague otros interruptores inteligentes',
  switch_controlType_switchDualControl_title: 'Control de interruptor doble',
  switch_layoutDetail_editIcon: 'Cambiar ícono',
  switch_layoutDetail_name: 'Nombre',
  switch_layoutDetail_room: 'Habitación',
  switch_list_empty_light: 'No hay luces compatibles en este hogar',
  switch_list_empty_manualScene: 'No hay controles manuales en este hogar. Agréguelos desde la página de inicio de Xiaomi Home.',
  switch_list_empty_switch: 'No hay interruptores compatibles en este hogar',
  switch_menu_deleteConfig: 'Eliminar configuración',
  switch_multikey_iconCategory_default: 'Por defecto',
  switch_multikey_iconCategory_light: 'Luces',
  switch_multikey_iconCategory_other: 'Otro',
  switch_multikey_iconSelect_title: 'Ícono',
  switch_multikey_roomSelect_createFail: 'No se pudo crear la habitación',
  switch_multikey_roomSelect_createNew: 'Crear habitación',
  switch_multikey_roomSelect_inputPlaceholder: 'Ingresar nombre de la habitación',
  switch_nav_subtitle_buttonControlLight_v2: 'Presionar una vez enciende o apaga la luz seleccionada',
  switch_nav_subtitle_buttonControlManualScene_v2: 'Presionar una vez ejecuta todos los controles manuales seleccionados',
  switch_nav_subtitle_buttonControlSwitch_v2: 'Presionar una vez enciende o apaga el interruptor seleccionado',
  scene_active_done: 'Activada',
  scene_can_turnOn: 'Disponible',
  scene_active_people: 'Número de usuarios: ${}',
  "scene_upgrade_subtitle": "Realice tareas más sofisticadas conectando varios dispositivos",
  newGB_remoteControl_disabled_tips: 'Remote control is not enabled and cannot be controlled in the app.',
  switch_autoCtrl_confirmToTraditionalDeleteConfig_desc: 'Una vez realizado el cambio, el botón ya no controlará los dispositivos inteligentes y se eliminará la configuración de control relacionada.',
  switch_autoCtrl_speedModeDescription: 'Compatible con toque simple para una respuesta más rápida',
  switch_autoCtrl_standardModeDescription: 'Compatible con toque simple, toque doble y mantener presionado.',
  switch_autoCtrl_multipleControlsHint: 'Vincular solo un control',
};