export default {
  ...
  updateWarningTip: 'Ikke slå av eller bruk enheten mens oppdateringen pågår',
  basicPerformanceUpdate: 'Grunnleggende ytelse',
  productFunctionUpdate: 'Produktfunksjoner',
  updateFailed: 'Kunne ikke oppdatere',
  partialUpdateFailed: 'Kunne ikke fullføre en del av denne oppdateringen',
  checkUpdateFailed: 'Kunne ikke se etter oppdateringer',
  updated: 'Oppdatert',
  deviceOfflineCheckNetwork: 'Enheten er frakoblet. Sjekk nettverksinnstillingene.',
  checkNetworkError: 'Det oppstod en nettverksfeil. Vent et minutt eller to og prøv igjen.',
  alreadyLatest: 'Gjeldende versjon er oppdatert',
  checkingUpdate: 'Ser etter oppdateringer …',
  foundNewVersion: 'En oppdatering er tilgjengelig',
  version: 'Versjon',
  updating: 'Oppdaterer …',
  ...
  cloutStorageSetting: 'Flere innstillinger for nettskylagring',
  open: 'På',
  close: 'Av',
  other: 'Annet',
  ...
  switch_dia_msg_repeatScene: 'Denne knappen har allerede en automatisering met ett trykk. Hvis du kobler til en enhet, kan det føre til at den utløses flere ganger. Fjerne den tilkoblede enheten?',
  common_loading: 'Et øyeblikk …',
  ...
  select_control_type: 'Velg kontrolltype',
  non_smart_device_wired: 'Kontroller ikke-smarte enheter via en kablet tilkobling',
  control_smart_lights_group: 'Styr smartlys eller lysgrupper i dette hjemmet',
  switch_double_control: 'Kontroll med to brytere',
  link_other_switches_intercontrol: 'Koble til andre smarte brytere, slik at de styrer hverandre',
  execute_scene: 'Kjør scene',
  execute_manual_scenes_home: 'Kjør en eksisterende manuell scene (f.eks. "Hjem igjen")',
  more_smart_devices: 'Flere smartenheter',
  control_other_devices_home: 'Kontroller andre smartenheter i dette hjemmet (f.eks. klimaanlegg)',
  power_switch: 'Strømbryter',
  turn_off_light_offline: 'Slår du av denne, vil den tilkoblede smartlampen miste strømmen og kobles fra',
  manage_switch_power: 'Slå bryteren på eller av. La smartlampene være på.',
  automation_toggle_btn: 'Bytte',
  save: 'Lagre',
  add_device_type: 'Legg til enhetstype',
  common_brand_produced_by: 'Utviklet av ${}',
  automation_add_control_device: 'Legg til enheter',
  automation_edit_btn: 'Rediger',
  switch_autoCtrl_confirmToSmart_desc: 'Når du har byttet, vil ikke knappen lenger slå bryteren av eller på, og den kan brukes til å styre smartenheter i dette hjemmet.',
  switch_autoCtrl_confirmToSmart_title: 'Bytte til trådløs modus?',
  switch_autoCtrl_confirmToSpeedMode_desc: 'I superhastighetsmodus kjøres ikke automatiseringene dobbelttrykk og trykk og hold inne.',
  switch_autoCtrl_confirmToSpeedMode_title: 'Bytte til superhastighetsmodus?',
  switch_autoCtrl_confirmToTraditional_desc: 'Når du har byttet, vil ikke knappen lenger kontrollere smartenheter, og tilhørende automatiseringer vil ikke kjøre.',
  switch_autoCtrl_confirmToTraditional_title: 'Bytte til kablet modus?',
  switch_autoCtrl_ctrlSection: 'Kontroll',
  switch_autoCtrl_modeSection: 'Modus',
  switch_autoCtrl_powerSwitch_confirmOff_desc: 'Når den er slått av, vil tilkoblede enheter miste strømmen og bli frakoblet',
  switch_autoCtrl_powerSwitch_title: 'Strømstyring',
  switch_autoCtrl_selectControlDevice_title: 'Velg enheter',
  switch_autoCtrl_smartMode_desc: 'Bruk knappen til å kontrollere smartenheter, for eksempel smart lys eller smarte brytere',
  switch_autoCtrl_smartMode_title: 'Trådløs modus',
  switch_autoCtrl_traditionalMode_desc: 'Bruk denne modusen når du er koblet til standardenheter, f.eks. vanlige lamper eller avtrekksvifter',
  switch_autoCtrl_traditionalMode_title: 'Kablet modus',
  switch_autoCtrl_wirelessHint_title: 'Automatiseringer for enkelttrykk, dobbelttrykk og trykk og hold inne er tilgjengelige når du bytter til trådløs modus',
  switch_controlType_advancedConfig: 'Avansert konfigurering',
  switch_controlType_manualScene_desc: 'Kjør eksisterende manuelle scener (f.eks. "Hjem igjen")',
  switch_controlType_manualScene_title: 'Manuelle kontroller',
  switch_controlType_otherSmartDevice_desc: 'Kontroller andre smartenheter i dette hjemmet',
  switch_controlType_otherSmartDevice_title: 'Opprett automatisering',
  switch_controlType_quickConfig: 'Hurtigkonfigurering',
  switch_controlType_smartLight_desc: 'Slå smarte lys på eller av',
  switch_controlType_smartLight_title: 'Smarte lys',
  switch_controlType_switchDualControl_desc: 'Slå andre smarte brytere på eller av',
  switch_controlType_switchDualControl_title: 'Kontroll med to brytere',
  switch_layoutDetail_editIcon: 'Endre ikon',
  switch_layoutDetail_name: 'Navn',
  switch_layoutDetail_room: 'Rom',
  switch_list_empty_light: 'Ingen støttede lys i dette hjemmet',
  switch_list_empty_manualScene: 'Ingen manuelle kontroller i dette hjemmet. Legg til fra Xiaomi-startsiden.',
  switch_list_empty_switch: 'Ingen støttede brytere i dette hjemmet',
  switch_menu_deleteConfig: 'Slett konfigurasjon',
  switch_multikey_iconCategory_default: 'Standard',
  switch_multikey_iconCategory_light: 'Lys',
  switch_multikey_iconCategory_other: 'Annet',
  switch_multikey_iconSelect_title: 'Ikon',
  switch_multikey_roomSelect_createFail: 'Kunne ikke opprette rom',
  switch_multikey_roomSelect_createNew: 'Opprett rom',
  switch_multikey_roomSelect_inputPlaceholder: 'Angi romnavn',
