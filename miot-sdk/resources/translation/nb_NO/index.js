export default {
  ...
  switch_listItem_subtile_wirelessSwitchSetting: 'Fysiske knapper vil ikke kunne kontrollere kretser når denne funksjonen er aktivert. Du vil fortsatt kunne bruke dem til smartscener.',
  ...
  switch_listItem_title_voiceControlLoop: 'Kontroller kretser med talekommandoer',
  switch_listItem_title_xiaoAiVoiceControlLoop: 'Kontroller kretser med Mi AI',
  switch_listItem_value_voiceControlLoopOn: 'På',
  switch_listItem_value_voiceControlLoopOff: 'Av',
  switch_listItem_subtile_xiaoAiVoiceControlLoopDescription: 'Aktiver og deaktiver kretser ved hjelp av Mi AI. Hvis smarte lys er inkludert i kretsen, kan de slås av og kobles fra.',
  ...
  switch_listItem_subtile_speedModeDescription: 'Hvis automatisering bare er nødvendig for «trykk»-handlingen, anbefales det å velge dette alternativet. Når det er valgt, reagerer bryteren raskt på trykk, noe som forbedrer responshastigheten til automatiseringen.',
  switch_listItem_subtile_standardModeDescription: 'Hvis automatisering kreves for "dobbelttrykk" og "trykk og hold inne", velger du dette alternativer.',
  switch_dia_msg_speedModeMessage: 'Automatiseringen som er konfigurert på den aktuelle enheten inkluderer "dobbelttrykk" eller "trykk og hold inne". Smartscene reagerer ikke når Superhastighetsmodus er aktivert. Aktivere likevel?',
