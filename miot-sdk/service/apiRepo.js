const API_REPO = {
  ...
  '/miot/camera/app/v1/put/reid-switch': {},
  ...
  // 扫地机代理接口（转发到扫地机服务）
  '/vacuum/api/skill/sweep_timeline': {}, // 清扫旅程信息获取
  '/vacuum/api/notification/poll': {}, // 弹泡查询
  '/vacuum/api/notification/ack': {}, // 弹泡确认
  '/vacuum/api/skill/clean_summary': {}, // 清扫总结查询
};
