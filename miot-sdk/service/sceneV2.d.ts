 ...
 * @export
 */
export declare class IMiotSceneV2 {
  /**
   * @since 10077
   ...
   */
  @report
  getManualSceneList(params: object): Promise<object>
  // 定时2.0相关接口
  /**
   * since 10074
   ...
   * @returns {Promise<object>}
   */
  editPeriodTimer: (timer: object) => Promise<object>
  /**
   * since 10074
   ...
   * @returns {Promise<object>}
   */
  editPointTimer: (timer: object) => Promise<object>
  /**
   * since 10074
   * 删除时间段定时
   * 删除时间段定时
   ...
   * @returns {Promise<object>}
   */
  deletePeriodTimer: (sceneId: string) => Promise<object>
  /**
   * since 10074
   * 删除时间点定时
   * 删除时间点定时
   ...
   */
  @report
  deletePointTimer: (sceneId: string) => Promise<object>
  /**
   * since 10074
   * 批量删除定时
   ...
   * @returns {Promise<object>}
   */
  batchDeleteTimers: (sceneIds: string[]) => Promise<object>
  /**
   * since 10074
   * 开关时间段定时
   * 开关时间段定时
   ...
   * @returns {Promise<object>}
   */
  enablePeriodTimer: (sceneId: string, enable: boolean) => Promise<object>
  /**
   * since 10074
   * 开关时间点定时
   * 开关时间点定时
   ...
   * @returns {Promise<object>}
   */
  enablePointTimer: (sceneId: string, enable: boolean) => Promise<object>
  /**
   * since 10074
   * 获取2.0插件定时列表
   ...
   */
  getTimerList: (deviceId?: string) => Promise<object>
  /**
   * @since 10077
   ...
   */
  hasConvertibleScene: (param?: object) => Promise<boolean>
  /**
   * @since 10077
   * 打开1.0场景转2.0场景的页面
   */
  openBatchConvertScenePage(): void
  /**
   * since 10085
   ...
   */
  loadSceneListV2(homeId: string, deviceId: string): Promise<object[]>
  /**
   * since 10085
   ...
   */
  createPointTimerPush: (timer: object) => Promise<object>