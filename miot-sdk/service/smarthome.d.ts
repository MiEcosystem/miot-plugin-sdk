 ...
 * @export
 */
export declare class ISmartHome {
  /**
   ...
   * })
   */
  getUserInfoList(uids: string[]): Promise<object[]>
  /**
   * @typedef GPSInfo
   * @property lng - 经度
   * @property lat - 维度
   ...
   *
   */
  reportGPSInfo(deviceID: string, gpsInfo: GPSInfo): Promise<object>
  /**
   * 设备固件版本信息
   ...
   */
  checkDeviceVersion(did: string, pid: number): Promise<object>
  /**
   * // 获取可用固件更新，传参为dids。 /home/multi_checkversion
   * @param {array<string>} deviceIDs 设备ID
   * @return {Promise<json>}
   */
  getAvailableFirmwareForDids(deviceIDs: string[]): Promise<object>
  /**
   ...
   * @return {Promise}
   */
  getLatestVersion(model: string): Promise<object>
  /**
   ...
   */
  getLatestVersionV2(did: string): Promise<object>
  /**
   ...
   * @returns Promise
   */
  getAutoUpgradeConfig(did: string): Promise<object>
  /**
   * 调用Device.getWifiDevice()的检测固件是否有升级的api, 达到与相关行为一致的目的。
   * @since 10037
   * @param {*} did 设备did
   */
  getFirmwareUpdateInfo(did: string): Promise<object>
  /**
   * 添加一条日志打点。
   ...
   *
   */
  reportLog(model: string, log: string): void
  /**
   * 上报设备数据 /device/event
   ...
   */
  reportRecords(deviceID: string, records: object[]): Promise<object>;
  /**
   ...
   * @return {Promise}
   */
  deviceSetExtraData(params: object): Promise<object>;
  /**
   * 通过前缀分批拉取设备的配置信息
   ...
   * @return {Promise<json>}
   */
  getDevicesConfig(params: object): Promise<object>;
  /**
   ...
   * @return {Promise<json>}
   */
  delDevicesConfig(params: object): Promise<object>;
  /**
   * 获取设备时区
   * @deprecated 10005, 内部取用extra_Data 中设置的数据，建议自行在batchSetDeviceData中实现
   * @param {string} did
   */
  getDeviceTimeZone(did: string): Promise<object>;
  /**
   ...
   */
  getUserStatistics(params: object): Promise<object>;
  /**
   * 获取支持语音的设备 可以控制的设备列表。 /voicectrl/ai_devs
   * @param deviceID  语音设备的 did
   * @return {Promise}
   */
  getVoiceCtrlDevices(deviceID: string): Promise<object>;
  getVoiceVtrlDevices(deviceID: string): Promise<object>;
  /**
   ...
   * }).then()
   */
  getAiServiceProxy(params: object): Promise<object>;
  /**
   ...
   * @return {Promise}
   */
  getDeviceSetting(params: object): Promise<object>;
  /**
   ...
   * @return {Promise}
   */
  getDeviceSettingV2(params: object): Promise<object>;
  /**
   ...
   * @return {Promise}
   */
  setDeviceSetting(params: object): Promise<object>;
  /**
   ...
   * @return {Promise}
   */
  delDeviceSetting(params: object): Promise<object>;
  /**
   ...
   * @return {Promise}
   */
  setDeviceData(params: object): Promise<object>;
  /**
   * 查询用户名下设备上报的属性和事件
   ...
   * @returns {Promise}
   */
  getDeviceDataV2(params: object): Promise<object>;
  /**
   ...
   */
  delDeviceData(params: object): Promise<object>;
  /**
   ...
   * @param {number} params.time_end      结束时间
   */
  getUserDeviceLog(params: object): Promise<object>;
  /**
   * 获取用户收藏
   * /user/get_user_coll
   * @param {object} params 参数
   ...
   * @return {Promise}
   */
  getUserColl(params: object): Promise<object>;
  /**
   * 设置用户收藏
   * /user/get_user_coll
   * @param {object} params 参数
   ...
   * @return {Promise}
   */
  setUserColl(params: object): Promise<object>;
  /**
   * /user/edit_user_coll
   *  编辑用户收藏
   * @since 10002
   ...
   * @return {Promise}
   */
  editUserColl(params: object): Promise<object>;
  /**
   * 删除用户收藏
   * /user/get_user_coll
   * @param {*} params 参数
   ...
   * @return {Promise}
   */
  delUserColl(params: { did: string, coll_id: string }): Promise<object>;
  /**
   * 石头扫地机专用
   ...
   * @return {Promise}
   */
  getMapfileUrl(params: object): Promise<object>;
  /**
   ...
   * @return {Promise}
   */
  getRobomapUrl(params: object): Promise<object>;
  /**
   ...
   * @return {Promise}
   */
  delUsermap(params: object): Promise<object>;
  /**
   ...
   * @return {Promise}
   */
  getHomeDevice(params: object): Promise<object>;
  /**
   ...
   */
  getAppConfig(params: object): Promise<object>;
  /**
   * 用于获取插件所需的一些默认配置信息
   ...
   */
  getAppConfigV2(params: object): Promise<object>;
  /**
   * 获取设备所在网络的IP地址所属国家
   * /home/getcountry
   ...
   * @return {Promise}
   */
  getCountry(params: object): Promise<object>;
  /**
   ...
   * @return {Promise}
   */
  getBleLockBindInfo(params: object): Promise<object>;
  /**
   ...
   *
   */
  batchGetDeviceDatas(params: object): Promise<object>;
  /**
   ...
   *
   */
  batchSetDeviceDatas(params: object): Promise<object>;
  /**
   ...
   */
  setDeviceProp(params: object): Promise<object>;
  /**
   ...
   * @return {Promise}
   */
  getThirdConfig(params: object): Promise<object>;
  /**
   ...
   */
  thirdSyncCall(params: object): Promise<object>;
  /**
   ...
   * @return {Promise}
   */
  callThirdPartyAPI(params: object): Promise<object>;
  /**
   * 华米watch配置使用
   * Android not support yet
   * @return {Promise}
   */
  getMiWatchConfig(): Promise<object>;
  /**
   * 获取authCode来做鉴权
   * @param string} did 设备的 did
   * @returns {Promise}
   */
  getUserDeviceAuth(did: string): Promise<object>;
  /**
   * 获取InterimFileUrl 获取临时文件。
   * @param {json} params  -参数 {obj_name : '{ownerId}/{deviceId}/{index}'}
   * @returns {Promise}
   */
  getInterimFileUrl(params: object): Promise<object>;
  /**
   * 获取文件下载地址
   ...
   * @return {Promise}
   */
  getFileUrl(params: object): Promise<object>;
  /**
   * 日志分页拉取
   * 仅限lumi.xxx.xxx的model设备可以使用
   * 最多可以查询90天前的数据
   ...
   * @return {Promise}
   */
  getUserDeviceDataTab(params: object): Promise<object>;
  /**
   ...
   * @return {Promise}
   */
  rangeGetOpenConfig(params: object): Promise<object>;
  /**
   ...
   */
  bindNFCCard(params: { did: string, uid: string, cid: string }): Promise<object>;
  /**
   ...
   */
  getNFCCard(params: object): Promise<object>;
  /**
   * /yaokan/insertunmodel
   * @since 10004
   * @param {json} params {device:int, id: int, brand: string, model: string}
   */
  insertunmodel(params: object): Promise<object>;
  /**
   ...
   */
  getIDFY(params: object): Promise<object>;
  /**
   * call api /scene/idfy_get
   * @since 10005
   * @param {object} params json params
   ...
   */
  editIDFY(params: object): Promise<object>;
  /**
   ...
   */
  getRangeOpenConfig(params: object): Promise<object>;
  /**
   * @typedef MemberPet
   ...
   */
  createMember(type: MemberType, info: MemberPerson): Promise<object>;
  /**
   * 更新成员信息
   * @since 10005
   ...
   */
  updateMember(type: MemberType, member_id: string, info: MemberPerson): Promise<object>;
  /**
   * 删除成员
   * @since 10005
   * @param {MemberType} type
   ...
   */
  deleteMember(type: MemberType, member_id: string[]): Promise<object>
  /**
   * 加载指定种类的成员列表
   * @since 10005
   * @param {MemberType} type
   */
  loadMembers(type: MemberType): Promise<object>;
  /**
   * 设置用户信息
   ...
   */
  setUserPDData(params: object): Promise<object>;
  /**
   * 获取用户信息
   * call /user/getpdata
   ...
   */
  getUserPDData(params: object): Promise<object>;
  /**
   * App获取设备上报操作记录
   ...
   */
  getDeviceDataRaw(params: object): Promise<object>;
  /**
   ...
   */
  createSeSession(params: object): Promise<object>;
  /**
   * 透传替换ISD key
   ...
   * @param {string} params.reqData.sign // 透传给Mipay的数据
   */
  replaceSEISDkey(params: object): Promise<object>;
  /**
   * 透传锁主密钥重置
   ...
   * @param {string} params.reqData.sign // 透传给Mipay的数据
   */
  resetLockPrimaryKey(params: object): Promise<object>;
  /**
   * 处理芯片返回
   ...
   * }
   */
  handleSEResponse(params: object): Promise<object>;
  /**
   * 上报蓝牙设备信息
   ...
   */
  reportBLEDeviceInfo(params: object): Promise<object>;
  /**
   * since 10036
   ...
   */
  reportEvent(eventName: string, params: object): void;
  /**
   * 获取多键开关名称
   ...
   * 失败时：{"code": XX, "msg": "XXX"}
   */
  getMultiSwitchName(did: string): Promise<object>;
  /**
   *创建组设备，(窗帘组设备)
   * @since 10046
   ...
   */
  createGroupDevice(name: string, member_dids: string[], member_tags?: object): Promise<object>;
  /**
   ...
   * { "code":xxx, "message":"xxx" }
   */
  getVirtualGroupSubDevices(group_did: string): Promise<object[]>;
  /**
   * 获取组设备下与子设备相关的tags
   ...
   * @returns {Promise<array>}
   */
  getVirtualGroupSubDevicesTags(group_did: string): Promise<object[]>;
  /**
   ...
   * @returns {Promise<Object>}
   */
  getVirtualDeviceCombineStatus(param: object): Promise<object>;
  /**
   * 切换用户米家温度单位信息
   * @since 10055
   * 请求参数：
   ...
   * { "code":xxx, "message":"xxx"}
   */
  getTempUnit(params: object): Promise<object[]>;
  /**
   * 获取是否开启自动升级
   * @since 10059
   * @param {string} aDevId
   ...
   * code != 0 data 失败详情
   */
  checkFirmwareAutoUpgradeOpen(aDevId?: string): Promise<object>;
  /**
   * 开启自动升级
   * @since 10059
   * @param {bool} aOpen
   ...
   *  code != 0 data 失败详情
   */
  setFirmwareAutoUpgradeSwitch(aOpen: boolean, aDevId?: string): Promise<object>;
   ...
   */
  requestAuthForAlexaVoiceService(params: object): Promise<object>;
  /**
   * 当前账号下的所有家庭列表
   * @since 10078
   ...
   * })
   */
  getHomeList(params? :object): Promise<object>;
  /**
   * @since 10078
   ...
   * @return {Promise}
   */
  getCarManualSceneData(params: object): Promise<object>;
  /**
   * @since 10078
   ...
   * @return {Promise}
   */
  updateCarManualSceneData(params: object): Promise<object>;
  /**
   ...
   */
  getConsumableDetails(param? :object): Promise<object>;
  /** ABTest
   ...
   */
  activeABTestByPath(param: object)
  /** ABTest
   * 通过实验路径获取实验对象。
   * @param param{Object}
   * param.expPath {string} 实验路径
   ...
   * }
   */
  getABTestConfigByPath(param: object): Promise<object>;
  /**
   ...
   * }
   */
  getDeviceIcon(param: object): Promise<object>;
  /**
   * @since 10085
   * 设置插件页面的ref和subRef
   * @param {Object} params kv键值对，key必须是string类型,需同时设置key为ref、subRef的值
   */
  updatePluginPageRef(params: object): void
  /**
   * since 10085
   * 上报插件ref
   * @param {string} eventName 事件名
   ...
   */
  reportEventRefChannel(eventName: string, params: object): void;
  /**
   * since 10089
   * 获取品牌信息
   ...
   * let params = [23];
   */
  getBrandInfos(params: object): Promise<object>;
  /**
   * 查询云服务接口，插件是否撤销了隐私协议
   */
  queryCloudStatus():Promise<object>;
  privacyCheckPopup(model: string): Promise<object>;
}
declare const SmartHomeInstance = new ISmartHome();
