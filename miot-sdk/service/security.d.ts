 ...
 *
 */
export declare class ISecureKey {
  /**
   * 设备 ID
   * @type {long}
   * @readonly
 ...
 * @export
 */
export declare class ISecurity {
  /**
   * 加载设备的安全锁 /share/bluetoothkeyshare
   * @param {*} deviceID 设备ID
   * @returns {Promise<ISecureKey[]>}
   */
  loadSecureKeys(deviceID: string): Promise<ISecureKey[]>
  /**
   ...
   */
  @report
  shareSecureKey(deviceID: string, shareUid: string, settings? :object = {}): Promise<ISecureKey>
  /**
   ...
   *
   */
  getLockBindInfo(deviceID: string): Promise<object>
}
declare const SecurityInstance: ISecurity;
