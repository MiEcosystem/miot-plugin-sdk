...
export declare class IScene {
   ...
   */
  get setting(): object
  set setting(setting: object)
  /**
   * 授权设备列表，指场景关联的那些设备的deviceID
   * @member
   * @type {Array<String>}
   */
  get authorizedDeviceIDs(): string[]
  set authorizedDeviceIDs(deviceIDs: string[])
  /**
   * 保存场景 /scene/edit
 ...
 * @returns {IScene}
 */
function createScene(deviceID: string, sceneType: SceneType, opt?: object): IScene
/**
 * 加载场景
 * @param {string} deviceID 设备id
 * @param {SceneType} sceneType 场景类型
 ...
 * @returns {Promise<IScene>}
 */
function loadScenes(deviceID: string, sceneType: SceneType, opt?: object): Promise<IScene>
/**
 * @export
 */
export declare class IMiotScene {
  /**
   * 创建场景
   * @param {string} deviceID 设备id
   * @param {SceneType} sceneType 场景类型
   ...
   *
   */
  createScene(deviceID: string, sceneType: SceneType, opt?: object): IScene
  /**
   * 创建定时场景
   ...
   * })
   */
  createTimerScene(deviceID: string, opt: object): IScene
  /**
   * 创建人工场景
   ...
   * @returns {IScene}
   */
  createArtificialScene(deviceID: string, opt: object): IScene
  /**
   * 创建自动场景
   ...
   * @returns {IScene}
   */
  createAutomaticScene(deviceID: string, opt: object): IScene
  /**
   * 获取场景列表 /scene/list
   * @param {*} deviceID 设备id
   ...
   * @returns {Promise<IScene[]>}
   */
  loadScenes(deviceID: string, sceneType: SceneType, opt?: object): Promise<IScene[]>
  /**
   * 加载定时场景 /scene/list
   * @param {*} deviceID 设备id
   ...
   * @returns {Promise<IScene[]>}
   */
  loadTimerScenes(deviceID: string, opt: object): Promise<IScene[]>
  /**
   * 加载人工场景 /scene/list
   * @param {*} deviceID 设备id
   * @param {json} opt {identify,name}
   * @returns {Promise<IScene[]>}
   */
  loadArtificialScenes(deviceID: string, opt: object): Promise<IScene[]>
  /**
   * 加载自动场景 /scene/list
   * @param {*} deviceID 设备id
   * @param {json} opt {identify,name}
   ...
   */
  @report
  loadAutomaticScenes(deviceID: string, opt: object): Promise<IScene[]>
  /**
   * since 10063
   ...
   * @returns {Promise<[]>}
   */
  loadAllScenesV2(homeID: string, deviceID: string): Promise<IScene[]>
  /**
   * 获取指定设备的智能日志信息
   * @since 10010
   ...
   */
  loadScenesHistoryForDevice(did: string, timestamp?: number, limit?: number): Promise<object>
  /**
   * 打开添加智能的页面(米家APP实现)
   ...
   * @since 10045
   */
  openIftttAutoPageWithDid(did: string): void
  /**
   * 打开时间设置页面(米家APP实现)
   ...
   */
  openTimerSettingPageWithOptions(options: object): void
  /**
   * 开启倒计时界面
   ...
   *
   */
  openCountDownPage(isCountDownOn: boolean, setting: object): void
  /**
   * 将时和分转化为cron表达式
   * @since 10034
   * @param {object} params
   ...
   */
  convertDateToCron(params: object): Promise<object>
  /**
   * 将cron表达式转化为时和分
   * @since 10034
   * @param {Object} params
   ...
   * 可参考 com.xiaomi.demo 中的 SceneDemo.js
   */
  convertCronToDate(param: object): Promise<object>
}
declare const MiotSceneInstance: IMiotScene;
/**
 * @export
 */
