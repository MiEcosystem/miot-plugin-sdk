 ...
 *
 */
export declare class ICloudStorage {
  /**
   ...
   */
  getUserConfigs(componentId: number, ...keys: number[]): Promise<object>;
  /**
   ...
   */
  getThirdUserConfigs(model: string, ...keys: number[]): Promise<object>;
  /**
   ...
   */
  setUserConfigs(componentId: string, data: object): Promise<object>;
  /**
   ...
   */
  setThirdUserConfigs(model: string, key: number, data: object): Promise<object>;
  /**
   * 写数据 /user/set_user_config
   ...
   */
  setThirdUserConfigsForOneKey(model: string, key: number, data: object): Promise<object>;
  /**
   ...
   * 失败时：{"code":xxx, "message":"xxx" }
   */
  getThirdUserConfigsForOneKey(model: string, key: string): Promise<object>;
}
declare const CloudStorageInstance: ICloudStorage;
