...
export default class IBluetoothLock {
  /**
     ...
     */
  toggle(cmd: int, timeout: int): Promise<IBluetoothLock>;
  /**
  ...
  /**
     ...
     */
  getOneTimePassword(interval: int, digits: int): Promise<int[]>;
  /**
   * @since 10075
   ...
   */
  initOneTimePasswordContext(param: Object): Promise<Object>;
  /**
     * @since 10075
     ...
     *      reject：{code: xxx, message:xxx} 失败原因
    */
  getOneTimePasswordV2(): Promise<Object>;
  /**
  ...
  /**
     ...
     */
  encryptMessageWithToken(data: string): Promise<json>;
  /**
     * 使用设备的token解密指定数据
     * @since 10004
     ...
     */
  decryptMessageWithToken(data: strng): Promise<json>;
  queryLockSharedRecords(params: any): Promise<any>;
  /**
     * 删除门锁分享记录
     * @since 10080
     * @param {strng} data Hex Data String
     ...
     *      reject：{code: xxx, message: xxx} 1:必须16进制字符串  2:获取device token 失败  3:解密失败
     */
  deleteLockSharedRecords(params: any): Promise<json>;
}