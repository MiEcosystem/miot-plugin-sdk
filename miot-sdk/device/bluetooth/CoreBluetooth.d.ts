...
export class IBluetoothCharacteristic {
  /**
       ...
       *
       */
  readonly get isDiscovered(): boolean;
  /**
       ...
       *
       */
  readonly get isValueLoaded(): boolean;
  /**
       * 特征值的 UUID
       * @member
       * @type {string}
  ...
  /**
     ...
     */
  write(value: hexstring): Promise<IBluetoothCharacteristic>;
  /**
     * 直接写数据
     ...
     */
  writeWithoutResponse(value: hexstring): Promise<IBluetoothCharacteristic>;
  /**
     ...
     *      reject：{code: xxx, message: xxx}  100:设备正在连接中  102:服务或者特征值未发现
     */
  setNotify(flag: boolean): Promise<IBluetoothCharacteristic>;
}
/**
 * BLE蓝牙服务类
 * @interface
...
export class IBluetoothService {
  ...
  /**
     ...
     *
     */
  startDiscoverCharacteristics(...characteristicUUIDs: string[]): boolean;
  /**
     ...
     *
     */
  getCharacteristic(characteristicUUID: string): IBluetoothCharacteristic;
}