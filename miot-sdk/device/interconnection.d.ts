 ...
 */
export function getSupportedDevices(category: string, sameRoom: string): Promise<any[]>;
/**
 * 扫描并监听扫描结果
 * @since 10039
 ...
 */
export function scan({ list, timeout, category, sameRoom }: {
    list: any[];
    timeout: number;
    category: string;
    sameRoom: bool;
}, fn: Function, onfail: Function): object;
/**
 * 获取关联信息
 * @since 10039
 ...
 */
export function getLinkage(mac: string): Promise<any[]>;
/**
 * 获取支持的设备列表及对应关联信息
 * @since 10039
 * @param {string} category 关联能力标识，在appConfig 文件中配置，比如sensor_ht，默认为全部
 ...
 */
export function getSupportedDevicesWithLinkage(category: string, sameRoom: bool): Promise<any[]>;
/**
 * 增加关联
 * @since 10039
 ...
 * @return {Promise<void>}
 */
export function addLinkage(mac: string, intvl?: string): Promise<void>;
/**
 * 删除关联
 * @since 10039
 ...
 * @return {Promise<void>}
 */
export function removeLinkage(mac: string): Promise<void>;
/**
 * 关联开关
 * @since 10039
 ...
 * @return {Promise<void>}
 */
export function setEnable(mac: string, enabled: bool): Promise<void>;
/**
 * 退出插件时清空类变量
 * @since 10061
 */
...
declare namespace _default {
    export { getSupportedDevices };
    export { scan };
    export { getLinkage };
    export { getSupportedDevicesWithLinkage };
    export { addLinkage };
    export { removeLinkage };
    export { setEnable };
}
