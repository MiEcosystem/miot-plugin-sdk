...
export default {
  ...
  get phoneDid() {
    if (isIOS) return "";
    return native.MIOTHost.systemInfo.phoneDid || "";
  },
  ...
  */
  ...
  /**
   * 查询"小米查找"App 是否支持充电宝查找（仅 Android）
   * @since 10116
...
export const HostEvent = {
   ...
   * @event
   * @example 
   * HostEvent.h5RetentionPopUpWindowConfirmEvent.addListener(() => {
   *      console.log(`HostEvent -> 关闭页面`);
   * });
   */
  h5RetentionPopUpWindowConfirmEvent: {
  }
};
