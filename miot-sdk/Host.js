...
export default {
  ...
  /**
   * @deprecated  此接口sdk 10090版本废弃，从10090(包括10090)开始请使用Package.entryInfo.mobileType进行判断，没有值则默认为phone
   * @const
   * @type {String}
  ...
  get mobileType() {
     return  "..."
      console.warn("mobileType deprecated 此接口sdk 10090版本废弃，从10090(包括10090)开始请使用Package.entryInfo.mobileType进行判断，没有值则默认为phone");
    }
    if (isIOS) {
      return 'phone';
    }
