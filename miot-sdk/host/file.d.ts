export namespace FileEvent {
    namespace fileDownloadProgress {
        function forever(emitter: any): ({ filename, url, totalBytesRead, totalBytesExpectedToRead }: {
            filename: any;
            url: any;
            totalBytesRead: any;
            totalBytesExpectedToRead: any;
        }) => void;
        const sameas: string;
    }
    namespace fileUploadProgress {
        export function forever_1(emitter: any): ({ uploadUrl, uploadBytes, totalBytes }: {
            uploadUrl: any;
            uploadBytes: any;
            totalBytes: any;
        }) => void;
...
declare const FileInstance: IFile;
/**
 * 文件管理
 * @interface
 *
...
declare class IFile {
  /**
     ...
     * })
     */
  readFileList(subFolder?: string): Promise<any>;
  /**
     * 判断文件是否存在
  ...
  /**
     ...
     * })
     */
  readFileToHexString(fileName: string): Promise<any>;
  /**
     * 读文件，并转换为 Base64 编码
     * @param {string} fileName - 文件名, 可以是多重文件夹嵌套文件， e.g 'path/path2/filename.txt'
     * @returns {Promise}
     ...
     * 失败时：{"code":xxx, "message":"xxx" }
     */
  readFileToBase64(fileName: string): Promise<any>;
  /**
     ...
     * 失败时：{"code":xxx, "message":"xxx" }
     */
  readFileSegmentToBase64(fileName: string, off: number, len: number): Promise<any>;
  /**
     ...
     *
     */
  writeFile(fileName: string, utf8Content: string): Promise<any>;
  /**
     * @since 10051
     ...
     *  });
     */
  saveFileToNotesAppOnMIUI(fileName: string): Promise<any>;
  /**
     ...
     * ...
     */
  writeFileThroughBase64(fileName: string, fileContent: string): Promise<any>;
  /**
     ...
     * ...
     */
  appendFile(fileName: string, utf8Content: string): Promise<any>;
  /**
     ...
     *
     */
  appendFileThroughBase64(fileName: string, fileContent: string): Promise<any>;
  /**
     * 删除文件
     * @param {string} fileName - 文件名, 可以是多重文件夹嵌套文件， e.g 'path/path2/filename.txt'
     * @returns {Promise}
  ...
  /**
     ...
     */
  generateObjNameAndUrlForFDSUpload(did: string, suffix: string): Promise<any>;
  /**
     ...
     * */
  generateObjNameAndUrlForFDSUploadV3(did: string, suffix: string): Promise<any>;
  /**
     * 上传日志文件。
     ...
     */
  generateObjNameAndUrlForLogFileFDSUpload(did: string, suffix: string): Promise<any>;
  /**
     ...
     */
  getFDSFileInfoWithObjName(obj_name: string): Promise<any>;
  /**
     ...
     */
  getFDSFileInfoWithObjNameV3(obj_name: string): Promise<any>;
  /**
  ...
  /**
     ...
     * ...
     */
  uploadFile(params: UploadParams): Promise<any>;
  /**
     * 上传文件到小米云FDS
     * @param {UploadParams} params - 参数字典
     * @returns {Promise}
     ...
     */
  uploadFileToFDS(params: UploadParams): Promise<any>;
  /**
  ...
  /**
     ...
     * ...
     */
  downloadFile(url: string, fileName: string, params?: DownloadParams): Promise<any>;
  /**
     * @since 10083
     * 注册字体
     * Android:
     ...
     * Android没有返回值
     */
  registerFontEnable(param: any): Promise<any>;
  /**
     * @since 10083
     ...
     */
  downloadFontFile(param: any): Promise<any>;
  /**
     * @since 10083
     * 读取已下载了的字体列表
     * @param param 预留参数
     ...
     * }
     */
  readFontFileList(param?: any): Promise<any>;
  /**
     * @since 10083
     * 删除下载了的字体文件
     * @param param
     ...
     * }
     */
  deleteFontFile(param: any): Promise<any>;
  /**
     * 取消指定的下载任务
     ...
     */
  cancelDownloadFile(taskID: string): Promise<any>;
  /**
     * 获取 base64 编码的数据长度
     ...
     * ...
     */
  dataLengthOfBase64Data(base64Data: string): Promise<any>;
  /**
     ...
     * @returns {Promise}
     */
  subBase64DataOfBase64Data(base64Data: string, loc: number, len: number): Promise<any>;
  /**
     ...
     * 失败时：{"code":xxx, "message":"xxx" }
     */
  unzipFile(fileName: string, desitinationPath?: string): Promise<any>;
  /**
     ...
     * })
     */
  ungzipFileToString(params: json): Promise<json>;
  /**
     ...
     * 失败时：{"code":xxx, "message":"xxx" }
     */
  ungzFile(fileName: string): Promise<any>;
  /**
     * 为云米扫地机的地图文件解压提供，私有
     * @param {string} fileName - 文件名（插件存储空间内的文件）
     * @return {Promise}
     */
  ungzYunMiFile(fileName: string): Promise<any>;
  /**
    * 保存指定照片文件到系统相册
    * @param {string} fileName 可以是多重文件夹嵌套文件， e.g 'path/path2/filename.txt'
    * @returns {Promise}
    ...
    * ...
    */
  saveImageToPhotosAlbum(fileName: string): Promise<any>;
  /**
     * 保存指定文件到系统相册
     * @since 10037
     * @param {string} fileName 可以是多重文件夹嵌套文件， e.g 'path/path2/filename.txt'
     ...
     * @example 参考com.xiaomi.demo Host-->PhotoDemo.js
    */
  saveFileToPhotosAlbum(fileName: string): Promise<any>;
  /**
     * 生成水印图片
     * @since 10110
     * @param {string} dirName 图片所在相册路径
     * @param {string} saveFilePath 存储位置filePath filePath必须是带 Host.file.storageBasePath前缀的path，native端会校验这个路径合法性。
     * @param {json} watermarkParams 水印参数信息
     * {
     *  "deviceID": "1170922735", //设备id
     *  "deviceName": "小米摄像机4", //设备名称
     ...
     * @returns {Promise}
     */
  generateImageWithWatermarkParams(dirName: string, saveFilePath: string, watermarkParams: json): Promise<any>;
  /**
     * 保存指定图片文件到以did命名的相册中
     ...
     * @param {json} watermarkParams 水印信息，默认为null， since 10110
     * {
     *  "deviceID": "1170922735", //设备id
     *  "deviceName": "小米摄像机4", //设备名称
     *  "hasWatermark": false, //图片是否有水印
     ...
     * @example 参考com.xiaomi.demo Host-->PhotoDemo.js
     */
  saveImageToPhotosDidAlbum(fileName: string, customDirName?: string, deviceID?: string, watermarkParams?: json): Promise<any>;
  /**
     ...
     * @example 参考com.xiaomi.demo Host-->PhotoDemo.js
     */
  saveImageToPhotosDidAlbumV2(fileName: string, customDirName?: string, deviceID?: string): Promise<any>;
  /**
     * 保存指定照片文件到以did命名的相册中
     ...
     * @example 参考com.xiaomi.demo Host-->PhotoDemo.js
     */
  saveVideoToPhotosDidAlbum(fileName: string, customDirName?: string, deviceID?: string): Promise<any>;
  /**
     ...
     * @example 参考com.xiaomi.demo Host-->PhotoDemo.js
     */
  saveVideoToPhotosDidAlbumV2(fileName: string, customDirName?: string, deviceID?: string): Promise<any>;
  /**
   * 拼接视频文件
   * @since 10095
   ...
   */
  mergeVideos(firstVideoPath: string, secondVideoPath: string, deviceID?: string): Promise<any>;
  /**
     * 拼接视频文件，iOS only
     * @since 10108
     * @param {string} firstVideoPath
     ...
     */
  mergeVideosUseHarewareAccelerate(firstPath: any, secondPath: any, deviceID?: string): Promise<any>;
  /**
     * 拼接视频文件：iOS only
     * @since 10108 【原生待验证】
     ...
     * 水平合并：合并视频高度取决于较高的视频，较短的原视频等比拉伸
    */
  mergeVideosWithFFmpeg(firstPath: any, secondPath: any, deviceID?: string): Promise<any>;
  /**
   * 拼接图片文件
   * @since 10095
   ...
   * @example 参考com.xiaomi.demo Host-->PhotoDemo.js
   */
  mergeImages(firstImagePath: string, secondImagePath: string, deviceID?: string): Promise<any>;
  /**
     ...
     * @example 参考com.xiaomi.demo Host-->PhotoDemo.js
     */
  mergeVideosV2(firstVideoPath: string, secondVideoPath: string, params: object, deviceID: string, callbackEvent: string): Promise<any>;
  /**
     ...
     * @example 参考com.xiaomi.demo Host-->PhotoDemo.js
     */
  mergeImagesV2(firstImagePath: string, secondImagePath: string, params?: object, deviceID?: string): Promise<any>;
  /**
     ...
     * @example 参考com.xiaomi.demo Host-->PhotoDemo.js
     */
  fetchLocalVideoFilePathFromDidAlbumByUrl(url: string, customDirName?: string, deviceID?: string): Promise<any>;
  /**
     * 通过图片相册URL获取图片是否有水印
     * 如果不存在该相册，返回空数组
     * @since 10110
     ...
     * @example
     */
  getWatermarkInfoFromAssetWithUrl(url: string): Promise<any>;
  /**
     ...
     * @example 参考com.xiaomi.demo Host-->PhotoDemo.js
     */
  getAllSourceFromPhotosDidAlbum(customDirName?: string, deviceID?: string): Promise<any>;
  /**
  ...
  checkWritePermission(): any;
  /**
     * 获取指定相册中所有的图片和视频
     * @since 10050
     * @param {string} albumID 相册唯一 ID
     * @returns {Promise}
     * 成功时：与 getAllSourceFromPhotosDidAlbum 成功时一致
     * 失败时：
     *  {"code":-401, "message":"access to photo library denied" }
     ...
     * @example 参考com.xiaomi.demo Host-->PhotoDemo.js
     */
  getAssets(albumID: string): Promise<any>;
  /**
     ...
     * @example 参考com.xiaomi.demo Host-->PhotoDemo.js
     */
  deleteAssetsFromAlbumByUrls(urls: any[]): Promise<any>;
  /**
     * 屏幕全屏截图
     ...
     *
     */
  screenShot(imageName: string): Promise<string>;
  /**
     * 自定义范围的屏幕截图
     * @param {string} imageName - 图片名称，png
     ...
     *
     */
  screenShotInRect(imageName: string, rect: {
        l: int;
        t: int;
        w: int;
        h: int;
     ...
     *  });
     */
  longScreenShot(viewRef: number, imageName: string): Promise<string>;
  /**
     * 高德地图截屏
     ...
     * });
     */
  amapScreenShot(viewRef: number, imageName: string): Promise<any>;
  /**
     ...
     * @returns {Promise}
     */
  getRGBAValueFromImageAtPath(imagePath: string, points: Array<{
        x: int;
        y: int;
    }>): Promise<any>;
    /**
  ...
  /**
     ...
     */
  mkdir(params: json): Promise<json>;
  /**
     * 搜索文件（只在Android可使用）
     * @since 10052
     * @param {json} params {
     ...
     */
  queryFile(params: json): Promise<json>;
  /**
      ...
      *        }
      */
  writePdfFile(utf8Content: string, filename: string, params: json): Promise<any>;
  /**
     * 将PDF指定页转换为图片
     * @since 10052
     * @param {json} params {
     ...
     */
  pdfToImage(params: json): Promise<json>;
  /**
      * 读PDF文件信息
      * @since 10052
      * @param {json} params {
      ...
      */
  readPdfMetaData(params: json): Promise<json>;
  /**
     * 复制文件
     * since 10048
     * @param {json} params {
     ...
     */
  copyFile(params: json): Promise<json>;
  /**
     * 获取当前磁盘的可用空间和总存储空间
     * since 10048
  ...
  /**
       ...
       * });
       */
  readFolderSize(folderName: any): Promise<json>;
  /**
     * 裁剪图片
     * since 10054
     ...
     */
  cropImage(targetFileName: string, sourceFilename: string, params: {
        offset: any;
        size: any;
        displaySize: any;
    }): Promise<string>;
     ...
     * 失败时：{"code":xxx, "message":"xxx" }
     */
  readFileInfo(fileName: string, type: string): Promise<any>;
  /**
     * 生成二维码并保存到插件路径
     * @since 10103
     * @param {object} params
