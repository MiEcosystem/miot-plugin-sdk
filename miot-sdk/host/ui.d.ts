...
declare class IUi {
  /**
     ...
     */
  canOpenStorePage(): Promise<boolean>;
  /**
     * 检测Android是否支持集成了商城,目前是通过当前的服务来判断的
     * @returns {boolean}
     * @deprecated  方法存在问题，废弃
     */
  checkStoreSupporttedOnAndroid(): boolean;
  /**
     * 弹出删除设备的对话框
     * @param {string} [title=null] - 自定义提示，不设置使用默认提示
     */
  openDeleteDevice(title?: string): void;
  /**
     * android 设备暂不支持该方法 会直接reject(false)
     * 删除设备
     * 注意：此方法只做删除设备的活，不会返回上一页。所以在then里面，需要自己调用closeCurrentPage
     */
  openDeleteDeviceWithCallback(): Promise<any>;
  /**
     * 打开分享设备的页面
     */
  openShareDevicePage(): void;
  /**
     * 是否保持屏幕常亮
     * @param {Boolean} flag 默认false
     */
  keepScreenNotLock(flag?: boolean): void;
  /**
     * 打开房间设备管理的页面
     */
  openRoomManagementPage(): void;
  openRoomManagementPageByDid(did: any): void;
  /**
     * 打开语音设备管理的页面
     */
  openVoiceCtrlDeviceAuthPage(): void;
  /**
     * 打开添加智能的页面,注意分享的用户无法打开
     * @deprecated  sdk 10032版本开始废弃，请使用 Service.scene.openIftttAutoPage()
     */
  openIftttAutoPage(): void;
  /**
     * 打开反馈页
     */
  openFeedbackInput(): void;
  /**
     * 打开安全管理页
     */
  openSecuritySetting(): void;
  /**
     * 打开常见问题页，别名「使用帮助」
     */
  openHelpPage(): void;
  /**
     ...
     */
  openShareListBar(title: string, description: string, imagePath: string, url: string): void;
  /**
     * 打开系统分享文件页面
     * @param {string} pathOrUrl 分享文件的全路径或者链接url。
     */
  openSystemShareWindow(pathOrUrl: string): void;
  /**
    * 打开系统文件打开页面 since 10050
    * @param {string} pathOrUrl 文件的全路径或者链接url。
    */
  openSystemFileWindow(pathOrUrl: string): void;
  /**
     * @since 10068
     * 打开耗材详情页面
     * @description 该接口已经废弃，外部调用建议使用{@see openConsumesDetailPage }代替
     * @param {object} params 耗材传递的参数
     *   params
     *    key1: items 可以参考文档 https://xiaomi.f.mioffice.cn/docs/dock4bLM2Tjps0kZFU9xyd6fKnd#
     */
  openConsumesPageWithParams(params: object): Promise<any>;
  /**
     * @since 10078
     * 打开耗材详情页面(自研插件)
     * @param {object} params 耗材传递的参数
     ...
     *   具体用法可参考xiaomi.demo
     */
  openConsumesDetailPage(params: object): Promise<any>;
  /**
     ...
     */
  getDevicesWithModel(model: any, includeGroupedDevice?: boolean): Promise<devices[]>;
  /**
     * 打开蓝牙网关页
     */
  openBtGatewayPage(): void;
  /**
     * 使用参数 params 打开蓝牙网关页
     ...
     */
  openBtGatewayPageWithParams(params: any): Promise<any>;
  /**
  ...
  alertLegalInformationAuthorization(option: {
        privacyURL: string;
        agreementURL?: string;
        experiencePlanURL?: string;
        hideAgreement?: boolean;
        hideUserExperiencePlan?: boolean;
        privacyURLForChildren?: string;
        privacyURLForWatch?: string;
        privacyChanges?: string;
    }): Promise<boolean>;
  _alertDeclarationWithConfigOption(option: any, reportVersion?: string): Promise<any>;
  /**
  ...
  previewLegalInformationAuthorizationV2(option: any): Promise<any>;
  _openDeclarationWithConfigOption(option: any): Promise<any>;
  /**
     * 查看软件政策和隐私协议
     ...
     */
  privacyAndProtocolReview(licenseTitle: string, licenseUrl: string, policyTitle: string, policyUrl: string): void;
  /**
     * 软件政策和隐私协议授权
     * 隐私协议弹框需求：
     ...
     */
  openPrivacyLicense(licenseTitle: string, licenseUrl: string, policyTitle: string, policyUrl: string): Promise<boolean>;
  /**
     * 打开重命名对话框
     */
  openChangeDeviceName(): void;
  /**
     * 添加桌面快捷方式
     */
  openAddToDesktopPage(): void;
  /**
     ...
     */
  openDeviceUpgradePage(type?: number, params?: {}): void;
  /**
     ...
     * @return null
    */
  openDoubleGraftingAuth(): void;
  /**
     * 固件升级页面，蓝牙连接 10107新增
    */
  bluetoothConnection(type: any, params: any): Promise<any>;
  /**
     * native toast
     * since 10109
     */
  ...
  /**
     *
     */
  openDeviceInfoPage(params: any): void;
  /**
     * since 10091
     * 多键设备，控制设备入口
  ...
  openSwitchButtonSettingPage(params: {
     ...
     * 打开设备检查固件历史版本信息页面
     */
  openDeviceUpgradeHistoryPage(): void;
  /**
     ...
     */
  openBleMeshDeviceUpgradePage(): void;
  /**
  ...
  openBleCommonDeviceUpgradePage(params: {
     ...
     * @since 10031
     */
  openLightGroupUpgradePage(): void;
  /**
     * 打开Ble 组设备升级页面
     * @param {Number} type 蓝牙类型，与蓝牙connect 参数中的type 一致
     * @since 10049
     */
  openBleGroupUpgradePage(type: number): void;
  /**
     * 打开设备时区设置页
     ...
     * @since 10025
     */
  openDeviceTimeZoneSettingPage(params?: any): void;
  /**
     * 打开H5页面
     * 不对外提供
     * @param {string} url - 链接地址
     * @param {object} params - 可选参数
     * @param {boolean} params.onCurrentPageIfAvailable 为 true 时, 如果已经有一个WebView, 则尝试在当前 WebView 加载 since 10053
     * @param {boolean} params.legacy 为 true 时，打开支持重定向webview，webview右上角为关闭图标, since 10067
     */
  openWebPage(url: string, params?: {
        onCurrentPageIfAvailable: boolean;
        legacy: boolean;
    }): void;
    /**
     * 跳转微信小程序
     ...
     */
  openWeChatMinProgram(appOriginalId: string, path: string, needDialogRemind?: boolean): void;
  /**
     * 打开设备服务页面，不对外提供
     * param{Object}
     * param.did 设备did
     * @since 10075
     */
  openDeviceServicePage(param: any): void;
  /**
     * 打开商城某商品详情页面
     * @param {string} gid - 商品ID
     */
  openShopPage(gid: string): any;
  /**
     * 打开商城搜索结果页面
     * @param {string} keyword - 搜索关键字
     * @since 10024
     */
  openShopSearchPage(keyword: string): void;
  /**
     * 打开产品百科H5页面
     * @since 10035
     * @param {string} url - 链接地址
     ...
     */
  openProductBaikeWebPage(url: string): void;
  /**
     ...
     */
  openMeshDeviceGroupPage(type: string, did: string, version?: int): void;
  /**
  ...
  /**
     ...
     *
     */
  openCountDownPage(isCountDownOn: boolean, setting: {
        onMethod: string;
        onParam: string;
        offMethod: string;
        offParam: string;
     ...
     */
  openOneTimePassword(did: string, interval: int, digits: int): void;
  /**
     ...
     */
  openTimerSettingPage(onMethod: string, onParam: string, offMethod: string, offParam: string): void;
  /**
     * @deprecated since 10004 use openTimerSettingPageWithVariousTypeParams instead
     ...
     * @description 这个api 应该可以废弃了，使用 Service.scene.openTimerSettingPageWithOptions()
     */
  openTimerSettingPageWithCustomIdentifier(customTimerIdentifier: string, onMethod: string, onParam: string, offMethod: string, offParam: string): void;
  /**
     ...
     */
  openTimerSettingPageWithVariousTypeParams(onMethod: string, onParam: json, offMethod: string, offParam: json): void;
  /**
  ...
  openTimerSettingPageWithOptions(options: {
    ...
    */
  openPowerMultikeyPage(did: string, mac?: string): void;
  openPowerMultikeyPageV2(did: any, mac: any, params: any): void;
  /**
    * 添加或者复制一个红外遥控器
    * @since 10003
    * @param {string} did 设备did
    ...
    */
  addOrCopyIR(did: string, type?: number, models?: any[], extra?: {
        create_device?: boolean;
        dismiss_current_plug?: boolean;
        open_room_select?: boolean;
    }): void;
    /**
     * 打开用户账号下某一设备的插件
     ...
     */
  openDevice(did: string, model: string, params: {
        dismiss_current_plug?: boolean;
    }): Promise<json>;
    /**
     ...
     */
  openPluginPage(did: string, pageName?: string, pageParams?: {
        isBackToMainPage?: boolean;
    }): Promise<any>;
    /**
     ...
     */
  openPageWithClassName(className: string): void;
  /**
     ...
     */
  openNewMorePage(): void;
  /**
     * @since 10002
     * android特有页面，ios 不能使用
     * 打开手机蓝牙设置页面
    */
  openPhoneBluSettingPage(): void;
  /**
     * 打开小爱训练计划
    ...
    */
  openXiaoAiLearnPage(clientId: string, did: string, aiMiotClientId: string, aiClientId: string, aiVersion: string, otherParams: {
        newVerAiTrain: boolean;
    }): void;
    /**
     * 显示提示用户打开蓝牙的动画示意图, 仅在iOS下有效，Android下无反应
     * @since 10004
     */
  showBLESwitchGuide(): void;
  /**
     * 隐藏提示用户打开蓝牙的动画示意图, 仅在iOS下有效，Android下无反应
     * @since 10004
     */
  dismissBLESwitchGuide(): void;
  /**
     * 打开设备快连成功页面
     * @since 10004
     ...
     * @param {string} did 设备did
     */
  openConnectSucceedPage(model: string, did: string): void;
  /**
     * 打开窗帘组选房间设置名称的页面
     * @since 10049
     ...
     */
  openCurtainGroupNamePage(groupDid: string, leftDid: string, rightDid: string): void;
  /**
     * 打开Zigbee 网关插件开启子设备快连
     * @since 10020
     * @param {string} did 网关设备did
     */
  openZigbeeConnectDeviceList(did: string): void;
  /**
     * 打开设备网络信息页面，米家已提供入口：设置 - 更多设置 - 网络信息。此方法只针对wifi设备，combo设备，蓝牙设备请不要调用此方法。
     * @since 10026
     */
  openDeviceNetworkInfoPage(): void;
  /**
     * android 特有， 跳转到小米钱包
     * @param params
     ...
     */
  openMiPayPageForAndroid(params: any): Promise<object>;
  /**
     ...
     */
  openPluginRecommendScene(did: string, recommendId: number): void;
  /**
     * 刷新设备列表，同时刷新设备列表页UI
     * @since 10025
     * @return {Promise}
     */
  refreshDeviceList(): Promise<any>;
  /**
     ...
     */
  openTerminalDeviceSettingPage(type: number): void;
  /**
     *  打开Android系统位置信息设置页(不同于权限配置页) only Android
     *  @since 10038
     */
  openAndroidLocationServerSettingPage(): void;
  /**
     *  打开设备重置页面
     *  @since 10041
     */
  openResetAndConnectDevicePage(): void;
  /**
     *  打开配网页面，（仅限猫眼门锁使用）
     *  @since 10068
     */
  openWifiConfigStepPage(): void;
  /**
     *  打开语音授权页面
     *  @since 10041
     */
  openVoiceCtrlDevListPage(): void;
  /**
     *  打开立体声设置页面
     *  @since 10041
     */
  openStereoSettingPage(): void;
  /**
     * 跳转到米家播放音乐页面
     */
  openXiaoaiContentPage(): void;
  /**
     * @since 10068
     * 跳转到小爱音箱指定的页面
     ...
     */
  openXiaoaiPage(params: jsonObject): Promise<any>;
  /**
     * 跳转到选择闹钟音乐页面，入参是为了告诉native当前选中的是哪个铃声，以高亮当前选中
     * @param {string} ringtone_tab 铃声tab
     * @param {string} ringtone_id 铃声的id
     * @param {string} ringtone_name 铃声的name
     * @param {string} ringtone_query 铃声的query
     ...
     */
  openClockMusicSelector(params: any): Promise<any>;
  /**
     * 跳转到地震播报选择地理位置页面，入参是为了告诉native当前选中的是哪个位置
     * @param {string} name 所选位置的名称
     * @param {string} district 所选位置的区
     * @param {string} city 所选位置的城市
     * @param {number} latitude 所选位置的纬度
     * @param {number} longitude 所选位置的经度
     * 返回值:{code:0,data:{name: '武汉市汉阳医院', district: '汉阳区', city:'武汉市', latitude: 30.554658, longitude: 114.252377}} 错误时：{code:-1,message:'xxxxxx'}
     */
  openEarthquakeLocationSelector({ name, district, city, latitude, longitude }: string): Promise<any>;
  /**
     ...
     * @param {number} latitude 所选位置的纬度
     * @param {number} longitude 所选位置的经度
     * @param {string} title 地理位置选择页的标题(默认显示地震播报)
     * 返回值:{code:0,data:{name: '武汉市汉阳医院', district: '汉阳区', city:'武汉市', latitude: 30.554658, longitude: 114.252377}} 错误时：{code:-1,message:'xxxxxx'}
     */
  openLocationSelector({ name, district, city, latitude, longitude, title }: string): Promise<any>;
  /**
     ...
     */
  openIOSDocumentFileChoosePage(): Promise<any>;
  /**
     ...
     * })
     */
  openFileSelectPage(mimeType: string): json;
  getIsSupportModel(): boolean;
  /**
  ...
  /**
     ...
     */
  openNFCWriteDeviceInfoPage(extra?: string): void;
  /**
     * @since 10056
     * 打开NFC写设备数据的调试页面。
     ...
     */
  openNFCWriteDeviceInfoDebugPage(params: jsonobject): void;
  /**
     * @since 10052
     * 打开常用设备/常用摄像机设置页面
     * 自SDK10077（含10077）开始，接口变更为打开放大卡片设置页面
     * ***注意***：该接口为SDK内部使用，不建议插件调用
     * @param {string} type 在SDK10077以下(不含10077)，0表示常用设备，1表示常用摄像机；SDK10077（含10077）开始，0不再使用，1表示放大卡片。
     * @example
     * Host.ui.openCommonDeviceSettingPage(1);
    */
  openCommonDeviceSettingPage(type: string): void;
  /**
     * @since 10052
     * 是否需要展示常用摄像机小红点
     * @return {object} 成功时：{code:0,data:[true|false]}
    */
  getFreqCameraNeedShowRedPoint(): object;
  /**
      * @since 10052
      * 清除常用摄像机小红点
    */
  clearFreqCameraNeedShowRedPoint(): void;
  /**
     * @since 10055
     * 打开设置定时的页面。
     ...
     */
  openGenerateCrontabStringPage(param?: any): Promise<any>;
  /**
      * @since 10056
    ...
    */
  openFirmWareAutoOTAPage(): void;
  /**
    * 打开自定义插件
    * @since 10059
    * @ignore 内部接口
    * @params {object} params
    *   params.std_dismiss {bool} dismiss掉标准插件页面
    *   params.open_plugin_source {int} 可选参数，标识从哪里打开插件(不传默认为0)。可能的取值有：0--默认值，如米家首页/其他；1-- 标准插件的更多功能；2--设置页的首页样式
    * @example
    * Host.ui.goCustomPlugin({"std_dismiss":true})
    */
  goCustomPlugin(params?: {}): void;
  /**
     * 返回Android手机底部导航栏高度
     * @since 10069
     * 仅限Android使用
  ...
  /**
     ...
     */
  openVirtualGroupInitPage(param: any): void;
  /**
  ...
  /**
     ...
     */
  openAssociatePage(param?: any): void;
  /**
     * @since 10084
  ...
  openChangeDeviceIconDialog(param: {
     ...
     */
  openNFCWritePageForConnectTV(param?: any): void;
  /**
     ...
     * }
     */
  openWifiChoosePage(): Promise<any>;
  /**
     * 基站（室内机）插件使用，调用该接口跳转到子设备配网页面，给子设备配网
    */
  openConfigRouterSubPage(): void;
  /**
    * @since 10102
    * 打开选择位置地图弹框
    * @param
    ...
    */
  openSelectLocationMapDialog(param: any): Promise<any>;
  /**
     * 为汉图照片打印机打开LivePhone选择一张动态照片
     * since 10106
     * @param
     *  param.callbackEvent(string) 回调事件类型 会通过这个发送自定义事件  android参数 iOS可以不用传
     *  param.sandBoxFolder(stgring) 选中的live photo存储的沙盒路径 android参数 iOS可以不用传
     */
  openPickLivePhotoPage(param: any): Promise<any>;
  /**
   * 打开设备中枢功能页
   * @param  暂传空
   */
  openDeviceHubGatewayPage(param?: {}): void;
  /**
     * 打开紧急事件电话呼叫页面
     * @param {string} did 设备 ID
     */
  openDeviceCallSettingPage(did: string): void;
  /**
     * 打开紧急事件电话呼叫页面
     * @param {string} did 设备 ID
     ...
     * }
     */
  openDeviceCallSettingPageWithExtra(did: string, extra: string): void;
  /**
     * 打开推荐场景详情页
     * @params {object} params
     ...
     */
  openTemplateScenePage(param?: {}): void;
  packageExit(): void;
  packageNavigate(name: any, params: {}, push: any): void;
  /**
     * 打开配对模式界面，仅Matter设备具备该项
     */
  openMatterConnectPage(did: any): void;
  /**
     * 跳转到插件之外页面后，如Host.ui.openWebPage(targetUrl)打开的H5页面，调用后回到插件页
     * @param info
     */
  backToPluginPage(info?: any): void;
  /**
   * 打开家庭管理页面
   * @param {string} did 设备 ID
   */
  openFamilyManagerPage(did: string): void;
  /**
     * since SDK_10100
     * 打开家庭相册页
     *
     * @param did
     */
  openFamilyAlbumPage(did: any): void;
  /**
     ...
     * })
     */
  requestWxDeviceVoIP(params: any): void;
  /**
     * 分享，邀请其他成员订阅音视频通话
     * @since 10091
     * @param params 参数必须包含：
     ...
     *  paramType : 固定："shareWxDeviceVoIP"
      ...
      */
  shareWxDeviceVoIP(params: any): void;
  /**
     ...
     *  inviteType : 固定："homeMember" "homeAdmin" "call" "homeMemberAndCall" "homeAdminAndCall" 分别对应上面五种类型
      ...
      */
  shareWxForInviteFriends(params: any): void;
  /**
     * 跳转微信小程序: 绑定、订阅等
     * 不对外提供
     * @since 10110
     * @param {
     *  wxBindStatus: bool, // 米家与微信绑定关系, 插件通过接口获取
     *  model: string, // Device.model, 设备唯一标识
     *  did: string, // Device.deviceID
     * }
     * 使用示例：
     * Host.ui.openWeChatMinProgramForBindOrSubscribe({
          wxBindStatus: true,
          model: Device.model,
          did: Device.deviceID,
        });
     */
  openWeChatMinProgramForBindOrSubscribe(params?: {}): void;
  /**
     ...
     *  paramType : 固定："locateWxDevice"
      ...
      */
  locateWxDevice(params: any): void;
  /**
     * 5. 跳转全部遥控器管理页面
     * since 10099
     * Android only support
     */
  openIrDeviceManagerPage(): void;
  /**
     * 1. 添加红外遥控器
     * since 10099
     * Android only support
     */
  openAddIrDevicePage(): void;
  /**
     * 2. 打开特定遥控器插件
     * since 10099
     * Android only support
     */
  openIrDevicePage(deviceTypeId: any): void;
}