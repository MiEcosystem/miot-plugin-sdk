...
class PinCodeDialog extends React.Component {
  ...
  renderTextGroup() {
    return Array.from({
      ...
      const borderColor = i === focusIndex ? {
        borderColor: this.props.color
      } : {};
      return <View key={i} style={[styles.blockContainer, marginLeft, borderColor]} {...getAccessibilityConfig({
        accessible: this.props.accessible
      })}>
            <Text style={[styles.blockText, this.props.dialogStyle.digitStyle]} allowFontScaling={this.props.dialogStyle.allowFontScaling}>
              {this.state.numArr[i] || ''}
            </Text>
          </View>;
    });
      ...
      accessible: this.props.accessible
        ...
        <View style={[styles.container]}>
          ...
          <View style={styles.pinCodeContainer}>
            ...
            <TextInput autoFocus={true} caretHidden={true} style={styles.textinput} value={this.state.value} selectionColor="#ffffff" underlineColorAndroid="transparent" onChangeText={text => this._onChangeText(text)} keyboardType="numeric" />
          </View>
