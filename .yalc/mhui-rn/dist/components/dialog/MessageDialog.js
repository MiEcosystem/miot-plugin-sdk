...
class MessageDialog extends React.Component {
        ...
        return <TouchableOpacity onPress={() => this.onPressCheckbox()} activeOpacity={1} style={{
          ...
          accessible: false
            ...
            accessibilityState: {
              ...
              <Text style={[styles.checkboxText, this.props.dialogStyle.extraTextStyle]} numberOfLines={extraTextNumberOfLines} allowFontScaling={this.props.dialogStyle.allowFontScaling}>
                {this.props.extraText || ''}
              </Text>
            </View>
          </TouchableOpacity>;
  ...
  render() {
    ...
    return <AbstractDialog animationType={this.props.animationType} visible={this.props.visible} title={this.props.title} showTitle={showTitle} buttons={this.buttons} dialogStyle={this.props.dialogStyle} onDismiss={() => this._onDismiss()} {...getAccessibilityConfig({
      accessible: this.props.accessible
    })}>
        <View style={[styles.container, paddingTop]}>
          <Text numberOfLines={messageNumberOfLines} allowFontScaling={this.props.dialogStyle.allowFontScaling} style={[styles.message, this.props.messageStyle]} {...getAccessibilityConfig({
          accessible: this.props.accessible,
