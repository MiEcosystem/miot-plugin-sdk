...
import { MIOTStringPicker as StringPicker } from "../../nativeModules";
import { referenceReport } from "../../decorators/reportDecorator"; // @native end

class StringSpinner extends React.Component {
  static propTypes = {
  ...
  render() {
    // @native :=> null
    const pickerStyle = this.props.pickerInnerStyle;
    ...
    return <StringPicker {...this.props} {...pickerStyle} {...getAccessibilityConfig({
      accessible: false
