      ...
      backgroundColor: '#fff'
        ...
        name: 'decrement'
          ...
          <View style={[styles.up]}>
            <Text numberOfLines={titleLine} ellipsizeMode="tail" allowFontScaling={this.props.allowFontScaling} style={[Styles.common.title, this.props.titleStyle, extraStyle, adaptedFontStyle]} {...getAccessibilityConfig({
            accessible: false
          })}>
              {this.props.title}
            </Text>
            ...
            <Text style={[styles.value, this.props.valueStyle, adaptedFontStyle]} numberOfLines={valueLine} allowFontScaling={this.props.allowFontScaling} {...getAccessibilityConfig({
            accessible: false
          })}>
