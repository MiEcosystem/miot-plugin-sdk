...
export default class Curtain extends Component {
  ...
  getCurtains() {
    ...
    for (let i = 0; i < l; i++) {
      ret.push(<Image key={String(i)} style={Styles.curtainSingle} source={i % 2 === 0 ? SourceCurtainDark : SourceCurtainLight} />);
    }
    ...
    return <View style={Styles.container} {...getAccessibilityConfig({
      ...
      name: 'decrement'
        ...
        <View style={Styles.curtains}>
          {[0, 1].indexOf(type) === -1 ? null : <View style={Styles.curtainWrap} {...this.panResponderLeft.panHandlers} {...getAccessibilityConfig({
          accessible: false
        })}>
          ...
          {[0, 2].indexOf(type) === -1 ? null : <View style={Styles.curtainWrap} {...this.panResponderRight.panHandlers} {...getAccessibilityConfig({
          accessible: false
        })}>
