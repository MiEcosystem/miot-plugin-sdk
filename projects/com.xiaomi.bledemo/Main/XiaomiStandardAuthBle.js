          ...
          <View style={[styles.actionContainer]}>
            ...
            <CommonCell
              ...
              onPress={() => {
                ...
                (Host.isAndroid ? NativeModules.MIOTHost : NativeModules.MHPluginSDK).openBleOtaDeviceUpgradePage({ fake_dfu_url: this.state.fake_dfu_url, fake_dfu_name: 'debug:' + this.state.fake_dfu_name, auth_type: 4 });
              }}
            />
            <CommonCell title="固件升级-常规" onPress={() => (Host.isAndroid ? NativeModules.MIOTHost : NativeModules.MHPluginSDK).openBleOtaDeviceUpgradePage({ auth_type: 4 })} />
          </View>
