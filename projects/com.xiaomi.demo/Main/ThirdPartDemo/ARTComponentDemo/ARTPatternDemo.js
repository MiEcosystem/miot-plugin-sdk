...
export default class ARTPatternDemo extends React.Component {
  render() {
    let textHeight = 20;
    let surfaceHeight = (height - (Platform.OS === 'ios' ? 64 : 76) - textHeight);

    let pattern = Platform.OS === 'ios' ? new Pattern(// 第一个参数是图片源码
    ...
    let info = Platform.OS === 'ios' ? "满屏的星星✨" : "安卓暂不支持图像 pattern, 展示满屏红色";
