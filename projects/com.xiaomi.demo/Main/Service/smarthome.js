    ...
    componentDidMount() {
        this.setState({
            apiList: [
                ...
                { name: "获取普通蓝牙列表", group: '蓝牙网关', handle: this.handleObjRes.bind(this), action: () => { return Device.getLinkedBTDevices() } },
                { name: "获取蓝牙mesh 设备列表", handle: this.handleObjRes.bind(this), action: () => { return Device.getLinkedBTMeshDevices() } },
