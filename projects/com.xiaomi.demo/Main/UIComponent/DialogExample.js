        ...
        <View style={styles.container}>
          ...
          <ScrollView>
            <View>
              <Text
                style={styles.label}
                onPress={() => this.setState({ visible0: true })}
              >
                {'通用弹窗容器显示默认内容(AbstractDialog)'}
              </Text>
              <Text
                style={styles.label}
                onPress={() => this.setState({ visible18: true })}
              >
              ...
              <Text
                style={styles.label}
                onPress={() => this.setState({ visible14: true })}
              >
                {'分页的分享弹窗(ShareDialog)'}
              </Text>
              <Text
                style={styles.label}
                onPress={() => this.setState({ visible15: true })}
              >
                {'选项弹窗(ActionSheet)'}
              </Text>
              <Text
                style={styles.label}
                onPress={() => this.setState({ visible16: true })}
              >
                {'单选弹窗(ChoiceDialog)'}
              </Text>
              <Text
                style={styles.label}
                onPress={() => this.setState({ visible17: true })}
              >
                {'多选弹窗(ChoiceDialog)'}
              </Text>
              <AbstractDialog
              ...
              <ProgressDialog
                ...
                accessibilityLabel={this.state.progress}
              />
              <MessageDialog
                ...
                buttons={[
                  {
                    text: '我了解了',
                    style: { color: 'lightpink' },
                    callback: () => this.setState({ visible4: false })
                  }
                ]}
                ...
                buttons={[
                  {
                    text: '消失',
                    style: { color: 'lightpink' },
                    callback: () => this.setState({ visible5: false })
                  },
                  {
                    text: '不消失',
                    style: { color: 'lightblue' },
                    callback: () => console.log('不消失')
                  }
                ]}
              ...
              <MessageDialog
                ...
                extraText="你点我一下试试"
                extra={{
                  onPress: () => alert('点击了下划线')
                }}
                buttons={[
                  {
                    text: '取消',
                    style: { color: 'lightpink' },
                    callback: () => this.setState({ visible6: false })
                  },
                  {
                    text: '确认',
                    style: { color: 'lightblue' },
              ...
              <MessageDialog
                ...
                buttons={[
                  {
                    text: '取消',
                    style: { color: 'lightpink' },
                    callback: () => this.setState({ visible7: false }),
                    accessibilityHint: '取消就取消'
                  },
                  {
                    text: '确认',
                    style: { color: 'lightblue' },
                ...
                accessibilityHint="点就点"
              />
              <InputDialog
                visible={this.state.visible8}
                title="最简单输入弹窗"
                onDismiss={() => this.onDismiss('8')}
              />
              <InputDialog
                ...
                underlineData={{
                  ...
                  onPress: () => alert('你注册的ID是123456')
                }}
                buttons={[
                  {
                    text: '取消',
                    style: { color: 'lightpink' },
                    callback: () => this.setState({ visible9: false })
                  },
                  {
                    text: '保存',
                    style: { color: 'lightblue' },
                ...
                buttons={[
                  {
                    text: '取消',
                    style: { color: 'lightpink' },
                    callback: () => this.setState({ visible10: false })
                  },
                  {
                    text: '保存',
                    style: { color: 'lightblue' },
                ...
                buttons={[
                  {
                    text: '取消',
                    style: { color: 'lightpink' },
                    callback: () => this.setState({ visible11: false })
                  },
                  {
                    text: '保存',
                    style: { color: 'lightblue' },
              ...
              <PinCodeDialog
                ...
                onDismiss={() => this.onDismiss('12')}
              />
              <ShareDialog
                visible={this.state.visible13}
                title="不分页的分享弹窗"
                onDismiss={() => this.onDismiss('13')}
              />
              <ShareDialog
                ...
                options={[
                  {
                    title: '🙈',
                    subtitle: '🙈',
                    onPress: () => console.log('非礼勿视')
                  },
                  {
                    title: '🙉',
                    onPress: () => console.log('非礼勿听')
                  },
                  {
                    title: '🙊',
                    subtitle: '🙊',
                    onPress: () => console.log('非礼勿言')
                  }
                ]}
                buttons={[
                  {
                    text: '取消',
                    style: { color: 'lightblue' },
                    callback: () => this.setState({ visible15: false })
                  }
                ]}
                onDismiss={() => this.onDismiss('15')}
              />
              <ChoiceDialog
