...
const propConfigs = [
  ...
  { name: 'onPress', type: 'pass', defaultValue: () => alert('onPress'), passOptions: [{ label: 'onPress', value: () => alert('onPress') }] },
  { name: 'onLongPress', type: 'pass', defaultValue: () => alert('onLongPress'), passOptions: [{ label: 'onLongPress', value: () => alert('onLongPress') }] },
