...
const propConfigs = [
  ...
  { name: 'onChange', type: 'pass', passDescription: '切换回调', defaultValue: () => console.log('onChange') },
  {
    name: 'colorType',
    type: 'enum',
    enumOptions: COLOR_TYPES,
    defaultValue: 'green',
  },
];
...
const SwitchDemo = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.sectionLabel}>Props 调试</Text>
      <TestComponent component={Switch} propConfigs={propConfigs} onPropsChange={(props) => console.log(props)} />
    </ScrollView>
  );
};
