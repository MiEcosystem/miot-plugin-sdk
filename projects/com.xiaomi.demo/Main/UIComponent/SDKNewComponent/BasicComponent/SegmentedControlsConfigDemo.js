...
const propConfigs = [
  {
    ...
    category: 'content',
    passOptions: [
      { label: '两个选项', value: [{ label: '选项一一一一一一一一一', value: 'opt1' }, { label: '选项二', value: 'opt2' }] },
      { label: '三个选项', value: [{ label: '选项一一一一一一一一一', value: 'opt1' }, { label: '选项二', value: 'opt2' }, { label: '选项三', value: 'opt3' }] },
      { label: '四个选项', value: [{ label: '选项一一一一一一一一一', value: 'opt1' }, { label: '选项二', value: 'opt2' }, { label: '选项三', value: 'opt3' }, { label: '选项四', value: 'opt4' }] },
      { label: '五个选项', value: [{ label: '选项一一一一一一一一一', value: 'opt1' }, { label: '选项二', value: 'opt2' }, { label: '选项三', value: 'opt3' }, { label: '选项四', value: 'opt4' }, { label: '选项五', value: 'opt5' }] },
    ],
  },
