...
const optionsEmphasisBlue = [
  { label: '普通选项', type: 'default', onPress: () => showToast('onPress: 普通') },
  { label: '强调蓝色（emphasis blue）', type: 'emphasis', colorType: 'blue', onPress: () => showToast('onPress: 蓝色强调') },
];

const optionsEmphasisGreen = [
  { label: '普通选项', type: 'default', onPress: () => showToast('onPress: 普通') },
  { label: '强调绿色（emphasis green）', type: 'emphasis', colorType: 'green', onPress: () => showToast('onPress: 绿色强调') },
];

const optionsEmphasisOrange = [
  { label: '普通选项', type: 'default', onPress: () => showToast('onPress: 普通') },
  { label: '强调橙色（emphasis orange）', type: 'emphasis', colorType: 'orange', onPress: () => showToast('onPress: 橙色强调') },
];

const optionsEmphasisPurple = [
  { label: '普通选项', type: 'default', onPress: () => showToast('onPress: 普通') },
  { label: '强调紫色（emphasis purple）', type: 'emphasis', colorType: 'purple', onPress: () => showToast('onPress: 紫色强调') },
];

const optionsEmphasisWathet = [
  { label: '普通选项', type: 'default', onPress: () => showToast('onPress: 普通') },
  { label: '强调天蓝（emphasis wathet）', type: 'emphasis', colorType: 'wathet', onPress: () => showToast('onPress: 天蓝强调') },
];
...
const optionsDisabledEmphasis = [
  { label: '正常 emphasis（blue）', type: 'emphasis', colorType: 'blue', onPress: () => showToast('onPress: 正常emphasis') },
  { label: '禁用 emphasis（blue）', type: 'emphasis', colorType: 'blue', disabled: true },
];
...
const propConfigs = [
  ...
  },
  {
    ...
    passOptions: [
      ...
      { label: 'disabled: emphasis', value: optionsDisabledEmphasis },
      // 多语言/超长
...
const ActionSheetConfigDemo = () => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 40 }}>
      ...
      <TestComponent component={ActionSheet} propConfigs={propConfigs} onPropsChange={handlePropsChange} />
