    ...
    >
      <View
        style={[
          ...
          item.selected&&selectable ? { backgroundColor: colorToken.accentGreenSubtle } : null,
          borderRadiusStyle,
        ]}
      >
        {/* 蒙层包裹整个内容，圆角随选中状态 */}
        {(pressed && !disabled || item.isPressed )&& <View style={[styles.pressOverlay,{ backgroundColor: colorToken.otherButtonPressed} ,borderRadiusStyle]} />}
        ...
        <View style={styles.textContainer}>
          <Text
            style={[
              ...
              item.selected&&selectable ? { color: colorToken.accentGreenContent } : null,
            ]}
            numberOfLines={3}
          >
            {item.title}
...
const styles = dynamicStyleSheet({
  ...
  card: {
    backgroundColor: colorToken.surfacePopover,
    borderRadius: 20,
    marginHorizontal: 16,
    marginBottom: 20,
    minWidth: 200,
