...
import { ButtonGroup, colorToken, showToast } from 'miot/ui/hyperOSUI';
import TestComponent from '../testComponent';
import { dynamicStyleSheet } from 'miot/ui/Style';

const twoButtons = [
  { title: '取消', type: 'normal', onPress: () => showToast('取消') },
  { title: '确认', type: 'primary', onPress: () => showToast('确认') },
];

const threeButtons = [
  { title: '取消', type: 'normal', onPress: () => showToast('取消') },
  { title: '删除', type: 'warning', onPress: () => showToast('删除') },
  { title: '确认', type: 'primary', onPress: () => showToast('确认') },
];
