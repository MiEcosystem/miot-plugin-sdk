...
const TestComponent = ({ component: Component, propConfigs, onPropsChange, showPreviewBg = true }) => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: COLORS.pageBg }]}>
      <View style={[styles.previewSection, { backgroundColor: showPreviewBg ? colorToken.surfaceCardTranslucent : 'transparent', borderRadius: showPreviewBg ? radiusToken.cardLarge : 0 }]}>
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  previewSection: { marginHorizontal: 12, overflow: 'hidden' },
