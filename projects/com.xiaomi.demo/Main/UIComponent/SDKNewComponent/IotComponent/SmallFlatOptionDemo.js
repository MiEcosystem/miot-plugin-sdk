...
import { ActionBlock, colorToken, Fonts, CardContainer, CardHeader, ContainerWithGap } from 'miot/ui/hyperOSUI';
    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <ContainerWithGap gap={8} title="副标题无交互">
          <CardContainer>
            <CardHeader title="标题"/>
            <ActionBlock value={state.currentValue} disabled={state.disabled} onChange={onSelect} options={state.sourceData1} />
          </CardContainer>
          <CardContainer>
            <CardHeader title="标题"/>
            <ActionBlock value={state.currentValue} disabled={state.disabled} onChange={onSelect} options={state.sourceData2} />
          </CardContainer>
        </ContainerWithGap>
        <ContainerWithGap gap={8} title="副标题带入口">
          <CardContainer>
            <CardHeader title="标题"/>
            <ActionBlock value={state.currentValue} disabled={state.disabled} onChange={onSelect} options={state.sourceData3} />
          </CardContainer>
          <CardContainer>
            <CardHeader title="标题"/>
            <ActionBlock value={state.currentValue} disabled={state.disabled} onChange={onSelect} options={state.sourceData4} />
          </CardContainer>
        </ContainerWithGap>
        <ContainerWithGap gap={8} title="副标题带切换">
          <CardContainer>
            <CardHeader title="标题"/>
            <ActionBlock value={state.currentValue} disabled={state.disabled} onChange={onSelect} options={state.sourceData5} />
          </CardContainer>
          <CardContainer>
            <CardHeader title="标题"/>
            <ActionBlock value={state.currentValue} disabled={state.disabled} onChange={onSelect} options={state.sourceData6} />
          </CardContainer>
        </ContainerWithGap>
        <ContainerWithGap gap={8} title="颜色配置">
          <CardContainer>
            <CardHeader title="标题"/>
            <ActionBlock value={state.currentValue} disabled={state.disabled} onChange={onSelect} options={state.sourceData7} />
          </CardContainer>
        </ContainerWithGap>
      </View>
    </ScrollView>
