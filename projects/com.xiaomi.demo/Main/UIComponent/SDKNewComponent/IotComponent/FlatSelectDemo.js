...
const UIItems = [
  { title: 'L', router: 'LargeFlatOptionDemo' },
  // { title: 'M', router: 'EntryMDemo' },
  { title: 'S', router: 'SmallFlatOptionDemo' }
];


const FlatSelectDemo = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.header}>切换器</Text>
      <ListGroup
