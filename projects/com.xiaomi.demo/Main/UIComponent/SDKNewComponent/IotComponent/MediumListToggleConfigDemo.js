...
import { MediumListToggle, colorToken, TestComponent } from 'miot/ui/hyperOSUI';
...
const propConfigs = [
  { name: 'title', type: 'string', defaultValue: '中型列表开关', category: 'content' },
...
const MediumListToggleConfigDemo = () => (
  <View style={styles.container}>
    <TestComponent component={MediumListToggle} propConfigs={propConfigs} />
  </View>
);
...
export default MediumListToggleConfigDemo;
