...
const SmallImageButtonDemo = ({ navigation }) => {
  ...
  return (
    ...
    >
      ...
      <Text style={styles.sectionTitle}>图标尺寸裁切（容器固定 20×20）</Text>
      <CardContainer>
        <SmallGridContainer>
          <SmallImageButton
            title="大图（32×32）"
            actionType="button"
            custom={<View style={{ width: 32, height: 32, borderRadius: 4, backgroundColor: '#00B884' }} />}
            onPress={() => {}}
          />
          <SmallImageButton
            title="正好（20×20）"
            actionType="button"
            custom={<View style={{ width: 20, height: 20, borderRadius: 4, backgroundColor: '#0077FF' }} />}
            onPress={() => {}}
          />
          <SmallImageButton
            title="小图（12×12）"
            actionType="button"
            custom={<View style={{ width: 12, height: 12, borderRadius: 4, backgroundColor: '#FF6600' }} />}
            onPress={() => {}}
          />
        </SmallGridContainer>
      </CardContainer>
