...
const LargeTriggerSelectDemo = ({ navigation }) => {
  useEffect(() => {
    navigation.setParams({
      right: [{ key: NavigationBar.ICON.MORE, onPress: () => navigation.navigate('LargeTriggerSelectConfigDemo', { title: 'LargeTriggerSelect 配置调试' }) }],
    });
  }, []);
    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <ContainerWithGap gap={8} title="带标题">
          <CardContainer>
            <CardHeader title="标题" actionType="none"/>
        ...
        <ContainerWithGap gap={8} title="无数据">
          <CardContainer>
            <CardHeader title="标题" actionType="none"/>
            <LargeTriggerSelect value={state.currentValue} disabled={state.disabled} onChange={onSelect} options={state.sourceData9} />
          </CardContainer>
          <CardContainer>
            <LargeTriggerSelect value={state.currentValue} disabled={state.disabled} cardType={'outer'} onChange={onSelect} options={state.sourceData10} />
          </CardContainer>
        </ContainerWithGap>
      </View>
    </ScrollView>
...
export default LargeTriggerSelectDemo;
