    ...
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 40 }}>
      ...
      <CardContainer gap={0}>
        <View style={styles.row}>
          <View style={styles.cell}><DataItem title="26°C" subtitle="室内温度" /></View>
      ...
      <CardContainer gap={0}>
        <View style={styles.row}>
          <View style={styles.cell}><DataItem title="28°C" subtitle="数字字体（默认）" /></View>
          <View style={styles.cell}><DataItem title="28°C" subtitle="系统字体" stringMode /></View>
        </View>
      </CardContainer>
      ...
      <CardContainer gap={0}>
        <View style={styles.row}>
          ...
          <View style={styles.cell}><DataItem title="26°C" subtitle="orange" align="center" colorType="orange" /></View>
      ...
      <CardContainer gap={0}>
        <View style={styles.row}>
          ...
          <View style={styles.cell}><DataItem title="26°C" subtitle="purple" align="center" colorType="purple" /></View>
        </View>
      </CardContainer>
