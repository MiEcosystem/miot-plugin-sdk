...
import {
  ...
  SelectList, BlockButton, Separator, NoticeBar, colorToken, Fonts, showToast } from 'miot/ui/hyperOSUI';
...
const SubpageLayoutConfigDemo = () => {
  ...
  const [contentType, setContentType] = useState('full'); // 'full' | 'simple' | 'select'
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.panel} contentContainerStyle={styles.panelContent}>
        ...
        <ToggleRow label="Footer（验证安全距离）" value={showFooter} onToggle={() => setShowFooter((v) => !v)} />
