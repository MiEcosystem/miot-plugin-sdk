    ...
    >
      <View
        style={[
          ...
          item.selected&&selectable ? { backgroundColor: defaultTheme.mjColorFunctionBrandfillSecondaryNormal } : null,
          borderRadiusStyle,
        ]}
      >
        {/* 蒙层包裹整个内容，圆角随选中状态 */}
        ...
        <View style={styles.textContainer}>
          <Text
            style={[
              ...
              item.selected&&selectable ? { color: defaultTheme.mjColorFunctionBrandtextNormal } : null,
            ]}
            numberOfLines={3}
          >
            {item.title}
...
const HandPopCustomDemo = ({ navigation }) => {
  const [group1, setGroup1] = useState([
    { title: '正常图标', selectable: false ,showIcon: true},
    { title: '禁用图标', selectable: false, disabled: true,showIcon: true},
  ]);
  const [group2, setGroup2] = useState([
    { title: '主文本',subtitle:'这里是副标题',selectable: true ,showIcon:true },
    { title: '这是主文本这是主文本这是主文本这是主文本这是主文本这是主文本这是主文本',subtitle: '这里是副标题这里是副标题这里是副标题这里是副标题这里是副标题这里是副标题这里是副标题',selectable: true,showIcon:true },
  ]);
  const [group3, setGroup3] = useState([
    { title: '主文本', subtitle: '这里是副标题',showIcon:true },
    { title: '这是主文本这是主文本这是主文本这是主文本这是主文本这是主文本这是主文本',subtitle:'这里是副标题这里是副标题这里是副标题这里是副标题这里是副标题这里是副标题这里是副标题', selectable: false,showIcon:true },
  ]);
...
const styles = StyleSheet.create({
  ...
  header: {
    fontSize: 22,
    color: defaultTheme.mjColorGrayTab,
    fontWeight: '600',
    paddingHorizontal: 16,
    marginBottom: 20,
  },
  card: {
    backgroundColor: defaultTheme.mjColorGrayPopover,
    borderRadius: 20,
    marginHorizontal: 16,
    marginBottom: 20,
    minWidth: 200,
  ...
  title: {
    ...
    color: defaultTheme.mjColorGrayText1,
  },
  subtitle: {
    ...Fonts.mjTextBody2R,
    color: defaultTheme.mjColorGrayText4,
  },
  disabled: {
    opacity: 0.3,
  },
