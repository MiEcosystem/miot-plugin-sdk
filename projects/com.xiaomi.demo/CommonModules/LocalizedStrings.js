...
class LocalizedStrings {
  ...
  setLanguage(language) {
    ...
    // should be used
    let bestLanguage = this._getBestMatchingLanguage(language, this.props);
    let defaultLanguage = Object.keys(this.props)[0];
    this.language = bestLanguage;
    // Associate the language object to the this object
    if (this.props[bestLanguage]) {
      let localizedStrings = Object.assign({}, this.props[defaultLanguage], this.props[this.language]);
