...
* [miot/Package](#module_miot/Package)
    * [module.exports](#exp_module_miot/Package--module.exports) ⏏
        * _static_
            ...
            * [.wifiDeviceUpgradeOptions](#module_miot/Package--module.exports.wifiDeviceUpgradeOptions)
...
<a name="module_miot/Package--module.exports.wifiDeviceUpgradeOptions"></a>

#### module.exports.wifiDeviceUpgradeOptions
...
| Param | Description |
| --- | --- |
| navigation | 传入包含upgradePageKey的navigation，否则可能会出现无法跳转的情况 |
| upgradePageKey | 要跳转的page key 通常是在index中定义的 |
| upgradePageParams | 要跳转的page params |
