...
* [miot/device/bluetooth](#module_miot/device/bluetooth)
    * [module.exports](#exp_module_miot/device/bluetooth--module.exports) ⏏
        ...
        * [.doSpecOperation()](#module_miot/device/bluetooth--module.exports.doSpecOperation)
...
```
<a name="module_miot/device/bluetooth--module.exports.doSpecOperation"></a>

#### module.exports.doSpecOperation()
ble 直连spec的关键方法，用于触发 set/get property, do action 这三个方法；

**Kind**: static method of [<code>module.exports</code>](#exp_module_miot/device/bluetooth--module.exports)  
**Params**: <code>String</code> mac, 蓝牙设备的mac地址  
**Params**: <code>int</code> opCode 定义为： 0：set Property; 2: get Property; 5: do action  
**Params**: <code>String</code> json: 各个方法需要的需要的参数各不相同，参数类型建议文档：https://xiaomi.feishu.cn/docs/doccneoCLgQYWtfaEU8sWoKwx3E#UXkcyO  
