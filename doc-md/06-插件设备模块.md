    ...
    * [module.exports](#exp_module_miot/Device--module.exports) ⏏
        ...
        * _inner_
            * [~IDevice](#module_miot/Device--module.exports..IDevice)
                ...
                * [.getLinkedBTMeshDevices([did])](#module_miot/Device--module.exports..IDevice+getLinkedBTMeshDevices) ⇒ <code>Promise</code>
...
**Kind**: instance method of [<code>IDevice</code>](#module_miot/Device--module.exports..IDevice)  
**Returns**: <code>Promise</code> - 返回数组设备信息的promise  

| Param | Type | Default | Description |
| --- | --- | --- | --- |
| [did] | <code>string</code> | <code>&quot;Device.deviceID&quot;</code> | 蓝牙网关的did，可以为空，为空时默认取当前Device.deviceID |

<a name="module_miot/Device--module.exports..IDevice+getLinkedBTMeshDevices"></a>

##### iDevice.getLinkedBTMeshDevices([did]) ⇒ <code>Promise</code>
获取蓝牙网关关联的蓝牙Mesh设备列表。
