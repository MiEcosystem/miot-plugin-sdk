...
| --- | --- | --- |
| visible | <code>bool</code> | 是否可见 |
| dataSource | <code>array</code> | 数据源 |
| defaultValue | <code>object</code> | 默认值 |
| onValueChanged | <code>func</code> | 值改变的回调 |
| textColor | <code>string</code> | 文字颜色 默认值 0x000000 |
| fontSize | <code>number</code> | 文字大小 默认值 22 |
| selectTextColor | <code>string</code> | 文字选中颜色 默认值 0x00aa71 |
| selectFontSize | <code>number</code> | 文字选中大小 默认值 22 |
| selectBgColor | <code>string</code> | 文字选中背景 默认值 0xffffff |
| lineColor | <code>string</code> | 分割线颜色 默认值 0xe5e5e5 |
| rowHeight | <code>number</code> | 行高 默认值 42 |
