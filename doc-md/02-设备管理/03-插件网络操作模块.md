...
* [miot/device](#module_miot/device)
    * [module.exports](#exp_module_miot/device--module.exports) ⏏
        * _instance_
            ...
            * [.connectWifi(ssid, pwd)](#module_miot/device--module.exports+connectWifi)
        * _inner_
...
<a name="module_miot/device--module.exports+connectWifi"></a>

#### module.exports.connectWifi(ssid, pwd)
连接路由器WiFi
...
| Param | Type | Description |
| --- | --- | --- |
| ssid | <code>String</code> | 要连接的WIFI名称 |
| pwd | <code>String</code> | 要连接的WIFI密码 |
