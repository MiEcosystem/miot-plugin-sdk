    ...
    * [module.exports](#exp_module_miot/device--module.exports) ⏏
        * _static_
            * [.BasicDevice](#module_miot/device--module.exports.BasicDevice)
                ...
                * [.getHideSubDevices(是否使用缓存,默认为false)](#module_miot/device--module.exports.BasicDevice+getHideSubDevices) ⇒ <code>[ &#x27;Promise&#x27; ].&lt;Array.&lt;BasicDevice&gt;&gt;</code>
...
##### basicDevice.getHideSubDevices(是否使用缓存,默认为false) ⇒ <code>[ &#x27;Promise&#x27; ].&lt;Array.&lt;BasicDevice&gt;&gt;</code>
获取隐藏子设备列表
android特有接口，ios不能使用
...
| Param | Type |
| --- | --- |
| 是否使用缓存,默认为false | <code>boolean</code> | 
