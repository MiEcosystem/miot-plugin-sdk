...
* [miot/Service](#module_miot/Service)
    * _static_
        ...
        * [.setPrivacyConfirmation(privacyVersion:, privacyType:, extra:)](#module_miot/Service.setPrivacyConfirmation) ⇒ <code>[ &#x27;Promise&#x27; ].&lt;String&gt;</code>
        * [.getPrivacyChanges(version:)](#module_miot/Service.getPrivacyChanges) ⇒ <code>[ &#x27;Promise&#x27; ].&lt;Object&gt;</code>
...
<a name="module_miot/Service.setPrivacyConfirmation"></a>

### miot/Service.setPrivacyConfirmation(privacyVersion:, privacyType:, extra:) ⇒ <code>[ &#x27;Promise&#x27; ].&lt;String&gt;</code>
隐私同意上报

**Kind**: static method of [<code>miot/Service</code>](#module_miot/Service)  
**Returns**: <code>[ &#x27;Promise&#x27; ].&lt;String&gt;</code> - 成功时：返回
"ok"
 失败时：返回
...
| Param | Type | Description |
| --- | --- | --- |
| privacyVersion: | <code>String</code> | 隐私政策版本,没有隐私版本的情况，传空字符串""，例如本地隐私,默认为"" |
| privacyType: | <code>Number</code> | 上报类型，隐私协议上报（1），系统权限同意上报（2），敏感数据上报（3），默认为1 |
| extra: | <code>Object</code> | 自定义数据 |


* * *

<a name="module_miot/Service.getPrivacyChanges"></a>

### miot/Service.getPrivacyChanges(version:) ⇒ <code>[ &#x27;Promise&#x27; ].&lt;Object&gt;</code>
