...
* [miot/Service](#module_miot/Service)
    * _static_
        ...
        * [.fetchMultilingualResources(did)](#module_miot/Service.fetchMultilingualResources) ⇒ <code>[ &#x27;Promise&#x27; ].&lt;JSON&gt;</code>
    * _inner_
        ...
        * [~callSmartHomeAPIV2(api, params, [resProcessHandler])](#module_miot/Service..callSmartHomeAPIV2)
        ...
        * [~getDevSerEnv()](#module_miot/Service..getDevSerEnv) ⇒
        ...
        * [~callSmartChatAPI(params)](#module_miot/Service..callSmartChatAPI) ⇒ <code>Promise.&lt;unknown&gt;</code> \| <code>Promise.Promise</code>
...
<a name="module_miot/Service.fetchMultilingualResources"></a>

### miot/Service.fetchMultilingualResources(did) ⇒ <code>[ &#x27;Promise&#x27; ].&lt;JSON&gt;</code>
...
<a name="module_miot/Service..callSmartHomeAPIV2"></a>

### miot/Service~callSmartHomeAPIV2(api, params, [resProcessHandler])
通用的请求米家后台接口的方法，与米家服务器交互。
...
| [resProcessHandler] | <code>function</code> | 可选响应加工钩子 (api, params, res) => res，resolve/reject 前对 res 做格式归一（不判 code）；默认不传即纯透传。 |
...
<a name="module_miot/Service..getDevSerEnv"></a>

### miot/Service~getDevSerEnv() ⇒
获取米家APP切换的当前服务器环境
...
<a name="module_miot/Service..callSmartChatAPI"></a>

### miot/Service~callSmartChatAPI(params) ⇒ <code>Promise.&lt;unknown&gt;</code> \| <code>Promise.Promise</code>
C700 智能问答接口（SSE）(插件->云存)
...
| Param | Description |
| --- | --- |
| params | params.conversationId   params.did   params.content   params.callbackEvent |
