...
* [miot/service/miotcamera](#module_miot/service/miotcamera)
    * [~IMiotCamera](#module_miot/service/miotcamera..IMiotCamera)
        ...
        * [.cancelDownloadM3U8ToMP4(fileId, callbackName, isAlarm, videoCodec, did)](#module_miot/service/miotcamera..IMiotCamera+cancelDownloadM3U8ToMP4)
        * [.downloadM3U8ToMP4V2(fileId, filePath, callbackName, isAlarm, videoCodec, transcode)](#module_miot/service/miotcamera..IMiotCamera+downloadM3U8ToMP4V2) ⇒
        * [.cancelDownloadM3U8ToMP4V2(fileId, callbackName, isAlarm, did)](#module_miot/service/miotcamera..IMiotCamera+cancelDownloadM3U8ToMP4V2)
...
<a name="module_miot/service/miotcamera..IMiotCamera+cancelDownloadM3U8ToMP4"></a>

#### iMiotCamera.cancelDownloadM3U8ToMP4(fileId, callbackName, isAlarm, videoCodec, did)
...
| isAlarm | <code>\*</code> | <code>false</code> | 
| videoCodec | <code>\*</code> |  | 
| did | <code>\*</code> |  | 


* * *

<a name="module_miot/service/miotcamera..IMiotCamera+downloadM3U8ToMP4V2"></a>

#### iMiotCamera.downloadM3U8ToMP4V2(fileId, filePath, callbackName, isAlarm, videoCodec, transcode) ⇒
...
| isAlarm | <code>false</code> | 是否报警视频 |
| videoCodec | <code>H265</code> | 视频编码如 "H264", "H265" |
| transcode | <code>true</code> | 是否需要把每个子视频转码成相同分辨率后再合成，默认需要转 |


* * *

<a name="module_miot/service/miotcamera..IMiotCamera+cancelDownloadM3U8ToMP4V2"></a>

#### iMiotCamera.cancelDownloadM3U8ToMP4V2(fileId, callbackName, isAlarm, did)
