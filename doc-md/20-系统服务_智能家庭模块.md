...
| params.data_type | <code>string</code> | 数据类型 包括： 采样统计 日统计:stat_day / 周统计:stat_week / 月统计:stat_month ; 计数统计 日统计:total_day_v2 / 周统计:total_week_v2 / 月统计:total_month_v2 |
...
| --- | --- | --- |
| params | <code>object</code> | 参数 |
| params.did | <code>int</code> | 设备did |
...
| params.time_start | <code>int</code> | 开始UTC时间 |
| params.time_end | <code>int</code> | 结束UTC时间 |
| params.limit | <code>int</code> | 最多返回结果数目，上限500。注意按需填写，返回数据越多查询越慢 |
