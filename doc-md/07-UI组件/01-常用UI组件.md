...
| surfaceFront | <code>bool</code> | [新增] 是否将当前surface view置顶，会遮挡其他surface view，双摄大小窗播放时需根据当前显示状态动态设置 |
| videoTemplate | <code>object</code> | [新增] 畸变矫正模板参数，插件从设备侧获取直播开启时通过此属性设置下来 |
...
* [miot/ui/CameraRender](#module_miot/ui/CameraRender)
    * _instance_
        ...
        * [.setRenderType(type)](#module_miot/ui/CameraRender+setRenderType)
    * _inner_
        ...
        * [~onGestureUpdate](#module_miot/ui/CameraRender..onGestureUpdate)
        * [~onWindowChanged](#module_miot/ui/CameraRender..onWindowChanged)
        ...
        * [~SingleFishPlayerType](#module_miot/ui/CameraRender..SingleFishPlayerType) : <code>object</code>
...
<a name="module_miot/ui/CameraRender+setRenderType"></a>

### miot/ui/CameraRender.setRenderType(type)
[新增]
动态设置当前鱼眼播放的类型
...
<a name="module_miot/ui/CameraRender..onGestureUpdate"></a>

### miot/ui/CameraRender~onGestureUpdate
...
<a name="module_miot/ui/CameraRender..onWindowChanged"></a>

### miot/ui/CameraRender~onWindowChanged
...
<a name="module_miot/ui/CameraRender..SingleFishPlayerType"></a>

### miot/ui/CameraRender~SingleFishPlayerType : <code>object</code>
单鱼眼播放器模式
