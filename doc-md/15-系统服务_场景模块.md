...
* [miot/service/scene](#module_miot/service/scene)
    * [module.exports](#exp_module_miot/service/scene--module.exports) ⏏
        ...
        * _inner_
            * [~场景id](#module_miot/service/scene--module.exports..场景id) : <code>int</code>
            * [~是否是新的场景](#module_miot/service/scene--module.exports..是否是新的场景) : <code>boolean</code>
            * [~场景的创建时间](#module_miot/service/scene--module.exports..场景的创建时间) : <code>long</code>
            * [~场景是否开启](#module_miot/service/scene--module.exports..场景是否开启) : <code>int</code>
            * [~定时场景的设备的did](#module_miot/service/scene--module.exports..定时场景的设备的did) : <code>string</code>
            * [~场景名称](#module_miot/service/scene--module.exports..场景名称) : <code>string</code>
            * [~场景类型，只读](#module_miot/service/scene--module.exports..场景类型，只读) : <code>SceneType</code>
            * [~是否是定时场景，只读](#module_miot/service/scene--module.exports..是否是定时场景，只读) : <code>boolean</code>
            * [~是否是人工场景，只读](#module_miot/service/scene--module.exports..是否是人工场景，只读) : <code>boolean</code>
            * [~是否是自动场景，只读](#module_miot/service/scene--module.exports..是否是自动场景，只读) : <code>readonly</code>
            * [~代表场景的分类，创建场景时可自定义此参数；如果获取场景的时候传入identify，表示获取identify类场景列表；如果不需要对场景分类，此参数可忽略。](#module_miot/service/scene--module.exports..代表场景的分类，创建场景时可自定义此参数；如果获取场景的时候传入identify，表示获取identify类场景列表；如果不需要对场景分类，此参数可忽略。) : <code>string</code>
            * [~场景的更多属性，详见](#module_miot/service/scene--module.exports..场景的更多属性，详见) : <code>json</code>
            ...
            * [~createScene(deviceID, sceneType, opt)](#module_miot/service/scene--module.exports..createScene) ⇒ <code>Promise.&lt;IScene&gt;</code>
...
<a name="module_miot/service/scene--module.exports..场景id"></a>

#### module.exports~场景id : <code>int</code>
**Kind**: inner property of [<code>module.exports</code>](#exp_module_miot/service/scene--module.exports)  
**Read only**: true  
<a name="module_miot/service/scene--module.exports..是否是新的场景"></a>

#### module.exports~是否是新的场景 : <code>boolean</code>
**Kind**: inner property of [<code>module.exports</code>](#exp_module_miot/service/scene--module.exports)  
**Read only**: true  
<a name="module_miot/service/scene--module.exports..场景的创建时间"></a>

#### module.exports~场景的创建时间 : <code>long</code>
**Kind**: inner property of [<code>module.exports</code>](#exp_module_miot/service/scene--module.exports)  
**Read only**: true  
<a name="module_miot/service/scene--module.exports..场景是否开启"></a>

#### module.exports~场景是否开启 : <code>int</code>
**Kind**: inner property of [<code>module.exports</code>](#exp_module_miot/service/scene--module.exports)  
**Read only**: true  
<a name="module_miot/service/scene--module.exports..定时场景的设备的did"></a>

#### module.exports~定时场景的设备的did : <code>string</code>
**Kind**: inner property of [<code>module.exports</code>](#exp_module_miot/service/scene--module.exports)  
**Read only**: true  
<a name="module_miot/service/scene--module.exports..场景名称"></a>

#### module.exports~场景名称 : <code>string</code>
**Kind**: inner property of [<code>module.exports</code>](#exp_module_miot/service/scene--module.exports)  
<a name="module_miot/service/scene--module.exports..场景类型，只读"></a>

#### module.exports~场景类型，只读 : <code>SceneType</code>
**Kind**: inner property of [<code>module.exports</code>](#exp_module_miot/service/scene--module.exports)  
**Read only**: true  
<a name="module_miot/service/scene--module.exports..是否是定时场景，只读"></a>

#### module.exports~是否是定时场景，只读 : <code>boolean</code>
**Kind**: inner property of [<code>module.exports</code>](#exp_module_miot/service/scene--module.exports)  
**Read only**: true  
<a name="module_miot/service/scene--module.exports..是否是人工场景，只读"></a>

#### module.exports~是否是人工场景，只读 : <code>boolean</code>
**Kind**: inner property of [<code>module.exports</code>](#exp_module_miot/service/scene--module.exports)  
**Read only**: true  
<a name="module_miot/service/scene--module.exports..是否是自动场景，只读"></a>

#### module.exports~是否是自动场景，只读 : <code>readonly</code>
**Kind**: inner property of [<code>module.exports</code>](#exp_module_miot/service/scene--module.exports)  
**Read only**: true  
<a name="module_miot/service/scene--module.exports..代表场景的分类，创建场景时可自定义此参数；如果获取场景的时候传入identify，表示获取identify类场景列表；如果不需要对场景分类，此参数可忽略。"></a>

#### module.exports~代表场景的分类，创建场景时可自定义此参数；如果获取场景的时候传入identify，表示获取identify类场景列表；如果不需要对场景分类，此参数可忽略。 : <code>string</code>
**Kind**: inner property of [<code>module.exports</code>](#exp_module_miot/service/scene--module.exports)  
<a name="module_miot/service/scene--module.exports..场景的更多属性，详见"></a>

#### module.exports~场景的更多属性，详见 : <code>json</code>
**Kind**: inner property of [<code>module.exports</code>](#exp_module_miot/service/scene--module.exports)  
...
#### module.exports~createScene(deviceID, sceneType, opt) ⇒ <code>Promise.&lt;IScene&gt;</code>
创建场景
