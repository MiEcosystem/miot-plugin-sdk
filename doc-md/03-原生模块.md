...
* [miot/Host](#module_miot/Host)
    ...
    * [.isInternationalEdition](#module_miot/Host.isInternationalEdition) : <code>boolean</code>
...
**Kind**: static constant of [<code>miot/Host</code>](#module_miot/Host)  
**Read only**: true  
<a name="module_miot/Host.isInternationalEdition"></a>

### miot/Host.isInternationalEdition : <code>boolean</code>
是否是国际版APP
