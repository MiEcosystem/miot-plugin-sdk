...
* [miot/device/bluetooth](#module_miot/device/bluetooth)
    * [module.exports](#exp_module_miot/device/bluetooth--module.exports) ⏏
        ...
        * [.wechatUnlock(params)](#module_miot/device/bluetooth--module.exports+wechatUnlock) ⇒ <code>[ &#x27;Promise&#x27; ].&lt;Object&gt;</code>
...
<a name="module_miot/device/bluetooth--module.exports+wechatUnlock"></a>

#### module.exports.wechatUnlock(params) ⇒ <code>[ &#x27;Promise&#x27; ].&lt;Object&gt;</code>
微信小程序蓝牙开锁（透传）
框架侧仅透传参数给 Native，不校验不处理，实际开锁逻辑由专门模块负责。

**Kind**: instance method of [<code>module.exports</code>](#exp_module_miot/device/bluetooth--module.exports)  
**Returns**: <code>[ &#x27;Promise&#x27; ].&lt;Object&gt;</code> - resolve: Native 返回的结果 map
     reject: Native 返回的错误 map  
**Since**: 11.5  

| Param | Type | Description |
| --- | --- | --- |
| params | <code>Object</code> | 业务侧定义的参数 map，框架直接透传 |
