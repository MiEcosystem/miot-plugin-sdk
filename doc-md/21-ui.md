...
* [miot/ui/NumberSpinner](#module_miot/ui/NumberSpinner)
    * [~visible](#module_miot/ui/NumberSpinner..visible) : <code>bool</code>
    * [~unit](#module_miot/ui/NumberSpinner..unit) : <code>string</code>
    * [~maxValue](#module_miot/ui/NumberSpinner..maxValue) : <code>int</code>
    * [~minValue](#module_miot/ui/NumberSpinner..minValue) : <code>int</code>
    * [~interval](#module_miot/ui/NumberSpinner..interval) : <code>int</code>
    * [~defaultValue](#module_miot/ui/NumberSpinner..defaultValue) : <code>int</code>
    * [~valueFormat](#module_miot/ui/NumberSpinner..valueFormat) : <code>string</code>
    * [~onNumberChanged](#module_miot/ui/NumberSpinner..onNumberChanged) : <code>func</code>

<a name="module_miot/ui/NumberSpinner..visible"></a>

### miot/ui/NumberSpinner~visible : <code>bool</code>
是否可见

**Kind**: inner property of [<code>miot/ui/NumberSpinner</code>](#module_miot/ui/NumberSpinner)  
<a name="module_miot/ui/NumberSpinner..unit"></a>

### miot/ui/NumberSpinner~unit : <code>string</code>
单位

**Kind**: inner property of [<code>miot/ui/NumberSpinner</code>](#module_miot/ui/NumberSpinner)  
<a name="module_miot/ui/NumberSpinner..maxValue"></a>

### miot/ui/NumberSpinner~maxValue : <code>int</code>
max

**Kind**: inner property of [<code>miot/ui/NumberSpinner</code>](#module_miot/ui/NumberSpinner)  
<a name="module_miot/ui/NumberSpinner..minValue"></a>

### miot/ui/NumberSpinner~minValue : <code>int</code>
min

**Kind**: inner property of [<code>miot/ui/NumberSpinner</code>](#module_miot/ui/NumberSpinner)  
<a name="module_miot/ui/NumberSpinner..interval"></a>

### miot/ui/NumberSpinner~interval : <code>int</code>
步长，默认为1

**Kind**: inner property of [<code>miot/ui/NumberSpinner</code>](#module_miot/ui/NumberSpinner)  
<a name="module_miot/ui/NumberSpinner..defaultValue"></a>

### miot/ui/NumberSpinner~defaultValue : <code>int</code>
缺省值

**Kind**: inner property of [<code>miot/ui/NumberSpinner</code>](#module_miot/ui/NumberSpinner)  
<a name="module_miot/ui/NumberSpinner..valueFormat"></a>

### miot/ui/NumberSpinner~valueFormat : <code>string</code>
格式

**Kind**: inner property of [<code>miot/ui/NumberSpinner</code>](#module_miot/ui/NumberSpinner)  
<a name="module_miot/ui/NumberSpinner..onNumberChanged"></a>

### miot/ui/NumberSpinner~onNumberChanged : <code>func</code>
回调
