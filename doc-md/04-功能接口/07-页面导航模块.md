...
* [miot/host/ui](#module_miot/host/ui)
    * [~IUi](#module_miot/host/ui..IUi)
        ...
        * [.backToPluginPage(info)](#module_miot/host/ui..IUi+backToPluginPage)
...
#### iUi.openChangeDeviceIconDialog(param) ⇒ <code>[ &#x27;Promise&#x27; ].&lt;{code:number, data: {subclass\_id:number, proxy\_category\_icon:String}}, {code:number, message:String}&gt;</code>
**Kind**: instance method of [<code>IUi</code>](#module_miot/host/ui..IUi)  
**Returns**: <code>[ &#x27;Promise&#x27; ].&lt;{code:number, data: {subclass\_id:number, proxy\_category\_icon:String}}, {code:number, message:String}&gt;</code> - 成功返回{
  code:0,
  data:{
    subclass_id:xxx,
...
<a name="module_miot/host/ui..IUi+openTemplateScenePage"></a>

#### iUi.openTemplateScenePage()
打开推荐场景详情页
...
<a name="module_miot/host/ui..IUi+openMatterConnectPage"></a>

#### iUi.openMatterConnectPage()
...
<a name="module_miot/host/ui..IUi+backToPluginPage"></a>

#### iUi.backToPluginPage(info)
