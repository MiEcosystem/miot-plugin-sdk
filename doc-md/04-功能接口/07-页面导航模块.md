...
* [miot/host/ui](#module_miot/host/ui)
    * [~IUi](#module_miot/host/ui..IUi)
        ...
        * [.openWebPage(url, {onCurrentPageIfAvailable:)](#module_miot/host/ui..IUi+openWebPage)
...
#### iUi.openWebPage(url, {onCurrentPageIfAvailable:)
打开H5页面
不对外提供
...
| {onCurrentPageIfAvailable: | <code>json</code> | [true | false](是否在当前页面打开URL，默认false)}；10052新增(该参数仅在android生效) |
