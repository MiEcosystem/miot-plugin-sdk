...
* [miot/host/ui](#module_miot/host/ui)
    * [~IUi](#module_miot/host/ui..IUi)
        ...
        * [.subMiniProgramDeviceMessage(param)](#module_miot/host/ui..IUi+subMiniProgramDeviceMessage)
...
<a name="module_miot/host/ui..IUi+subMiniProgramDeviceMessage"></a>

#### iUi.subMiniProgramDeviceMessage(param)
