...
* [miot/host/ui](#module_miot/host/ui)
    * [~IUi](#module_miot/host/ui..IUi)
        ...
        * [.openPowerMultikeyPageV2(did, mac, params)](#module_miot/host/ui..IUi+openPowerMultikeyPageV2)
...
<a name="module_miot/host/ui..IUi+openPowerMultikeyPageV2"></a>

#### iUi.openPowerMultikeyPageV2(did, mac, params)
...
| did | <code>string</code> |  | 设备did 指定设备ID |
| mac | <code>string</code> | <code>null</code> | 设备mac option, 在不传递时。默认使用当前设备 |
| params | <code>Object</code> | <code></code> | { expandMemberId: 0 } 可不传，默认展开第一个按键 |
