...
* [miot/host/ui](#module_miot/host/ui)
    * [~IUi](#module_miot/host/ui..IUi)
        ...
        * [.openCarImportControlPage(params)](#module_miot/host/ui..IUi+openCarImportControlPage)
...
<a name="module_miot/host/ui..IUi+openCarImportControlPage"></a>

#### iUi.openCarImportControlPage(params)
导入批量控制界面
...
| params.home_id | <code>string</code> | 设备所属home_id |
