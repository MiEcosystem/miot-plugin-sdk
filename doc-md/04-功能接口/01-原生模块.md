...
* [miot/Host](#module_miot/Host)
    * _static_
        * [.isSupportQ](#module_miot/Host.isSupportQ) ⇒ <code>\*</code>
        * [.isSupportUWB](#module_miot/Host.isSupportUWB) ⇒ <code>\*</code>
        * [.phoneBrand](#module_miot/Host.phoneBrand) ⇒ <code>\*</code>
        * [.isMiuiChannel](#module_miot/Host.isMiuiChannel) ⇒ <code>\*</code>
        ...
        * [.safeAreaInsets](#module_miot/Host.safeAreaInsets) : <code>map</code>
        * [.getSafeAreaInsets](#module_miot/Host.getSafeAreaInsets) : <code>[ &#x27;Promise&#x27; ].&lt;map&gt;</code>
        ...
        * [.phoneId](#module_miot/Host.phoneId) : <code>string</code>
        * [.phoneDid](#module_miot/Host.phoneDid) : <code>string</code>
        ...
        * [.appBuildTargetType](#module_miot/Host.appBuildTargetType) : <code>int</code>
        ...
        * [.getWindowMode()](#module_miot/Host.getWindowMode) ⇒ <code>[ &#x27;Promise&#x27; ].&lt;number&gt;</code>
        ...
        * [.copyToClipboard(text)](#module_miot/Host.copyToClipboard)
        * [.feedbackRequestForModelAlgorithm(content)](#module_miot/Host.feedbackRequestForModelAlgorithm) ⇒ <code>Promise</code>
        * [.isSupportAccessoryFind()](#module_miot/Host.isSupportAccessoryFind) ⇒ <code>[ &#x27;Promise&#x27; ].&lt;boolean&gt;</code>
    * _inner_
        * [~HostEvent](#module_miot/Host..HostEvent) : <code>object</code>
            ...
            * ["h5RetentionPopUpWindowConfirmEvent"](#module_miot/Host..HostEvent.event_h5RetentionPopUpWindowConfirmEvent)
...
<a name="module_miot/Host.isSupportQ"></a>

### miot/Host.isSupportQ ⇒ <code>\*</code>
...
<a name="module_miot/Host.isSupportUWB"></a>

### miot/Host.isSupportUWB ⇒ <code>\*</code>
当前手机是否支持UWB：
...
<a name="module_miot/Host.phoneBrand"></a>

### miot/Host.phoneBrand ⇒ <code>\*</code>
...
<a name="module_miot/Host.isMiuiChannel"></a>

### miot/Host.isMiuiChannel ⇒ <code>\*</code>
...
<a name="module_miot/Host.safeAreaInsets"></a>

### miot/Host.safeAreaInsets : <code>map</code>
获取iphone手机安全区域，返回例子：{"bottom" : 34, "left": 0, "right": 0, "top": 62}
...
<a name="module_miot/Host.getSafeAreaInsets"></a>

### miot/Host.getSafeAreaInsets : <code>[ &#x27;Promise&#x27; ].&lt;map&gt;</code>
获取iphone手机安全区域，返回例子：{"bottom" : 34, "left": 0, "right": 0, "top": 62}
...
<a name="module_miot/Host.phoneId"></a>

### miot/Host.phoneId : <code>string</code>
手机唯一id
...
<a name="module_miot/Host.phoneDid"></a>

### miot/Host.phoneDid : <code>string</code>
手机DID
...
<a name="module_miot/Host.appBuildTargetType"></a>

### miot/Host.appBuildTargetType : <code>int</code>
...
<a name="module_miot/Host.getWindowMode"></a>

### miot/Host.getWindowMode() ⇒ <code>[ &#x27;Promise&#x27; ].&lt;number&gt;</code>
判断当前 Activity 是否处于分屏/多窗口模式 
android only
获取当前窗口模式

**Kind**: static method of [<code>miot/Host</code>](#module_miot/Host)  
**Returns**: <code>[ &#x27;Promise&#x27; ].&lt;number&gt;</code> - 0=普通全屏, 1=分屏, 2=自由窗口(freeform小窗)  
**Since**: 10117  
...
<a name="module_miot/Host.copyToClipboard"></a>

### miot/Host.copyToClipboard(text)
**Kind**: static method of [<code>miot/Host</code>](#module_miot/Host)  
**Since**: 10104
调用系统剪贴板  
...
<a name="module_miot/Host.feedbackRequestForModelAlgorithm"></a>

### miot/Host.feedbackRequestForModelAlgorithm(content) ⇒ <code>Promise</code>
**Kind**: static method of [<code>miot/Host</code>](#module_miot/Host)  
**Returns**: <code>Promise</code> - 网络API Response结果  
**Since**: 10115
模型算法反馈API
不对外提供  
...
| Param | Type | Description |
| --- | --- | --- |
| content | <code>string</code> | 反馈内容 |


* * *

<a name="module_miot/Host.isSupportAccessoryFind"></a>

### miot/Host.isSupportAccessoryFind() ⇒ <code>[ &#x27;Promise&#x27; ].&lt;boolean&gt;</code>
...
<a name="module_miot/Host..HostEvent.event_h5RetentionPopUpWindowConfirmEvent"></a>
