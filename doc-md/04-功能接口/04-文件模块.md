...
* [miot/host/file](#module_miot/host/file)
    * [~IFile](#module_miot/host/file..IFile)
        ...
        * [.generateImageWithWatermarkParams(dirName, saveFilePath, watermarkParams)](#module_miot/host/file..IFile+generateImageWithWatermarkParams) ⇒ <code>Promise</code>
        * [.saveImageToPhotosDidAlbum(fileName, customDirName, deviceID, watermarkParams)](#module_miot/host/file..IFile+saveImageToPhotosDidAlbum) ⇒ <code>Promise</code>
        ...
        * [.mergeVideosUseHarewareAccelerate(firstVideoPath, secondVideoPath, deviceID)](#module_miot/host/file..IFile+mergeVideosUseHarewareAccelerate) ⇒ <code>Promise</code>
        * [.mergeVideosWithFFmpeg(firstVideoPath, secondVideoPath, deviceID)](#module_miot/host/file..IFile+mergeVideosWithFFmpeg) ⇒ <code>Promise</code>
...
<a name="module_miot/host/file..IFile+generateImageWithWatermarkParams"></a>

#### iFile.generateImageWithWatermarkParams(dirName, saveFilePath, watermarkParams) ⇒ <code>Promise</code>
生成水印图片
...
| Param | Type | Description |
| --- | --- | --- |
| dirName | <code>string</code> | 图片所在相册路径 |
| saveFilePath | <code>string</code> | 存储位置filePath filePath必须是带 Host.file.storageBasePath前缀的path，native端会校验这个路径合法性。 |
| watermarkParams | <code>json</code> | 水印参数信息 {  "deviceID": "1170922735", //设备id  "hasWatermark": false, //图片是否有水印  "watermarkInfo": "23mm f/1.6 1/100s ISO 64", //水印文案  "watermarkTemplate": 1, //水印模板，默认为1,1带icon的模块，2为不带Icon的模块  "extraInfo": { //水印额外信息，json，内部参数可自定义     "fnum": 18,     "iso": 500,      "shutter": 4,  } } |
...
#### iFile.saveImageToPhotosDidAlbum(fileName, customDirName, deviceID, watermarkParams) ⇒ <code>Promise</code>
保存指定图片文件到以did命名的相册中
...
| watermarkParams | <code>json</code> | <code></code> | 水印信息，默认为null， since 10109 {  "deviceID": "1170922735", //设备id  "hasWatermark": false, //图片是否有水印  "watermarkInfo": "23mm f/1.6 1/100s ISO 64", //水印文案  "watermarkTemplate": 1, //水印模板，默认为1,1带icon的模块，2为不带Icon的模块  "extraInfo": { //水印额外信息，json，内部参数可自定义     "fnum": 18,     "iso": 500,      "shutter": 4,  } } |
...
<a name="module_miot/host/file..IFile+mergeVideosUseHarewareAccelerate"></a>

#### iFile.mergeVideosUseHarewareAccelerate(firstVideoPath, secondVideoPath, deviceID) ⇒ <code>Promise</code>
拼接视频文件，iOS only
...
失败时：code < 0
 {"code":xx, "message":"merge failure" }  
**Remarks**: 使用硬件合并视频 逐步替代mergeVideos:videoFilePath:did:callback:在视频宽高比不一致时
...
<a name="module_miot/host/file..IFile+mergeVideosWithFFmpeg"></a>

#### iFile.mergeVideosWithFFmpeg(firstVideoPath, secondVideoPath, deviceID) ⇒ <code>Promise</code>
拼接视频文件：iOS only
