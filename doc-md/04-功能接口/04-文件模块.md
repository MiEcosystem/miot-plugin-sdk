...
* [miot/host/file](#module_miot/host/file)
    * [~IFile](#module_miot/host/file..IFile)
        ...
        * [.unzipFileToString(params)](#module_miot/host/file..IFile+unzipFileToString) ⇒ <code>[ &#x27;Promise&#x27; ].&lt;json&gt;</code>
...
<a name="module_miot/host/file..IFile+unzipFileToString"></a>

#### iFile.unzipFileToString(params) ⇒ <code>[ &#x27;Promise&#x27; ].&lt;json&gt;</code>
...
| Param | Type | Description |
| --- | --- | --- |
| params | <code>json</code> | {  fileName: 'cache/test.zip', //沙盒内的相对路径,必填  charsetName:'[utf-8|base-64|hex-string]',//指定解压后的字符串的格式: utf-8表示将文件解压为utf-8格式的字符串； base-64表示解压为base-64格式的字符串；hex-string表示解压为16进制字符串；charsetName可不传，不传默认为base-64 } |
